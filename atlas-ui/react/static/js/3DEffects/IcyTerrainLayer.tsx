...
export class IcyTerrainLayer {
  ...
  constructor(layerSystem: PlanetLayerSystem, params: IcyTerrainLayerParams = {}) {
    ...
    this.params = {
      color: baseColor,
      iceReflectivity: params.iceReflectivity || 0.8,
      frostDensity: params.frostDensity || 1.0,
      crackIntensity: params.crackIntensity || 1.0,
...
export function createIcyTerrainLayerFromPythonData(
  ...
  return new IcyTerrainLayer(layerSystem, {
    ...
    iceReflectivity: surface.ice_reflectivity || 0.8,
    frostDensity: surface.frost_density || 1.0,
    crackIntensity: surface.crack_intensity || 1.0,
    opacity: 0.7
  });
}