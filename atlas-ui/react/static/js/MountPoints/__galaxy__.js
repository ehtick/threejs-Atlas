...
document.addEventListener('DOMContentLoaded', async () => {
  console.log('DOM loaded, starting Galaxy scripts...');
  
  // 1. Stargate Animation (from script.js)
  ...
  // 2. Historical Data System (from atlasHistoricalScript.js)
  function initHistoricalData() {
    ...
    function markLocationAsViewed(coords) {
      let viewedPlanets = JSON.parse(localStorage.getItem("atlasHistoricalData")) || {};
  ...
  // 3. Space Travel Animation (from spaceTravel.js)
  ...
  console.log('Galaxy scripts initialized successfully!');
});