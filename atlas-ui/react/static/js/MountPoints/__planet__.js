...
document.addEventListener('DOMContentLoaded', async () => {
  console.log('DOM loaded, starting Planet scripts...');
  ...
  function initHistoricalData() {
    ...
    function markLocationAsViewed(coords, systemIdx, planet) {
    ...
    if (coordinates && systemIndex && planetName) {
  ...
  console.log('Planet scripts initialized successfully!');
});