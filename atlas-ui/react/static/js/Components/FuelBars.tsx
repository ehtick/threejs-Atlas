...
const FuelBars: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      <div 
        className={`flex w-full transition-all duration-300 ease-out backdrop-blur-md ${isExpanded ? 'h-16' : 'h-1.5'} group`}
      ...
      >
        ...
        <div className="w-1/3 relative bg-purple-900/30 backdrop-blur-md border-r border-white/20 overflow-hidden">
          <div 
            className="absolute left-0 h-full bg-gradient-to-r from-purple-600 to-purple-400 transition-all duration-300"
        ...
        <div className="w-1/3 relative bg-cyan-900/30 backdrop-blur-md border-r border-white/20 overflow-hidden">
          <div 
            className="absolute left-0 h-full bg-gradient-to-r from-cyan-600 to-cyan-400 transition-all duration-300"
        ...
        <div className="w-1/3 relative bg-orange-900/30 backdrop-blur-md overflow-hidden">
          <div 
            className="absolute left-0 h-full bg-gradient-to-r from-orange-600 to-orange-400 transition-all duration-300"
