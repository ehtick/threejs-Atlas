import{r as M,j as h,R as Kt,V as mi,c as ui}from"./atlas_bDOTfl6YifhEgi64OZoGp.js";import{H as fi}from"./atlas_DAPSgiEQDbHKEp53GoVrV.js";import{S as pi,U as gi,m as it,c as Et,a as vi}from"./atlas_HOF5V4Y7Q3DW-IYNsZLlc.js";import{m as yi,V as A,n as $e,T as Ge,Q as Ot,l as zt,o as _e,R as xi,p as bi,q as Qt,e as Ae,r as te,s as ue,N as Pe,t as Ke,c as dt,C as m,u as Si,v as Ve,d as xe,G as ze,w as Jt,x as It,F as we,y as Ct,z as Tt,h as _i,H as wi,I as Ei,J as Ze,B as ei,K as Mt,O as Ci,U as Ti,X as Mi,L as Pt,g as At,Y as Pi,Z as Ai,_ as qe,M as ti,$ as Ii,S as Ni,P as Di,W as Ri,a0 as Li,a1 as Oi,a2 as zi,D as Ft,A as Fi}from"./atlas_BVw4Oz7k70lSX13lINg8j.js";const ji=({effects:r,onToggleEffect:e})=>{const[t,i]=M.useState(r),[o,a]=M.useState(!1);M.useEffect(()=>{i(r)},[r]);const n=(d,l)=>{i(s=>s.map(u=>u.id===d?{...u,enabled:l}:u)),e(d,l)},c=d=>d;return t.length===0?null:h.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10",children:[h.jsxs("div",{className:"flex items-center justify-between mb-2",children:[h.jsx("div",{className:"text-xs text-gray-400",children:"3D Effects Control"}),h.jsxs("button",{onClick:()=>a(!o),className:"text-xs text-blue-400 hover:text-blue-300 transition-colors",children:[o?"Hide":"Show"," (",t.filter(d=>d.enabled).length,"/",t.length,")"]})]}),o&&h.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs",children:t.map(d=>h.jsxs("div",{className:"bg-white/5 rounded p-2 flex items-center justify-between",children:[h.jsxs("label",{className:"flex items-center gap-2 cursor-pointer flex-1",children:[h.jsx("input",{type:"checkbox",checked:d.enabled,onChange:l=>n(d.id,l.target.checked),className:"rounded border-gray-400 text-blue-500 focus:ring-blue-500 focus:ring-offset-0 bg-white/10"}),h.jsx("span",{className:`${d.enabled?"text-white":"text-gray-500"} transition-colors`,children:c(d.type)})]}),h.jsx("span",{className:`text-[10px] ${d.enabled?"text-green-400":"text-gray-600"}`,children:d.enabled?"ON":"OFF"})]},d.id))}),o&&t.length>3&&h.jsxs("div",{className:"mt-2 flex gap-2",children:[h.jsx("button",{onClick:()=>{t.forEach(d=>n(d.id,!0))},className:"text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded hover:bg-green-500/30 transition-colors",children:"Enable All"}),h.jsx("button",{onClick:()=>{t.forEach(d=>n(d.id,!1))},className:"text-xs px-2 py-1 bg-red-500/20 text-red-400 rounded hover:bg-red-500/30 transition-colors",children:"Disable All"})]})]})},ki=({planet:r,system:e,galaxy:t,cosmicOriginTime:i,initialAngleRotation:o,effects:a,onToggleEffect:n})=>{const[c,d]=M.useState(!1),l=v=>v.replace(/_/g," "),s=v=>{const S=v/86400;return S<30?`${S.toFixed(2)} days`:S<365?`${(S/30).toFixed(2)} months`:`${(S/365).toFixed(2)} years`},u=v=>{const S=v*9/5+32;return`${v.toFixed(1)}°C (${S.toFixed(1)}°F)`},f=v=>`${v.toExponential(2)} kg`,p=v=>v>=1e3?`${(v/1e3).toFixed(2)} km`:`${v.toFixed(2)} m`;return h.jsxs("div",{className:"h-full flex flex-col relative",children:[h.jsx("div",{className:"absolute top-0 right-0 bg-green-500/20 border border-green-500/50 text-green-400 text-[10px] px-1.5 py-0.5 rounded z-10",children:"VISITED"}),h.jsxs("div",{className:"flex items-center justify-between mb-3 pr-16",children:[h.jsx("h3",{className:"text-lg sm:text-xl font-bold text-white",children:"Planet Information"}),h.jsx(pi,{type:"planet",name:r.name,coordinates:t.coordinates.join(","),systemIndex:e.index,planetName:r.name,className:"text-xs"})]}),h.jsxs("div",{className:"grid grid-cols-3 gap-2 mb-3",children:[h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-blue-500/30",children:[h.jsx("div",{className:"text-xs text-gray-200",children:"Type"}),h.jsx("div",{className:"text-sm font-bold text-blue-300 capitalize",children:r.planet_type})]}),h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-purple-500/30",children:[h.jsx("div",{className:"text-xs text-gray-200",children:"Atmosphere"}),h.jsx("div",{className:"text-sm font-bold text-purple-300 capitalize",children:r.atmosphere})]}),h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-green-500/30",children:[h.jsx("div",{className:"text-xs text-gray-200",children:"Life Forms"}),h.jsx("div",{className:"text-sm font-bold text-green-300 capitalize",children:r.life_forms})]})]}),h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-orange-500/30 mb-3",children:[h.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Physical Properties"}),h.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-1",children:[h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Mass"}),h.jsx("div",{className:"text-xs font-bold text-orange-300",children:f(r.mass)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Diameter"}),h.jsx("div",{className:"text-xs font-bold text-orange-300",children:p(r.diameter)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Density"}),h.jsxs("div",{className:"text-xs font-bold text-orange-300",children:[r.density.toFixed(2)," kg/m³"]})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Gravity"}),h.jsxs("div",{className:"text-xs font-bold text-orange-300",children:[r.gravity.toFixed(2)," m/s²"]})]})]})]}),h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-cyan-500/30 mb-3",children:[h.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Orbital Properties"}),h.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-1",children:[h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Radius"}),h.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.orbital_radius.toFixed(2)," AU"]})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Period"}),h.jsx("div",{className:"text-xs font-bold text-cyan-300",children:s(r.orbital_period_seconds)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Speed"}),h.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.orbital_speed.toFixed(2)," m/s"]})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Tilt"}),h.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.axial_tilt.toFixed(2),"°"]})]})]})]}),h.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-2",children:[h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-red-500/30",children:[h.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Surface Conditions"}),h.jsxs("div",{className:"grid grid-cols-2 gap-1",children:[h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-red-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Temperature"}),h.jsx("div",{className:"text-xs font-bold text-red-300",children:u(r.surface_temperature)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-red-500/20",children:[h.jsx("div",{className:"text-xs text-gray-300",children:"Rotation"}),h.jsx("div",{className:"text-xs font-bold text-red-300",children:s(r.rotation_period_seconds)})]})]})]}),h.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-yellow-500/30",children:[h.jsxs("div",{className:"flex items-center justify-between mb-2",children:[h.jsxs("div",{className:"text-xs text-gray-200",children:["Elements (",r.elements.length,")"]}),r.elements.length>4&&h.jsx("button",{onClick:()=>d(!c),className:"text-xs text-yellow-400 hover:text-yellow-300 transition-colors duration-300",children:c?"▲ Less":"▼ All"})]}),h.jsx("div",{className:"flex flex-wrap gap-1",children:(c?r.elements:r.elements.slice(0,4)).map((v,S)=>h.jsx("span",{className:"text-xs bg-yellow-500/20 text-yellow-300 px-1.5 py-0.5 rounded border border-yellow-500/30",children:v},S))})]})]}),h.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10",children:[h.jsx("div",{className:"text-xs text-gray-400 mb-2",children:"Technical Data"}),h.jsxs("div",{className:"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 text-xs",children:[h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"Status:"}),h.jsx("div",{className:"text-green-400 font-medium",children:"Visited"})]}),h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"Planet:"}),h.jsx("div",{className:"text-white truncate font-medium",children:l(r.name)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"System:"}),h.jsx("div",{className:"text-white truncate font-medium",children:l(e.name)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"System ID:"}),h.jsxs("div",{className:"text-white font-medium",children:["#",e.index+1]})]}),h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"Galaxy:"}),h.jsx("div",{className:"text-white truncate font-medium",children:l(t.name)})]}),h.jsxs("div",{className:"bg-white/5 rounded p-2",children:[h.jsx("span",{className:"text-gray-400",children:"Coordinates:"}),h.jsx("div",{className:"text-white font-medium",children:t.coordinates.join(", ")})]})]})]}),a&&n&&h.jsx(ji,{effects:a,onToggleEffect:n})]})},jt={type:"change"},Nt={type:"start"},ii={type:"end"},ft=new xi,kt=new bi,Ui=Math.cos(70*Qt.DEG2RAD),me=new A,be=2*Math.PI,J={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},St=1e-6;class Vi extends yi{constructor(e,t=null){super(e,t),this.state=J.NONE,this.target=new A,this.cursor=new A,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:$e.ROTATE,MIDDLE:$e.DOLLY,RIGHT:$e.PAN},this.touches={ONE:Ge.ROTATE,TWO:Ge.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new A,this._lastQuaternion=new Ot,this._lastTargetPosition=new A,this._quat=new Ot().setFromUnitVectors(e.up,new A(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new zt,this._sphericalDelta=new zt,this._scale=1,this._panOffset=new A,this._rotateStart=new _e,this._rotateEnd=new _e,this._rotateDelta=new _e,this._panStart=new _e,this._panEnd=new _e,this._panDelta=new _e,this._dollyStart=new _e,this._dollyEnd=new _e,this._dollyDelta=new _e,this._dollyDirection=new A,this._mouse=new _e,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Yi.bind(this),this._onPointerDown=Wi.bind(this),this._onPointerUp=Gi.bind(this),this._onContextMenu=Ki.bind(this),this._onMouseWheel=$i.bind(this),this._onKeyDown=Zi.bind(this),this._onTouchStart=qi.bind(this),this._onTouchMove=Xi.bind(this),this._onMouseDown=Bi.bind(this),this._onMouseMove=Hi.bind(this),this._interceptControlDown=Qi.bind(this),this._interceptControlUp=Ji.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(jt),this.update(),this.state=J.NONE}update(e=null){const t=this.object.position;me.copy(t).sub(this.target),me.applyQuaternion(this._quat),this._spherical.setFromVector3(me),this.autoRotate&&this.state===J.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,o=this.maxAzimuthAngle;isFinite(i)&&isFinite(o)&&(i<-Math.PI?i+=be:i>Math.PI&&(i-=be),o<-Math.PI?o+=be:o>Math.PI&&(o-=be),i<=o?this._spherical.theta=Math.max(i,Math.min(o,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+o)/2?Math.max(i,this._spherical.theta):Math.min(o,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const n=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=n!=this._spherical.radius}if(me.setFromSpherical(this._spherical),me.applyQuaternion(this._quatInverse),t.copy(this.target).add(me),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let n=null;if(this.object.isPerspectiveCamera){const c=me.length();n=this._clampDistance(c*this._scale);const d=c-n;this.object.position.addScaledVector(this._dollyDirection,d),this.object.updateMatrixWorld(),a=!!d}else if(this.object.isOrthographicCamera){const c=new A(this._mouse.x,this._mouse.y,0);c.unproject(this.object);const d=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=d!==this.object.zoom;const l=new A(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(c),this.object.updateMatrixWorld(),n=me.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;n!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(n).add(this.object.position):(ft.origin.copy(this.object.position),ft.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ft.direction))<Ui?this.object.lookAt(this.target):(kt.setFromNormalAndCoplanarPoint(this.object.up,this.target),ft.intersectPlane(kt,this.target))))}else if(this.object.isOrthographicCamera){const n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),n!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>St||8*(1-this._lastQuaternion.dot(this.object.quaternion))>St||this._lastTargetPosition.distanceToSquared(this.target)>St?(this.dispatchEvent(jt),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?be/60*this.autoRotateSpeed*e:be/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){me.setFromMatrixColumn(t,0),me.multiplyScalar(-e),this._panOffset.add(me)}_panUp(e,t){this.screenSpacePanning===!0?me.setFromMatrixColumn(t,1):(me.setFromMatrixColumn(t,0),me.crossVectors(this.object.up,me)),me.multiplyScalar(e),this._panOffset.add(me)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const o=this.object.position;me.copy(o).sub(this.target);let a=me.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*a/i.clientHeight,this.object.matrix),this._panUp(2*t*a/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),o=e-i.left,a=t-i.top,n=i.width,c=i.height;this._mouse.x=o/n*2-1,this._mouse.y=-(a/c)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(be*this._rotateDelta.x/t.clientHeight),this._rotateUp(be*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-be*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._rotateStart.set(i,o)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._panStart.set(i,o)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,o=e.pageY-t.y,a=Math.sqrt(i*i+o*o);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),o=.5*(e.pageX+i.x),a=.5*(e.pageY+i.y);this._rotateEnd.set(o,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(be*this._rotateDelta.x/t.clientHeight),this._rotateUp(be*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._panEnd.set(i,o)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,o=e.pageY-t.y,a=Math.sqrt(i*i+o*o);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const n=(e.pageX+t.x)*.5,c=(e.pageY+t.y)*.5;this._updateZoomParameters(n,c)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new _e,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Wi(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function Yi(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function Gi(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(ii),this.state=J.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function Bi(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case $e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=J.DOLLY;break;case $e.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=J.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=J.ROTATE}break;case $e.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=J.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=J.PAN}break;default:this.state=J.NONE}this.state!==J.NONE&&this.dispatchEvent(Nt)}function Hi(r){switch(this.state){case J.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case J.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case J.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function $i(r){this.enabled===!1||this.enableZoom===!1||this.state!==J.NONE||(r.preventDefault(),this.dispatchEvent(Nt),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(ii))}function Zi(r){this.enabled!==!1&&this._handleKeyDown(r)}function qi(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case Ge.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=J.TOUCH_ROTATE;break;case Ge.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=J.TOUCH_PAN;break;default:this.state=J.NONE}break;case 2:switch(this.touches.TWO){case Ge.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=J.TOUCH_DOLLY_PAN;break;case Ge.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=J.TOUCH_DOLLY_ROTATE;break;default:this.state=J.NONE}break;default:this.state=J.NONE}this.state!==J.NONE&&this.dispatchEvent(Nt)}function Xi(r){switch(this._trackPointer(r),this.state){case J.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case J.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case J.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case J.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=J.NONE}}function Ki(r){this.enabled!==!1&&r.preventDefault()}function Qi(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Ji(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}class Ut{seed;constructor(e){this.seed=e}next(){return this.seed=this.seed*16807%2147483647,(this.seed-1)/2147483646}uniform(e,t){return e+(t-e)*this.next()}choice(e){return e[Math.floor(this.next()*e.length)]}}class oi{ringSystem;material;params;planetRadius;constructor(e,t){this.planetRadius=e,this.params=t,this.createRingSystemFromAPI(t)}createRingSystemFromAPI(e){const{full_ring:t,ontop_ring:i,ring_inner_radius:o,ring_outer_radius:a,tilt_factor:n,planet_radius:c,shape_seed:d}=e;if(!t||!i){console.warn("No ring data provided");return}const l=[...t.particles,...i.particles],s=l.length,u=new Ut(d||12345),f=new Ae,p=new Float32Array(s*3),v=new Float32Array(s*3),S=new Float32Array(s),E=[{baseGray:.18,variation:.04,name:"dark"},{baseGray:.25,variation:.06,name:"medium"},{baseGray:.32,variation:.06,name:"light"},{baseGray:.25,variation:.08,name:"mixed"}],y=u.choice(E);for(let x=0;x<s;x++){const g=l[x],b=this.planetRadius/(c||200),I=(d||12345)+x,T=new Ut(I),P=g.distance*b,L=g.angle,O=P*Math.sin(L),k=Math.asin((n||.2)*.5),C=O*Math.sin(k),V=O*Math.cos(k),W=((a||400)-(o||200))*b*.4,G=T.uniform(-W*.8,W*.8),ee=T.uniform(-W*.3,W*.3),Z=T.uniform(-.08,.08),K=P+ee,D=L+Z;p[x*3]=K*Math.cos(D),p[x*3+1]=C+G+this.planetRadius*.15,p[x*3+2]=V+T.uniform(-W*.4,W*.4),g.color[0]/255;const z=(g.distance-(o||200))/((a||400)-(o||200)),q=y.baseGray,ie=y.variation,fe=T.uniform(-ie,ie),oe=Math.max(.12,Math.min(.45,q+fe)),pe=.8+z*.4,ve=T.uniform(.85,1.15),Se=T.uniform(0,1),ye=Se<.03?T.uniform(1.1,1.3):1,Ce=oe*pe*ve*ye,de=Math.max(.1,Math.min(.55,Ce));v[x*3]=de,v[x*3+1]=de,v[x*3+2]=de;const Ne=.15,Te=T.uniform(.3,.7),re=Se<.1?T.uniform(1.05,1.2):1;S[x]=g.size*Ne*Te*re}f.setAttribute("position",new te(p,3)),f.setAttribute("color",new te(v,3)),f.setAttribute("size",new te(S,1)),this.material=new ue({uniforms:{brightness:{value:2.2}},vertexShader:`
  ...
  `;constructor(e,t={}){const i=t.seed||Math.floor(Math.random()*1e6),o=new U(i);this.startTime=t.startTime||i%1e4/1e3,this.params={color:t.color||new m(16777215),cloudCount:t.cloudCount||Math.floor(o.uniform(H.CLOUD_COUNT.min,H.CLOUD_COUNT.max)),size:t.size||o.uniform(H.SIZE.min,H.SIZE.max),opacity:t.opacity||o.uniform(H.OPACITY.min,H.OPACITY.max),density:t.density||o.uniform(H.DENSITY.min,H.DENSITY.max),rotationSpeed:t.rotationSpeed||o.uniform(H.ROTATION_SPEED.min,H.ROTATION_SPEED.max),movementAmplitude:t.movementAmplitude||o.uniform(H.MOVEMENT_AMPLITUDE.min,H.MOVEMENT_AMPLITUDE.max),puffiness:t.puffiness||o.uniform(H.PUFFINESS.min,H.PUFFINESS.max),timeSpeed:t.timeSpeed||o.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max),seed:i,startTime:this.startTime},this.cloudCount=this.params.cloudCount,this.cloudSystem=new ze,this.material=this.createMaterial(),this.generateClouds(e)}generateClouds(e){const t=this.params.color instanceof m?this.params.color:new m(this.params.color),i=this.params.seed||Math.floor(Math.random()*1e6),o=new U(i),a=this.params.cloudsFromPython;for(let n=0;n<this.cloudCount;n++){let c,d,l,s=t,u=this.params.size*o.uniform(.8,1.2);if(a&&n<a.length){const O=a[n];c=O.position[0]*e*1.04,d=O.position[1]*e*1.04,l=O.position[2]*e*1.04,O.color&&(s=new m().setRGB(O.color[0],O.color[1],O.color[2])),u=O.radius*e*.8}else{const O=o.uniform(0,2*Math.PI),k=o.uniform(-1,1),C=Math.acos(k),V=e*o.uniform(1.02,1.06);c=V*Math.sin(C)*Math.cos(O),d=V*Math.sin(C)*Math.sin(O),l=V*Math.cos(C)}const f=u*o.uniform(.3,.8),p=Math.max(8,Math.floor(f*15)),v=new Jt(f*2,f*2,p,p),S=new A(c,d,l);new A(0,0,0);const E=S.clone().normalize(),y=new A,x=new A;Math.abs(E.y)<.99?y.crossVectors(E,new A(0,1,0)).normalize():y.crossVectors(E,new A(1,0,0)).normalize(),x.crossVectors(E,y).normalize();const g=new It;g.makeBasis(y,x,E);const b=v.attributes.position,I=new A,T=Math.sqrt(c*c+d*d+l*l);v.applyMatrix4(g);for(let O=0;O<b.count;O++){I.fromBufferAttribute(b,O);const W=I.clone().add(S).clone().normalize().multiplyScalar(T).sub(S);b.setXYZ(O,W.x,W.y,W.z)}b.needsUpdate=!0,v.computeVertexNormals(),v.translate(c,d,l);const P=this.material.clone();P.uniforms.cloudColor.value=s,P.uniforms.density.value=this.params.density*o.uniform(.8,1.2),P.uniforms.noiseOffset.value=new _e(o.uniform(0,100),o.uniform(0,100)),P.uniforms.shapeVariation.value=o.uniform(-1,1),P.uniforms.lightDirection.value=this.material.uniforms.lightDirection.value.clone(),P.uniforms.lightPosition.value=this.material.uniforms.lightPosition.value.clone();const L=new xe(v,P);L.userData.isAtmosphericCloud=!0,L.userData.planetNormal=E.clone(),this.clouds.push(L),this.cloudSystem.add(L)}}createMaterial(){return new ue({vertexShader:Xe.vertexShader,fragmentShader:Xe.fragmentShader,uniforms:{time:{value:0},opacity:{value:this.params.opacity},movementAmplitude:{value:this.params.movementAmplitude},cloudColor:{value:new m(16777215)},density:{value:this.params.density},noiseOffset:{value:new _e(0,0)},shapeVariation:{value:0},lightDirection:{value:new A(1,1,1).normalize()},lightPosition:{value:new A(0,0,0)}},transparent:!0,blending:Pe,depthWrite:!1,side:we})}addToScene(e,t){t&&this.cloudSystem.position.copy(t),e.add(this.cloudSystem)}update(e,t){const o=(this.startTime+Date.now()/1e3*this.params.timeSpeed)%1e3;this.clouds.forEach(a=>{const n=a.material;n.uniforms.time.value=o}),this.cloudSystem.rotation.y=o*this.params.rotationSpeed}updateParams(e){this.params={...this.params,...e},this.clouds.forEach(t=>{const i=t.material;e.opacity!==void 0&&(i.uniforms.opacity.value=e.opacity),e.movementAmplitude!==void 0&&(i.uniforms.movementAmplitude.value=e.movementAmplitude)})}updateLightPosition(e){this.clouds.forEach(t=>{const i=t.material;i.uniforms.lightPosition&&i.uniforms.lightPosition.value.copy(e)})}updateLightDirection(e){this.clouds.forEach(t=>{const i=t.material;i.uniforms.lightDirection&&i.uniforms.lightDirection.value.copy(e)})}updateFromThreeLight(e){this.updateLightPosition(e.position);const t=e.target.position.clone().sub(e.position).normalize();this.updateLightDirection(t)}getObject3D(){return this.cloudSystem}dispose(){this.clouds.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.clouds=[],this.cloudSystem.clear()}}function Ue(r,e,t){const i=e.clouds||[];if(i.length===0){const c=t||Math.floor(Math.random()*1e6),d=new U(c+4e3),l={color:new m(1,1,1),cloudCount:15,size:.6,opacity:.7,density:.8,seed:c,rotationSpeed:.005,movementAmplitude:.02,puffiness:1.5,timeSpeed:d.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max)};return new Xe(r,l)}const o=t||Math.floor(Math.random()*1e6),a=new U(o+4e3),n={color:new m(16777215),cloudCount:i.length,size:a.uniform(H.SIZE.min,H.SIZE.max),opacity:a.uniform(H.OPACITY.min,H.OPACITY.max),density:a.uniform(H.DENSITY.min,H.DENSITY.max),seed:o,rotationSpeed:a.uniform(H.ROTATION_SPEED.min,H.ROTATION_SPEED.max),movementAmplitude:a.uniform(H.MOVEMENT_AMPLITUDE.min,H.MOVEMENT_AMPLITUDE.max),puffiness:a.uniform(H.PUFFINESS.min,H.PUFFINESS.max),timeSpeed:a.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max),cloudsFromPython:i};return new Xe(r,n)}class Dt{landGroup;lands=[];constructor(e,t={}){this.landGroup=new ze;const i=t.seed||Math.floor(Math.random()*1e6),o=new U(i);t.greenPatches&&t.greenPatches.length>0?this.generateLandsFromPython(e,t.greenPatches,o,t):this.generateProceduralLands(e,o,t)}generateLandsFromPython(e,t,i,o){t.forEach((a,n)=>{let c=a.position_3d||a.position||[0,0,1];if(c.length===2){const D=i.uniform(0,Math.PI*2),F=Math.acos(i.uniform(-1,1));c=[Math.sin(F)*Math.cos(D),Math.sin(F)*Math.sin(D),Math.cos(F)]}const d=(a.size||.1)*e*1.8;Math.max(8,Math.min(a.sides||20,12));let l=new m(4881497),s=1;a.color&&Array.isArray(a.color)&&(l=new m(a.color[0],a.color[1],a.color[2]),a.color.length>3&&(s=a.color[3]));const u=Math.max(24,Math.min(64,Math.floor(d*32))),f=new A(c[0],c[1],c[2]).normalize(),p=new A,v=new A;Math.abs(f.y)<.99?p.crossVectors(f,new A(0,1,0)).normalize():p.crossVectors(f,new A(1,0,0)).normalize(),v.crossVectors(f,p).normalize();const S=2/Math.max(d*.05,1),E=(D,F)=>{let z=0,q=1,ie=S,fe=0;const oe=Math.min(5,Math.max(3,Math.floor(d/40)+2));for(let pe=0;pe<oe;pe++){const ve=D*ie,Se=F*ie,ye=(Me,mt)=>{const et=Me*12.9898+mt*78.233;return Math.sin(et+i.uniform(0,1e3))*43758.5453%1},Ce=Math.floor(ve),de=Math.floor(Se),Ne=ve-Ce,Te=Se-de,re=Me=>Me*Me*Me*(Me*(Me*6-15)+10),De=re(Ne),Fe=re(Te),Qe=ye(Ce,de),Je=ye(Ce+1,de),ht=ye(Ce,de+1),je=ye(Ce+1,de+1),Le=Qe*(1-De)+Je*De,xt=ht*(1-De)+je*De,We=Le*(1-Fe)+xt*Fe;z+=We*q,fe+=q,q*=.5,ie*=2.2}return z/fe},y=[],x=[],g=[],b=.35,I=new Map,T=new Map;let P=0;for(let D=0;D<=u;D++)for(let F=0;F<=u;F++){const z=(D/u-.5)*2,q=(F/u-.5)*2,ie=Math.sqrt(z*z+q*q),fe=E(z*2,q*2);if(1-ie*.5+fe*.6>b&&ie<1.2){const pe=z*d,ve=q*d,ye=new A().addScaledVector(p,pe).addScaledVector(v,ve).addScaledVector(f,0);y.push(ye.x,ye.y,ye.z),g.push((z+1)*.5,(q+1)*.5),I.set(`${D},${F}`,P),T.set(`${D},${F}`,fe),P++}}for(let D=0;D<u;D++)for(let F=0;F<u;F++){const z=I.get(`${D},${F}`),q=I.get(`${D+1},${F}`),ie=I.get(`${D},${F+1}`),fe=I.get(`${D+1},${F+1}`);z!==void 0&&q!==void 0&&ie!==void 0&&x.push(z,q,ie),q!==void 0&&fe!==void 0&&ie!==void 0&&x.push(q,fe,ie)}const L=new Ae;L.setAttribute("position",new Ct(y,3)),L.setAttribute("uv",new Ct(g,2)),L.setIndex(x),L.computeVertexNormals();const O=L.attributes.position,k=f.clone().multiplyScalar(e),C=new A;for(let D=0;D<O.count;D++){C.fromBufferAttribute(O,D);const z=C.clone().add(k).clone().normalize(),q=L.attributes.uv;if(q){const ie=q.getX(D)*2-1,fe=q.getY(D)*2-1,oe=Math.sqrt(ie*ie+fe*fe),pe=E(ie*2,fe*2),Se=Math.max(0,1-Math.pow(oe,.7))*.5+pe*.5,Ce=(Le=>Le*Le*(3-2*Le))(Se),Ne=e*1.01-e,Te=d*.15,re=Math.min(Te,Ne*.9),De=e*.002,Fe=e+De,Qe=e+De+re,Je=Qt.lerp(Fe,Qe,Ce),je=z.multiplyScalar(Je).sub(k);O.setXYZ(D,je.x,je.y,je.z)}}O.needsUpdate=!0,L.computeVertexNormals(),L.translate(k.x,k.y,k.z);const V=new Tt({color:o.transparentMode?new m(15135743):l,opacity:o.transparentMode?.3:s,transparent:o.transparentMode||s<1,emissive:o.transparentMode?new m(13428479).multiplyScalar(.1):l.clone().multiplyScalar(.05),emissiveIntensity:o.transparentMode?.05:1e-7,shininess:o.transparentMode?30:8,flatShading:!1,bumpScale:.002}),W=document.createElement("canvas");W.width=W.height=64;const G=W.getContext("2d"),ee=G.createImageData(64,64);for(let D=0;D<ee.data.length;D+=4){const F=i.uniform(.8,1.2),z=Math.floor(128*F);ee.data[D]=z,ee.data[D+1]=z,ee.data[D+2]=z,ee.data[D+3]=255}G.putImageData(ee,0,0);const Z=new _i(W);Z.wrapS=Z.wrapT=wi,Z.repeat.set(2,2),V.bumpMap=Z;const K=new xe(L,V);K.castShadow=!0,K.receiveShadow=!0,this.lands.push(K),this.landGroup.add(K)})}generateProceduralLands(e,t,i){const o=Math.floor(t.uniform(5,15));for(let a=0;a<o;a++){const n=t.uniform(0,Math.PI*2),c=Math.acos(t.uniform(-1,1)),d=new A(Math.sin(c)*Math.cos(n),Math.sin(c)*Math.sin(n),Math.cos(c)),l=e*t.uniform(.02,.08),s=new Ei(l,16),u=d.clone().multiplyScalar(e*1);s.lookAt(d),s.translate(u.x,u.y,u.z);const f=t.uniform(.3,.7),p=new m(.36*(1-f)+.22*f,.23*(1-f)+.36*f,0),S=i.tundraMode||!1?.25:1,E=new Tt({color:i.transparentMode?new m(15135743):p,opacity:i.transparentMode?.3:S,transparent:i.transparentMode||S<1,emissive:i.transparentMode?new m(13428479).multiplyScalar(.1):657920,shininess:i.transparentMode?30:5}),y=new xe(s,E);this.lands.push(y),this.landGroup.add(y)}}addToScene(e,t){t&&this.landGroup.position.copy(t),e.add(this.landGroup)}update(e){}getObject3D(){return this.landGroup}dispose(){this.lands.forEach(e=>{e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.lands=[],this.landGroup.clear()}}function pt(r,e,t){const i=e.green_patches;if(!i||i.length===0)return null;const o=t||Math.floor(Math.random()*1e6);return new Dt(r,{greenPatches:i,seed:o+6e3})}function io(r,e,t){const i=t||Math.floor(Math.random()*1e6),o=new U(i+7e3),a=Math.floor(o.uniform(3,8)),n=[];for(let c=0;c<a;c++){const d=o.uniform(0,Math.PI*2),l=Math.acos(o.uniform(-1,1));n.push({position_3d:[Math.sin(l)*Math.cos(d),Math.sin(l)*Math.sin(d),Math.cos(l)],size:o.uniform(.05,.15),sides:Math.floor(o.uniform(8,16)),color:[0,0,0]})}return console.log(`🧊 Creating ${a} transparent ice formations for Icy planet with seed ${i+7e3}`),new Dt(r,{greenPatches:n,seed:i+7e3,transparentMode:!0})}class oo{featuresGroup;crystals=[];cracks=[];iceCaps=[];planetRadius;constructor(e,t={}){this.featuresGroup=new ze,this.planetRadius=e;const i=t.seed||Math.floor(Math.random()*1e6),o=new U(i);t.crystals&&t.crystals.length>0&&this.generateCrystals(t.crystals,o),t.cracks&&t.cracks.length>0&&this.generateCracks(t.cracks),t.iceCaps&&t.iceCaps.length>0&&this.generateIceCaps(t.iceCaps,o)}generateCrystals(e,t){e.forEach(i=>{const o=i.position||[0,0],a=(i.width||.05)*this.planetRadius*.8,n=(i.length||.1)*this.planetRadius*.08,c=i.angle||0,d=i.color||[172/255,215/255,230/255,1],l=this.planetRadius*.015,s=Math.max(n,l),u=new ei(a*2,s,a*1.5,4,2,4),f=u.attributes.position,p=new A;for(let Z=0;Z<f.count;Z++){if(p.fromBufferAttribute(f,Z),Math.abs(p.y)>s*.3){const K=Math.atan2(p.z,p.x),D=Math.sqrt(p.x*p.x+p.z*p.z),F=Math.round(K/(Math.PI/3))*(Math.PI/3),z=t.uniform(.8,1.2),q=D*z;p.x=Math.cos(F)*q,p.z=Math.sin(F)*q,p.y+=t.uniform(-s*.1,s*.1)}f.setXYZ(Z,p.x,p.y,p.z)}f.needsUpdate=!0,u.computeVertexNormals();const v=new Mt({color:new m(d[0],d[1],d[2]),transparent:!0,opacity:.8,metalness:0,roughness:.02,clearcoat:1,clearcoatRoughness:0,transmission:.7,ior:1.31,thickness:.5,emissive:new m(d[0],d[1],d[2]),emissiveIntensity:.02,flatShading:!1,side:we}),S=new xe(u,v);let E=Math.min(1,Math.max(-1,o[1]));const y=Math.pow(Math.abs(E),.3),x=Math.sign(E)*y,g=t.uniform(-.3,.3)*(1-Math.abs(x)),b=Math.min(1,Math.max(-1,x+g)),I=Math.acos(Math.abs(b)),T=Math.atan2(o[0],.001)+c,P=this.planetRadius*t.uniform(1.0005,1.001),L=P*Math.sin(I)*Math.cos(T),O=P*b,k=P*Math.sin(I)*Math.sin(T);S.position.set(L,O,k);const C=S.position.clone().normalize(),V=new A,W=new A;Math.abs(C.x)<.9?V.set(1,0,0):V.set(0,1,0),V.crossVectors(V,C).normalize(),W.crossVectors(C,V).normalize();const G=new It;G.makeBasis(V,C,W),S.rotation.setFromRotationMatrix(G),S.rotateY(t.uniform(0,Math.PI*2));const ee=t.uniform(.8,1.2);S.scale.set(ee,ee,ee),this.crystals.push(S),this.featuresGroup.add(S)})}generateCracks(e){const t=new U(42);e.forEach(i=>{const o=i.angle||0,a=(i.length||1)*this.planetRadius*2,n=i.color||[80/255,80/255,80/255,.4],c=(i.width||1)*5e-4*this.planetRadius,d=t.uniform(.6,1),l=t.uniform(0,1)>.5?1:-1,s=Math.acos(d*l),u=[],f=20;for(let y=0;y<=f;y++){const x=y/f,g=Math.sin(x*Math.PI)*.1,I=o+(x-.5)*a/(this.planetRadius*Math.sin(Math.abs(s)))+g,T=this.planetRadius*1.002*Math.sin(Math.abs(s))*Math.cos(I),P=this.planetRadius*1.002*Math.cos(Math.abs(s))*l,L=this.planetRadius*1.002*Math.sin(Math.abs(s))*Math.sin(I);u.push(new A(T,P,L))}const p=new Ci(u),v=new Ti(p,f*2,c,8,!1),S=new Tt({color:new m(n[0],n[1],n[2]),transparent:!0,opacity:n[3]||.4,emissive:new m(0,0,0),shininess:5}),E=new xe(v,S);this.cracks.push(E),this.featuresGroup.add(E)})}generateIceCaps(e,t){e.forEach(i=>{const o=i.position||[0,0],a=(i.radius||.3)*this.planetRadius,n=i.color||[.678,.847,1,.8],c=Math.atan2(o[1],o[0]),d=Math.acos(Math.min(1,Math.max(-1,Math.sqrt(o[0]**2+o[1]**2)))),l=this.planetRadius*1.002*Math.sin(d)*Math.cos(c),s=this.planetRadius*1.002*Math.cos(d),u=this.planetRadius*1.002*Math.sin(d)*Math.sin(c),f=new A(l,s,u),p=f.clone().normalize(),v=new ze,S=Math.floor(t.uniform(8,20));for(let E=0;E<S;E++){const y=t.uniform(0,Math.PI*2),x=t.uniform(0,a*.8),g=Math.cos(y)*x,b=Math.sin(y)*x,I=new A,T=new A;Math.abs(p.y)<.99?I.crossVectors(p,new A(0,1,0)).normalize():I.crossVectors(p,new A(1,0,0)).normalize(),T.crossVectors(p,I).normalize();const O=f.clone().addScaledVector(I,g).addScaledVector(T,b).normalize().multiplyScalar(this.planetRadius*t.uniform(1.002,1.008)),k=t.uniform(a*.05,a*.15),C=t.uniform(k*.4,k*4),V=new Mi(k,C,6,1,!1),W=V.attributes.position,G=new A;for(let D=0;D<W.count;D++)if(G.fromBufferAttribute(W,D),G.y>.1&&G.y<C*.9){const F=Math.atan2(G.z,G.x),z=Math.sqrt(G.x*G.x+G.z*G.z),q=Math.round(F/(Math.PI/3))*(Math.PI/3),ie=z*1.1;G.x=Math.cos(q)*ie,G.z=Math.sin(q)*ie,W.setXYZ(D,G.x,G.y,G.z)}W.needsUpdate=!0,V.computeVertexNormals();const ee=new Mt({color:new m(n[0],n[1],n[2]),transparent:!0,opacity:.85,metalness:0,roughness:.05,clearcoat:1,clearcoatRoughness:0,transmission:.6,ior:1.31,thickness:.8,emissive:new m(n[0],n[1],n[2]),emissiveIntensity:.03,flatShading:!0,side:we}),Z=new xe(V,ee);Z.position.copy(O),Z.lookAt(0,0,0),Z.rotateX(Math.PI/2),Z.rotateZ(t.uniform(0,Math.PI*2));const K=t.uniform(.7,1.3);Z.scale.set(K,K,K),v.add(Z),this.iceCaps.push(Z)}this.featuresGroup.add(v)})}addToScene(e,t){t&&this.featuresGroup.position.copy(t),e.add(this.featuresGroup)}update(){}getObject3D(){return this.featuresGroup}dispose(){this.crystals.forEach(e=>{e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.cracks.forEach(e=>{e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.iceCaps.forEach(e=>{e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.crystals=[],this.cracks=[],this.iceCaps=[],this.featuresGroup.clear()}}function Wt(r,e,t){const i=e.crystals,o=e.cracks,a=e.ice_caps;if(!i&&!o&&!a)return null;const n=t||Math.floor(Math.random()*1e6);return new oo(r,{crystals:i||[],cracks:o||[],iceCaps:a||[],seed:n+9e3})}class ai{snowflakeGroup;planetRadius;materials=[];particleSystems=[];trailPositions=[];trailColors=[];globalWindDirection;rng;startTime;timeSpeed;trailLength=15;particleCount;rotationSpeed;particleOpacity;windSpeedMultiplier;verticalOscillation;gustCycles;gustPhases;gustZones;burstZone;burstCycleDuration;burstDuration;burstStartOffset;constructor(e,t={}){this.snowflakeGroup=new ze,this.planetRadius=e;const i=t.seed||Math.floor(Math.random()*1e6);this.rng=new U(i),this.particleCount=t.particleCount||10,t.windSpeed;const o=(t.size||1)*(e*.2),a=t.opacity||1;this.globalWindDirection=this.rng.uniform(0,Math.PI*2),this.startTime=this.rng.uniform(0,1e3),this.timeSpeed=this.rng.uniform(2,4),this.rotationSpeed=this.rng.uniform(.2,.8),this.particleOpacity=this.rng.uniform(.05,.25),this.windSpeedMultiplier=this.rng.uniform(1.1,2.5),this.verticalOscillation=this.rng.uniform(.1,.4),this.gustCycles=[],this.gustPhases=[],this.gustZones=[];for(let c=0;c<this.particleCount;c++){this.gustCycles.push(this.rng.uniform(15,30)),this.gustPhases.push(this.rng.uniform(0,1));const d=this.rng.uniform(0,Math.PI*2),l=this.rng.uniform(Math.PI*.3,Math.PI*.6);this.gustZones.push({start:d,end:(d+l)%(Math.PI*2)})}this.burstZone={lat:this.rng.uniform(-Math.PI/3,Math.PI/3),lon:this.rng.uniform(0,Math.PI*2),radius:this.rng.uniform(1.2,2)},this.burstCycleDuration=this.rng.uniform(45,75),this.burstDuration=this.rng.uniform(8,15),this.burstStartOffset=this.rng.uniform(0,this.burstCycleDuration);const n=t.colors||[new m(1,1,1),new m(.9,.9,.9),new m(.7,.7,.7),new m(.5,.5,.5),new m(.3,.3,.3)];this.createSnowflakeSystem(this.particleCount,o,a,n)}createSnowflakeSystem(e,t,i,o){const a=[];for(let d=0;d<e;d++){let l,s,u,f=0;do{const y=(this.rng.uniform(-1,1)+this.rng.uniform(-1,1))*.2,x=this.rng.uniform(-1,1)*this.burstZone.radius;l=Math.max(0,Math.min(Math.PI,this.burstZone.lat+Math.PI/2+y)),s=(this.burstZone.lon+x)%(Math.PI*2);const g=Math.abs(l-(this.burstZone.lat+Math.PI/2)),b=Math.min(Math.abs(s-this.burstZone.lon),Math.PI*2-Math.abs(s-this.burstZone.lon));u=Math.max(g/.3,b/this.burstZone.radius),f++}while(u>1&&f<10);u>1&&(l=this.burstZone.lat+Math.PI/2+this.rng.uniform(-.1,.1),s=this.burstZone.lon+this.rng.uniform(-this.burstZone.radius,this.burstZone.radius));const p=this.planetRadius*this.rng.uniform(1.001,1.005),v=p*Math.sin(l)*Math.cos(s),S=p*Math.cos(l),E=p*Math.sin(l)*Math.sin(s);a.push(v,S,E)}const n=[],c=new m;for(let d=0;d<this.trailLength;d++){const l=Math.pow(1-d/(this.trailLength-1),1.5);c.setRGB(l,l,l),n.push(c.r,c.g,c.b)}for(let d=0;d<e;d++){const l=d*3,s=a[l],u=a[l+1],f=a[l+2],p=new Float32Array(this.trailLength*3);for(let y=0;y<this.trailLength;y++){const x=y*.1;p[y*3]=s+this.rng.uniform(-1,1)*x*this.planetRadius*.01,p[y*3+1]=u+this.rng.uniform(-1,1)*x*this.planetRadius*.01,p[y*3+2]=f+this.rng.uniform(-1,1)*x*this.planetRadius*.01}const v=new Ae;v.setAttribute("position",new te(p,3)),v.setAttribute("color",new te(new Float32Array(n),3));const S=new Pt({vertexColors:!0,transparent:!0,opacity:this.particleOpacity,blending:Pe,depthTest:!0,linewidth:3}),E=new At(v,S);this.materials.push(S),this.particleSystems.push(E),this.trailPositions.push(p),this.trailColors.push(new Float32Array(n)),E.rnd=this.rng.uniform(0,1),E.particleIndex=d,this.snowflakeGroup.add(E)}}update(e=.016){const i=(this.startTime+Date.now()/1e3*this.timeSpeed)%1e3,a=(Date.now()/1e3+this.burstStartOffset)%this.burstCycleDuration;let n=0;if(a<this.burstDuration){const c=a/this.burstDuration;c<.2?n=c/.2:c>.8?n=(1-c)/.2:n=1}this.snowflakeGroup.visible=!0,Math.floor(a)%5===0&&a%1<.1&&console.log("❄️ Burst Debug:",{burstTime:Math.round(a),burstIntensity:Math.round(n*100)/100,cycleDuration:Math.round(this.burstCycleDuration),burstDuration:Math.round(this.burstDuration)}),this.particleSystems.forEach((c,d)=>{const l=c.geometry.getAttribute("position"),s=l.array,u=c.rnd,f=c.particleIndex,p=this.calculateTrailPath(i,f,u);for(let L=this.trailLength-1;L>0;L--){const O=L*3,k=(L-1)*3;s[O]=s[k],s[O+1]=s[k+1],s[O+2]=s[k+2]}s[0]=p.x,s[1]=p.y,s[2]=p.z,l.needsUpdate=!0;const v=Date.now()/1e3,S=this.gustCycles[d],E=this.gustPhases[d],y=(v/S+E)%1;let x=0;y<.3?x=y/.3:y<.7?x=1:x=(1-y)/.3;const g=new A(s[0],s[1],s[2]),b=Math.atan2(g.z,g.x),I=b<0?b+Math.PI*2:b,T=this.gustZones[d];let P=!1;T.start<T.end?P=I>=T.start&&I<=T.end:P=I>=T.start||I<=T.end,this.materials[d].opacity=P?this.particleOpacity*x:0})}calculateTrailPath(e,t,i){e+=10*i+t*.1;const o=this.burstZone.lon+(i-.5)*this.burstZone.radius,a=this.burstZone.lat+Math.PI/2+(i-.5)*.2,n=this.windSpeedMultiplier,c=e*n,d=o+Math.cos(this.globalWindDirection)*c,l=a+this.verticalOscillation*Math.sin(e*.5+i),s=.015*Math.sin(e*2+i*10),u=this.planetRadius*(1.005+s),f=u*Math.sin(l)*Math.cos(d),p=u*Math.cos(l),v=u*Math.sin(l)*Math.sin(d);return{x:f,y:p,z:v}}addToScene(e,t){t&&this.snowflakeGroup.position.copy(t),e.add(this.snowflakeGroup)}getObject3D(){return this.snowflakeGroup}dispose(){this.materials.forEach(e=>e.dispose()),this.particleSystems.forEach(e=>e.geometry.dispose()),this.materials=[],this.particleSystems=[],this.trailPositions=[],this.trailColors=[],this.snowflakeGroup.clear()}}function Yt(r,e,t){if(e.type!=="tundra")return null;const i=t||Math.floor(Math.random()*1e6),o=e.snow_intensity||.7,a=e.wind_strength||1,n=Math.floor(o*200+50),c=a*5;return new ai(r,{particleCount:n,windSpeed:c,size:1.2,opacity:.9,seed:i+15e3})}const ne={PARTICLE_COUNT:{min:60,max:150},PHASE_INTENSITY:{min:.4,max:.9},TRANSITION_SPEED:{min:1,max:4},COHERENCE_LEVEL:{min:.2,max:.7},TIME_SPEED:{min:.6,max:2.2},PHASE_STATES:{min:3,max:6}};class st{phaseSystem;material;geometry;params;particleCount;startTime;static vertexShader=`
    attribute float size;
...
`;class _t{mesh;material;params;startTime;proceduralParams;constructor(e){const t=e.seed||Math.floor(Math.random()*1e6),i=new U(t);this.startTime=e.startTime||t%1e4/1e3,this.proceduralParams={size:i.uniform(Oe.SIZE.min,Oe.SIZE.max),rotationSpeed:i.uniform(Oe.ROTATION_SPEED.min,Oe.ROTATION_SPEED.max),opacity:i.uniform(Oe.OPACITY.min,Oe.OPACITY.max),timeSpeed:i.uniform(Oe.TIME_SPEED.min,Oe.TIME_SPEED.max)},this.params=e;const o=new m(e.planetColor),a=o.clone();a.multiplyScalar(1-e.hexagonData.color_darken_factor),this.material=new ue({uniforms:{time:{value:0},planetColor:{value:o},hexagonColor:{value:a},darkenFactor:{value:e.hexagonData.color_darken_factor},opacity:{value:this.proceduralParams.opacity},hexagonRadius:{value:this.proceduralParams.size},rotationSpeed:{value:this.proceduralParams.rotationSpeed},pole:{value:e.hexagonData.pole==="north"?1:-1},visibility:{value:1}},vertexShader:po,fragmentShader:go,transparent:!0,depthWrite:!1,side:we,blending:e.hexagonData.nebula_blend?Ve:Pe});const n=this.createCurvedHexagonGeometry(e.hexagonData.pole,e.hexagonData.radius);this.mesh=new xe(n,this.material),this.mesh.scale.set(e.planetRadius,e.planetRadius,e.planetRadius),this.updateVisibility()}updateVisibility(){if(!this.params.hexagonData.enabled){this.material.uniforms.visibility.value=0;return}const t=(this.params.currentTime||0)%this.params.hexagonData.cycle_duration_years/this.params.hexagonData.cycle_duration_years,i=this.params.hexagonData.visible_duration_years/this.params.hexagonData.cycle_duration_years;if(t<i){const o=t/i;o<.1?this.material.uniforms.visibility.value=o/.1:o>.9?this.material.uniforms.visibility.value=(1-o)/.1:this.material.uniforms.visibility.value=1}else this.material.uniforms.visibility.value=0}update(e){const i=(this.startTime+Date.now()/1e3*this.proceduralParams.timeSpeed)%1e3;this.material.uniforms.time.value=i,this.updateVisibility()}addToScene(e){e.add(this.mesh)}removeFromScene(e){e.remove(this.mesh)}dispose(){this.material.dispose(),this.mesh.geometry.dispose()}createCurvedHexagonGeometry(e,t){const i=e==="north"?1:-1,o=64,a=1,n=new Jt(a,a,o,o),c=n.attributes.position,d=new A;for(let l=0;l<c.count;l++){d.fromBufferAttribute(c,l);const s=d.x,u=d.y,f=Math.sqrt(s*s+u*u);if(f<=a/2){const v=f*Math.PI*.5,S=i*Math.cos(v)*1.02,E=Math.sin(v)*1.02;if(f>0){const y=s/f,x=u/f;d.x=y*E,d.y=S,d.z=x*E}else d.x=0,d.y=i*1.02,d.z=0}c.setXYZ(l,d.x,d.y,d.z)}return c.needsUpdate=!0,n.computeVertexNormals(),n}setEnabled(e){this.mesh.visible=e}}class $t{fragments;fragmentMeshes=[];params;planetRadius;constructor(e,t={}){this.planetRadius=e,this.params={fragmentCount:t.fragmentCount||20,color:t.color||new m(4473924),size:t.size||.05,distribution:t.distribution||"edge",animationSpeed:t.animationSpeed||1,rotationSpeed:t.rotationSpeed||.1,metalness:t.metalness||.9,roughness:t.roughness||.6},this.fragments=new ze,this.generateFragments()}generateFragments(){const e=new qe({color:this.params.color instanceof m?this.params.color:new m(this.params.color),metalness:this.params.metalness,roughness:this.params.roughness});for(let t=0;t<this.params.fragmentCount;t++){const i=this.generateFragmentGeometry(),o=new xe(i,e);this.positionFragment(o,t),o.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);const a=this.params.size*(Math.random()*.5+.75);o.scale.set(a,a,a),o.userData={rotationAxis:new A(Math.random()-.5,Math.random()-.5,Math.random()-.5).normalize(),rotationSpeed:(Math.random()-.5)*this.params.rotationSpeed},this.fragmentMeshes.push(o),this.fragments.add(o)}}generateFragmentGeometry(){const e=Math.floor(Math.random()*4)+3,t=[],i=[],o=[];o.push(new A(0,0,0));for(let c=0;c<e;c++){const d=c/e*Math.PI*2,l=Math.random()*.5+.5,s=(Math.random()-.5)*.3;o.push(new A(Math.cos(d)*l,Math.sin(d)*l,s))}for(let c=1;c<=e;c++){const l=o[c].clone();l.z+=Math.random()*.4+.2,o.push(l)}for(const c of o)t.push(c.x,c.y,c.z);for(let c=1;c<e;c++)i.push(0,c,c+1);i.push(0,e,1);const a=o.length-e-1;for(let c=0;c<e-1;c++)i.push(a,a+c+2,a+c+1);i.push(a,a+1,a+e);for(let c=0;c<e;c++){const d=c+1,l=(c+1)%e+1,s=d+e,u=l+e;i.push(d,s,l),i.push(l,s,u)}const n=new Ae;return n.setAttribute("position",new Ct(t,3)),n.setIndex(i),n.computeVertexNormals(),n}positionFragment(e,t){let i;switch(this.params.distribution){case"edge":i=this.generateEdgePosition(t);break;case"surface":i=this.generateSurfacePosition();break;case"random":default:i=this.generateRandomPosition();break}e.position.copy(i)}generateEdgePosition(e){const t=e/this.params.fragmentCount*Math.PI*2,i=this.planetRadius*(.95+Math.random()*.1),o=(Math.random()-.5)*this.planetRadius*.5;return new A(Math.cos(t)*i,o,Math.sin(t)*i)}generateSurfacePosition(){const e=Math.random()*Math.PI*2,t=Math.acos(Math.random()*2-1),i=this.planetRadius*(1+Math.random()*.05);return new A(i*Math.sin(t)*Math.cos(e),i*Math.sin(t)*Math.sin(e),i*Math.cos(t))}generateRandomPosition(){const e=this.planetRadius*(.8+Math.random()*.4),t=Math.random()*Math.PI*2,i=Math.random()*Math.PI*2;return new A(e*Math.sin(t)*Math.cos(i),e*Math.sin(t)*Math.sin(i),e*Math.cos(t))}addToScene(e,t){t&&this.fragments.position.copy(t),e.add(this.fragments)}update(e){this.fragmentMeshes.forEach((t,i)=>{const o=t.userData;t.rotateOnAxis(o.rotationAxis,o.rotationSpeed*e*this.params.animationSpeed);const a=Math.sin(Date.now()*.001+i)*.001;t.position.y+=a*e}),this.fragments.rotation.y+=e*.01*this.params.animationSpeed}updateParams(e){if(this.params={...this.params,...e},e.color){const t=e.color instanceof m?e.color:new m(e.color);this.fragmentMeshes.forEach(i=>{i.material instanceof qe&&(i.material.color=t)})}(e.metalness!==void 0||e.roughness!==void 0)&&this.fragmentMeshes.forEach(t=>{t.material instanceof qe&&(e.metalness!==void 0&&(t.material.metalness=e.metalness),e.roughness!==void 0&&(t.material.roughness=e.roughness))}),(e.size!==void 0||e.fragmentCount!==void 0)&&this.regenerateFragments()}regenerateFragments(){this.fragmentMeshes.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.fragments.clear(),this.fragmentMeshes=[],this.generateFragments()}getObject3D(){return this.fragments}getFragmentMeshes(){return[...this.fragmentMeshes]}dispose(){this.fragmentMeshes.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material instanceof Ze&&e.material.dispose()}),this.fragmentMeshes=[],this.fragments.clear()}}function gt(r){const e=r.replace("#",""),t=parseInt(e.substr(0,2),16)/255,i=parseInt(e.substr(2,2),16)/255,o=parseInt(e.substr(4,2),16)/255;return new m(t,i,o)}function wt(r){return r.length>=3?new m(r[0],r[1],r[2]):new m(.5,.5,.5)}function Be(r){if(r.ocean_color){if(typeof r.ocean_color=="string")return gt(r.ocean_color);if(Array.isArray(r.ocean_color))return wt(r.ocean_color)}if(r.planet_info?.base_color){if(typeof r.planet_info.base_color=="string")return gt(r.planet_info.base_color);if(Array.isArray(r.planet_info.base_color))return wt(r.planet_info.base_color)}if(r.base_color){if(typeof r.base_color=="string")return gt(r.base_color);if(Array.isArray(r.base_color))return wt(r.base_color)}const e=r.planet_info?.type||r.type||"Unknown";return vo(e)}function vo(r){const t={"Gas Giant":"#FFA500",Anomaly:"#FFFFFF",Rocky:"#808080",Icy:"#ADD8E6",Oceanic:"#0000FF",Desert:"#FFD700",Lava:"#FF0000",Arid:"#800000",Swamp:"#008000",Tundra:"#F0F8FF",Forest:"#006400",Savannah:"#F4A460",Cave:"#D1D1D1",Crystalline:"#00FFFF",Metallic:"#C0C0C0",Toxic:"#800080",Radioactive:"#00FF00",Magma:"#FF4500","Molten Core":"#FF8C00",Carbon:"#090909",Diamond:"#87CEFA","Super Earth":"#90EE90","Sub Earth":"#006400","Frozen Gas Giant":"#ADD8E6",Nebulous:"#FFC0CB",Aquifer:"#00FFFF",Exotic:"#FF00FF"}[r]||"#FFFFFF";return gt(t)}class lt{material;params;oceanLayerMesh;static vertexShader=`
  ...
  `;constructor(e,t={}){this.params={radius:t.radius||e*.999,detail:t.detail||128,flowSpeed:t.flowSpeed||.5,waveAmplitude:t.waveAmplitude||.02,opacity:t.opacity||.75,colorDeep:t.colorDeep||new m(4147),colorShallow:t.colorShallow||new m(26333),...t};const i=new dt(this.params.radius,this.params.detail,this.params.detail);this.material=new ue({vertexShader:ct.vertexShader,fragmentShader:ct.fragmentShader,uniforms:{uTime:{value:0},uFlowSpeed:{value:this.params.flowSpeed},uWaveAmplitude:{value:this.params.waveAmplitude},uFresnelPower:{value:1.5},uOpacity:{value:this.params.opacity},uColorDeep:{value:this.params.colorDeep instanceof m?this.params.colorDeep:new m(this.params.colorDeep)},uColorShallow:{value:this.params.colorShallow instanceof m?this.params.colorShallow:new m(this.params.colorShallow)},uNoiseScale:{value:3},uSecondaryWaveScale:{value:6},uPrimaryFlowSpeed:{value:this.params.flowSpeed||.5},uSecondaryFlowSpeed:{value:(this.params.flowSpeed||.5)*1.6},uUvPatternSpeed1:{value:(this.params.flowSpeed||.5)*4},uUvPatternSpeed2:{value:(this.params.flowSpeed||.5)*3}},transparent:!0,depthWrite:!1,depthTest:!0,side:we,blending:Pe}),this.mesh=new xe(i,this.material),this.mesh.renderOrder=-1,console.log("🌊 FluidLayersEffect created with params:",this.params)}addToScene(e,t){t&&this.mesh.position.copy(t),e.add(this.mesh),console.log("🌊 FluidLayers mesh added to scene at position:",this.mesh.position)}update(e,t){this.material.uniforms.uTime.value+=e,t!==void 0&&(this.mesh.rotation.y=t)}updateParams(e){if(this.params={...this.params,...e},e.flowSpeed!==void 0&&(this.material.uniforms.uFlowSpeed.value=e.flowSpeed,this.material.uniforms.uPrimaryFlowSpeed.value=e.flowSpeed,this.material.uniforms.uSecondaryFlowSpeed.value=e.flowSpeed*1.6,this.material.uniforms.uUvPatternSpeed1.value=e.flowSpeed*4,this.material.uniforms.uUvPatternSpeed2.value=e.flowSpeed*3),e.waveAmplitude!==void 0&&(this.material.uniforms.uWaveAmplitude.value=e.waveAmplitude),e.opacity!==void 0&&(this.material.uniforms.uOpacity.value=e.opacity),e.colorDeep){const t=e.colorDeep instanceof m?e.colorDeep:new m(e.colorDeep);this.material.uniforms.uColorDeep.value=t}if(e.colorShallow){const t=e.colorShallow instanceof m?e.colorShallow:new m(e.colorShallow);this.material.uniforms.uColorShallow.value=t}}getObject3D(){return this.mesh}dispose(){this.mesh.geometry&&this.mesh.geometry.dispose(),this.material&&this.material.dispose()}}function Zt(r,e){let t=.5,i=.025,o=.75;if(e.seeds){const n=e.seeds.shape_seed||e.seeds.planet_seed,d=(l=>{let s=l;return()=>(s=(s*1664525+1013904223)%4294967296,s/4294967296)})(n);t=.05+d()*.3,i=.02+d()*.02,o=.25+d()*.6}const a={radius:r*.999,detail:128,flowSpeed:t,waveAmplitude:i*.4,opacity:o,colorDeep:new m(4147),colorShallow:new m(26333)};return new ct(r,a)}const le={WAVE_HEIGHT:{min:.05,max:.12},WAVE_FREQUENCY:{min:2,max:5},WAVE_SPEED:{min:.2,max:.8},SPECULAR_INTENSITY:{min:2,max:6},TRANSPARENCY:{min:.2,max:.5},TIME_SPEED:{min:.1,max:1}};class ri{layerMesh;material;params;layerSystem;startTime;constructor(e,t={}){this.layerSystem=e;const i=t.seed||Math.floor(Math.random()*1e6),o=new U(i);this.startTime=t.startTime||i%1e4/1e3;const a=t.waterColor instanceof m?t.waterColor:t.waterColor?new m(t.waterColor):new m(3050379),n=t.deepWaterColor instanceof m?t.deepWaterColor:t.deepWaterColor?new m(t.deepWaterColor):new m(13158),c=t.foamColor instanceof m?t.foamColor:t.foamColor?new m(t.foamColor):new m(16777215);this.params={waterColor:a,deepWaterColor:n,foamColor:c,waveHeight:t.waveHeight||o.uniform(le.WAVE_HEIGHT.min,le.WAVE_HEIGHT.max),waveFrequency:t.waveFrequency||o.uniform(le.WAVE_FREQUENCY.min,le.WAVE_FREQUENCY.max),waveSpeed:t.waveSpeed||o.uniform(le.WAVE_SPEED.min,le.WAVE_SPEED.max),secondaryWaveHeight:t.secondaryWaveHeight||o.uniform(le.WAVE_HEIGHT.min*.6,le.WAVE_HEIGHT.max*.6),secondaryWaveFrequency:t.secondaryWaveFrequency||o.uniform(le.WAVE_FREQUENCY.min*1.2,le.WAVE_FREQUENCY.max*1.2),secondaryWaveSpeed:t.secondaryWaveSpeed||o.uniform(le.WAVE_SPEED.min*1.1,le.WAVE_SPEED.max*1.1),distortionScale:t.distortionScale||3,distortionSpeed:t.distortionSpeed||.5,specularIntensity:t.specularIntensity||o.uniform(le.SPECULAR_INTENSITY.min,le.SPECULAR_INTENSITY.max),reflectivity:t.reflectivity||.3,transparency:t.transparency||o.uniform(le.TRANSPARENCY.min,le.TRANSPARENCY.max),roughness:t.roughness||.1,metalness:t.metalness||.2,normalScale:t.normalScale||.05,normalSpeed:t.normalSpeed||.5,seed:i,startTime:this.startTime,timeSpeed:t.timeSpeed||o.uniform(le.TIME_SPEED.min,le.TIME_SPEED.max)},this.material=this.layerSystem.createAquiferWaterLayerMaterial(this.params),this.layerMesh=this.layerSystem.addEffectLayer("aquiferWater",this.material,this.layerSystem.getNextScaleFactor(),this)}update(e){const i=(this.startTime+Date.now()/1e3*this.params.timeSpeed)%1e3;this.material.uniforms.time&&(this.material.uniforms.time.value=i)}dispose(){}}function qt(r,e,t){const i=e.planet_info||{},o=i.base_color?typeof i.base_color=="string"?new m(i.base_color):new m().fromArray(i.base_color):new m(4886754),a={h:0,s:0,l:0};o.getHSL(a);const n=new m().setHSL(a.h,Math.min(1,a.s*1.2),Math.min(1,a.l*.8)),c=new m().setHSL(a.h,Math.min(1,a.s*1.3),Math.max(0,a.l*.4)),d=12345,l=new U(d+5e3),s={waterColor:n,deepWaterColor:c,foamColor:new m(.9,.95,1),specularIntensity:l.uniform(le.SPECULAR_INTENSITY.min,le.SPECULAR_INTENSITY.max),reflectivity:.3,transparency:l.uniform(le.TRANSPARENCY.min,le.TRANSPARENCY.max),roughness:.05,metalness:.1,normalScale:.02,normalSpeed:.6,seed:d};return new ri(r,s)}class li{sunLine=null;rotationLine=null;debugGroup;params;planetRadius;constructor(e,t={}){this.planetRadius=e,this.params={showSunLine:!0,showRotationLine:!0,showRotationInfo:!0,showTimeInfo:!0,planetRadius:e,...t},this.debugGroup=new ze,this.createDebugElements()}createDebugElements(){this.params.showSunLine&&this.createSunLine(),this.params.showRotationLine&&this.createRotationLine()}createSunLine(){const e=this.calculateSunAngle(),t=this.planetRadius*3,i=e,o=t*Math.cos(i),a=t*Math.sin(i),n=a*.8,c=new Ae,d=new Float32Array([0,0,0,o,n,a]);c.setAttribute("position",new te(d,3));const l=new Pt({color:16776960,linewidth:5,transparent:!1});this.sunLine=new At(c,l),this.debugGroup.add(this.sunLine);const s=e+Math.PI,u=t*.7,f=u*Math.cos(s),p=0,v=u*Math.sin(s),S=new dt(this.planetRadius*.15,16,16),E=new ti({color:16776960,transparent:!1,opacity:1}),y=new xe(S,E);y.position.set(f,p,v),this.debugGroup.add(y),this.createTestSpheres()}createTestSpheres(){}createRotationLine(){const e=this.calculateCurrentRotation(),t=this.planetRadius*25,i=new Ae,o=new Float32Array([-t*Math.cos(e),0,-t*Math.sin(e),t*Math.cos(e),0,t*Math.sin(e)]);i.setAttribute("position",new te(o,3));const a=new Pt({color:9079434,linewidth:2,transparent:!1});this.rotationLine=new At(i,a),this.debugGroup.add(this.rotationLine)}calculateSunAngle(){return this.params.sunAngle!==void 0?this.params.sunAngle:this.params.orbitalAngle||0}calculateCurrentRotation(){const e=this.params.currentTime||Date.now()/1e3,t=this.params.cosmicOriginTime||e-3600,i=this.params.rotationPeriod||86400,o=this.params.initialAngleRotation||0,a=e-t,n=2*Math.PI/i;return(o+a*n)%(2*Math.PI)}update(e,t){t&&(this.params={...this.params,...t}),this.sunLine&&this.params.showSunLine&&this.updateSunLine(),this.rotationLine&&this.params.showRotationLine&&this.updateRotationLine()}updateSunLine(){if(!this.sunLine)return;const t=this.calculateSunAngle(),i=this.planetRadius*20,o=this.sunLine.geometry,a=o.attributes.position.array;a[3]=i*Math.cos(t),a[4]=0,a[5]=i*Math.sin(t),o.attributes.position.needsUpdate=!0}updateRotationLine(){if(!this.rotationLine)return;const e=this.calculateCurrentRotation(),t=this.planetRadius*25,i=this.rotationLine.geometry,o=i.attributes.position.array;o[0]=-t*Math.cos(e),o[1]=0,o[2]=-t*Math.sin(e),o[3]=t*Math.cos(e),o[4]=0,o[5]=t*Math.sin(e),i.attributes.position.needsUpdate=!0}addToScene(e,t){t&&this.debugGroup.position.copy(t),e.add(this.debugGroup)}getDebugInfo(){const e=this.calculateCurrentRotation(),t=this.calculateSunAngle();return{"Current Time":new Date().toISOString(),"Planet Rotation":`${(e*180/Math.PI).toFixed(2)}°`,"Sun Angle":`${(t*180/Math.PI).toFixed(2)}°`,"Rotation Period":`${this.params.rotationPeriod}s`,"Cosmic Origin":new Date((this.params.cosmicOriginTime||0)*1e3).toISOString()}}toggleSunLine(e){this.sunLine&&(this.sunLine.visible=e)}toggleRotationLine(e){this.rotationLine&&(this.rotationLine.visible=e)}getObject3D(){return this.debugGroup}dispose(){this.debugGroup.clear(),this.sunLine&&(this.sunLine.geometry.dispose(),this.sunLine.material.dispose()),this.rotationLine&&(this.rotationLine.geometry.dispose(),this.rotationLine.material.dispose())}}function xo(r,e){const t={currentTime:Date.now()/1e3,cosmicOriginTime:r.debug?.cosmic_origin_time||r.timing?.cosmic_origin_time||r.cosmicOriginTime,rotationPeriod:r.planet_info?.rotation_period||r.rotation_period_seconds||86400,initialAngleRotation:r.debug?.initial_angle_rotation||r.timing?.initial_angle_rotation||r.initialAngleRotation||0,planetRadius:e,orbitalAngle:r.timing?.orbital_angle||0,sunAngle:r.sun_angle||r.lighting?.sun_angle,showSunLine:!0,showRotationLine:!0,showRotationInfo:!0,showTimeInfo:!0};return new li(e,t)}const bo=!1;class He{static instance;creators=new Map;effects=new Map;nextId=1;layerSystem;constructor(){this.registerDefaultEffects()}static getInstance(){return He.instance||(He.instance=new He),He.instance}registerDefaultEffects(){this.registerEffect("atmosphere_glow",{create:(e,t)=>new at(t,e),fromPythonData:(e,t)=>Vt(t,e.atmosphere||{})}),this.registerEffect("atmosphere_clouds",{create:(e,t)=>new Xe(t,e),fromPythonData:(e,t)=>Ue(t,e.surface_elements||{})}),this.registerEffect("atmospheric_streaks",{create:(e,t)=>new ni(t,e),fromPythonData:(e,t)=>Ht(t,e.atmosphere||{})}),this.registerEffect("atmosphere",{create:(e,t)=>new ot(t,e),fromPythonData:(e,t)=>to(t,e)}),this.registerEffect("ring_system",{create:(e,t)=>new oi(t,e),fromPythonData:(e,t)=>eo(e.rings||{},t)}),this.registerEffect("fragmentation",{create:(e,t)=>new $t(t,e),fromPythonData:(e,t)=>new $t(t,{color:e.surface?.fragment_color||[.3,.3,.3],fragmentCount:e.surface?.fragment_count||20})}),this.registerEffect("land_masses",{create:(e,t)=>new Dt(t,e),fromPythonData:(e,t)=>pt(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("ocean_waves",{create:(e,t)=>new lt(e),fromPythonData:(e,t)=>yo(e)}),this.registerEffect("aquifer_water",{create:(e,t,i)=>new ri(i,e),fromPythonData:(e,t,i)=>qt(i,e)}),this.registerEffect("fluid_layers",{create:(e,t)=>new ct(t,e),fromPythonData:(e,t)=>Zt(t,e)}),this.registerEffect("lava_flows",{create:(e,t)=>(console.warn("Lava flows effect not implemented yet"),null)}),this.registerEffect("crystal_formations",{create:(e,t)=>(console.warn("Crystal formations effect not implemented yet"),null)}),this.registerEffect("star_field",{create:(e,t)=>new rt(t,e),fromPythonData:(e,t)=>fo(t,e.seeds?.planet_seed||e.planet_seed)}),this.registerEffect("tundra_snowflakes",{create:(e,t)=>new ai(t,e),fromPythonData:(e,t)=>Yt(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("anomaly_phase_matter",{create:(e,t)=>new st(t,e),fromPythonData:(e,t)=>ao(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("pulsating_cube",{create:(e,t)=>new si(t,e),fromPythonData:(e,t)=>{const i=Be(e);return so(t,e.surface_elements||{},e.seeds?.planet_seed,i,e)}}),this.registerEffect("visual_debug_3d",{create:(e,t)=>new li(t,e),fromPythonData:(e,t)=>xo(e,t)})}registerEffect(e,t){this.creators.set(e,t)}createEffect(e,t,i,o,a=0){const n=this.creators.get(e);if(!n)return console.warn(`Effect type '${e}' not registered`),null;try{const c=n.create(t,i,o);if(!c)return null;const d={id:`effect_${this.nextId++}`,type:e,effect:c,priority:a,enabled:!0};return this.effects.set(d.id,d),d}catch(c){return console.error(`Error creating effect '${e}':`,c),null}}createEffectFromPythonData(e,t,i,o,a=0){const n=this.creators.get(e);if(!n||!n.fromPythonData)return this.createEffect(e,t,i,o,a);try{const c=n.fromPythonData(t,i,o);if(!c)return null;const d={id:`effect_${this.nextId++}`,type:e,effect:c,priority:a,enabled:!0};return this.effects.set(d.id,d),d}catch(c){return console.error(`Error creating effect '${e}' from Python data:`,c),null}}createEffectsFromList(e,t,i){const o=[],a=e.sort((n,c)=>(n.priority||0)-(c.priority||0));for(const n of a){const c=this.createEffect(n.type,n.params,t,i,n.priority);c&&(c.enabled=n.enabled!==!1,o.push(c))}return o}createEffectsFromPythonPlanetData(e,t,i,o,a){const n=[];try{const c=Be(e);if(a?this.layerSystem=a:this.layerSystem=new nt(i,c),e.surface_elements){const s=e.surface_elements;if(s.effects_3d&&Array.isArray(s.effects_3d))for(const u of s.effects_3d){if(u.type==="atmospheric_streaks"){const p=Ht(t,u.params,e.seeds?.shape_seed+3e3),v={id:`effect_${this.nextId++}`,type:"atmospheric_streaks",effect:p,priority:u.priority||0,enabled:!0,name:"Atmospheric Streaks"};this.effects.set(v.id,v),n.push(v),p.addToScene(o,i.position);continue}const f=this.createEffect(u.type,u.params,t,i,u.priority||0);f?(f.name=u.type.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase()),n.push(f),f.effect.apply&&f.effect.apply(i),f.effect.addToScene&&f.effect.addToScene(o,i.position)):console.error("❌ FALLO AL CREAR EFECTO:",u.type)}switch(console.log(`🔍 Planet surface type: "${s.type}"`),console.log(`🔍 Planet info type: "${e.planet_info?.type}"`),s.type.toLowerCase()){case"gas_giant":if(this.layerSystem){const g=Gt(this.layerSystem,{...s,base_color:c,turbulence:e.turbulence||s.turbulence},e.seeds?.shape_seed||e.seeds?.planet_seed||e.seeds?.planet_seed),b=Bt(this.layerSystem,{...s,base_color:c,storm_intensity:e.storm_intensity||s.storm_intensity},(e.seeds?.shape_seed||e.seeds?.planet_seed)+1e3),I={id:`effect_${this.nextId++}`,type:"cloud_bands_layer",effect:g,priority:0,enabled:!0};this.effects.set(I.id,I),n.push(I);const T={id:`effect_${this.nextId++}`,type:"cloud_gyros_layer",effect:b,priority:1,enabled:!0};if(this.effects.set(T.id,T),n.push(T),s.polar_hexagon&&s.polar_hexagon.enabled){const P=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,L=new _t({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:P}),O={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:L,priority:10,enabled:!0};this.effects.set(O.id,O),n.push(O),o&&L.addToScene(o)}}else console.error("❌ PlanetLayerSystem not initialized!");break;case"frozen_gas_giant":if(this.layerSystem){const g=Gt(this.layerSystem,{...s,base_color:c,turbulence:e.turbulence||s.turbulence,icy_tint:!0},e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"cloud_bands_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.polar_hexagon&&s.polar_hexagon.enabled){const I=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,T=new _t({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:I}),P={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:T,priority:10,enabled:!0};this.effects.set(P.id,P),n.push(P),o&&T.addToScene(o)}}break;case"aquifer":console.log("🌊 Processing Aquifer planet with surface data:",s),console.log("🌊 Surface.clouds:",s.clouds);const u=qt(this.layerSystem,e);if(u){const g={id:`effect_${this.nextId++}`,type:"aquifer_water",effect:u,priority:2,enabled:!0,name:"Aquifer Water Surface"};this.effects.set(g.id,g),n.push(g),console.log("🌊 AquiferWater effect added for aquifer planet")}if(s.clouds&&s.clouds.length>0){const g=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("☁️ Atmospheric Clouds added to Aquifer planet")}if(s.land_masses&&s.land_masses.length>0){const g=pt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+7e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:3,enabled:!0,name:"Emergent Land Masses"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}if(s.atmosphere_clouds&&s.atmosphere_clouds.length>0){const g=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+8e3);if(g){const b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:4,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}break;case"nebulous":if(this.layerSystem){const g=Bt(this.layerSystem,{...s,base_color:c,storm_intensity:s.nebula_density||.6,color_variance:s.color_variance||.2},(e.seeds?.shape_seed||e.seeds?.planet_seed)+2e3),b={id:`effect_${this.nextId++}`,type:"cloud_gyros_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.polar_hexagon&&s.polar_hexagon.enabled){const I=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,T=new _t({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:I}),P={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:T,priority:10,enabled:!0};this.effects.set(P.id,P),n.push(P),o&&T.addToScene(o)}}break;case"metallic":case"metallic_3d":if(this.layerSystem){const g=uo(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"metallic_surface_layer",effect:g,priority:0,enabled:!0};this.effects.set(b.id,b),n.push(b)}break;case"rocky":if(this.layerSystem){const g=lo(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"rocky_terrain_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.clouds&&s.clouds.length>0){const I=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),T={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:I,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(T.id,T),n.push(T),I.addToScene(o,i.position)}}break;case"icy":if(this.layerSystem){const g=ho(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"icy_terrain_layer",effect:g,priority:0,enabled:!0};this.effects.set(b.id,b),n.push(b);const I=io(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+8e3);if(I){const P={id:`effect_${this.nextId++}`,type:"transparent_land_masses",effect:I,priority:1,enabled:!0,name:"Ice Formations"};this.effects.set(P.id,P),n.push(P),I.addToScene(o,i.position),console.log("🧊 Ice Formations (transparent LandMasses) added to Icy planet")}else console.warn("❄️ Failed to create transparent LandMasses for Icy planet");if(s.clouds&&s.clouds.length>0){const P=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),L={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:P,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(L.id,L),n.push(L),P.addToScene(o,i.position),console.log("☁️ Atmospheric Clouds added to Icy planet")}const T=Wt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+9e3);if(T){const P={id:`effect_${this.nextId++}`,type:"icy_features",effect:T,priority:2,enabled:!0,name:"Ice Crystals & Features"};this.effects.set(P.id,P),n.push(P),T.addToScene(o,i.position),console.log("❄️ Icy Features (crystals, cracks, ice caps) added to Icy planet")}}break;case"oceanic":const f=Zt(t,e);if(f){const g={id:`effect_${this.nextId++}`,type:"fluid_layers",effect:f,priority:3,enabled:!0,name:"Fluid Ocean Layers"};this.effects.set(g.id,g),n.push(g),f.addToScene(o,i.position),console.log("🌊 FluidLayers effect added for oceanic planet")}if(s.green_patches&&s.green_patches.length>0){const g=pt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+6e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:5,enabled:!0,name:"Land Masses (Islands)"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}if(s.clouds&&s.clouds.length>0){const g=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}break;case"tundra":if(s.green_patches&&s.green_patches.length>0){const g=pt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+6e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:5,enabled:!0,name:"Tundra Terrain"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("🏔️ Tundra terrain (LandMasses) added")}}const p=Wt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+9e3);if(p){const g={id:`effect_${this.nextId++}`,type:"icy_features",effect:p,priority:6,enabled:!0,name:"Snow Patches & Ice"};this.effects.set(g.id,g),n.push(g),p.addToScene(o,i.position),console.log("❄️ Sparse ice features added to Tundra planet")}if(s.clouds&&s.clouds.length>0){const g=Ue(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("☁️ Atmospheric clouds added to Tundra planet")}const v=Yt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+15e3);if(v){const g={id:`effect_${this.nextId++}`,type:"tundra_snowflakes",effect:v,priority:20,enabled:!0,name:"Snowflakes"};this.effects.set(g.id,g),n.push(g),v.addToScene(o,i.position),console.log("❄️ Tundra snowflakes added to Tundra planet")}break;case"anomaly":console.log("🌌 DETECTED ANOMALY PLANET - Creating effects"),console.log("🌌 Planet data:",{surfaceType:s.type,planetType:e.planet_info?.type}),console.log("🎭 SHOWCASE MODE: Activating ALL anomaly effects for evaluation");const E=["anomaly_phase_matter","pulsating_cube"],y=e.seeds?.planet_seed||Math.floor(Math.random()*1e6),x=E.length;for(let g=0;g<x;g++){const b=E[g],I=y+g*1e4,T=this.createEffectFromPythonData(b,{...e,seeds:{...e.seeds,planet_seed:I}},t,i,10+g);T&&(T.name=b.replace(/_/g," ").replace(/\b\w/g,P=>P.toUpperCase()),n.push(T),T.effect.addToScene&&T.effect.addToScene(o,i.position),console.log(`🎭 Added anomaly effect: ${T.name}`))}if(e.atmosphere&&e.atmosphere.type!=="None"){const g=this.createEffectFromPythonData("atmosphere",e.atmosphere,t,i,5);g&&(n.push(g),g.effect.addToScene(o,i.position),console.log("🌫️ Anomalous atmosphere added"))}break;default:if(e.planet_info?.type?.toLowerCase()==="anomaly"){console.log("🌌 DETECTED ANOMALY PLANET via planet_info.type - Creating effects"),console.log("🎭 SHOWCASE MODE (alt detection): Activating ALL anomaly effects for evaluation");const b=["anomaly_phase_matter","pulsating_cube"],I=e.seeds?.planet_seed||Math.floor(Math.random()*1e6),T=b.length;for(let P=0;P<T;P++){const L=b[P],O=I+P*1e4,k=this.createEffectFromPythonData(L,{...e,seeds:{...e.seeds,planet_seed:O}},t,i,10+P);k&&(k.name=L.replace(/_/g," ").replace(/\b\w/g,C=>C.toUpperCase()),n.push(k),k.effect.addToScene&&k.effect.addToScene(o,i.position),console.log(`🎭 Added anomaly effect: ${k.name}`))}if(e.atmosphere&&e.atmosphere.type!=="None"){const P=this.createEffectFromPythonData("atmosphere",e.atmosphere,t,i,5);P&&(n.push(P),P.effect.addToScene(o,i.position),console.log("🌫️ Anomalous atmosphere added"))}}else if(i.material instanceof qe){const g=Be(e);i.material.color.copy(g)}break}}else if(i.material instanceof qe){const s=Be(e);i.material.color.copy(s)}const d=e.planet_info?.type?.toLowerCase()||e.surface_elements?.type?.toLowerCase(),l=d==="anomaly"||e.surface_elements?.type==="anomaly";if(e.atmosphere&&!l){if(e.atmosphere.streaks||["Gas Giant","Frozen Gas Giant"].includes(e.planet_info?.type)){const s=Vt(t,e.atmosphere||{},e.seeds?.shape_seed+2e3);if(s){const u={id:`effect_${this.nextId++}`,type:"atmosphere_glow",effect:s,priority:20,enabled:!0};this.effects.set(u.id,u),n.push(u),s.addToScene(o,i.position)}}if(e.atmosphere.type&&e.atmosphere.type!=="None"){const s={...e.atmosphere};d==="oceanic"&&(s.opacity=Math.min(s.opacity||.3,.15),s.width=Math.min(s.width||15,8));const u=this.createEffectFromPythonData("atmosphere",s,t,i,5);u&&(n.push(u),u.effect.addToScene(o,i.position))}}if(e.rings&&e.rings.has_rings||["Gas Giant","Frozen Gas Giant","Super Earth"].includes(e.planet_info?.type)){const s=this.createEffectFromPythonData("ring_system",e,t,i,1);s?(n.push(s),s.effect.addToScene(o,i.position)):console.warn("⚠️ Failed to create ring effect")}if(e.surface_elements?.has_fragmentation_zones){const s=this.createEffectFromPythonData("fragmentation",e,t,i,5);s&&(n.push(s),s.effect.addToScene(o,i.position))}this.layerSystem&&this.layerSystem.addToScene(o);try{const s=this.createEffectFromPythonData("star_field",e,t,i,-100);s&&s.effect&&(s.effect.addToScene(o,i.position),n.push(s),console.log("⭐ StarField added automatically using planet seed:",e.seeds?.planet_seed))}catch(s){console.warn("Could not create StarField:",s)}return n.forEach((s,u)=>{}),n.length===0&&console.warn("⚠️ NO EFFECTS WERE CREATED! Check the data structure and conditions."),n}catch(c){throw console.error("Error in EffectRegistry.createEffectsFromPythonPlanetData:",c),c}}getEffect(e){return this.effects.get(e)||null}getEffectsByType(e){return Array.from(this.effects.values()).filter(t=>t.type===e)}getAllEffects(){return Array.from(this.effects.values())}toggleEffect(e,t){const i=this.effects.get(e);if(i){i.enabled=t!==void 0?t:!i.enabled;const o=i.effect;if(o&&o.getObject3D){const a=o.getObject3D();a&&(a.visible=i.enabled,console.log(`🎮 Toggle effect ${i.type}: visible = ${i.enabled}`))}if(this.layerSystem){const a=this.layerSystem.getLayerMeshes(),c={cloud_bands_layer:"cloudBands",cloud_gyros_layer:"cloudGyros",metallic_surface_layer:"metallicSurface",rocky_terrain_layer:"rockyTerrain",icy_terrain_layer:"icyTerrain",aquifer_water:"aquiferWater"}[i.type];c&&a[c]&&(a[c].visible=i.enabled)}}else console.warn(`⚠️ Effect not found: ${e}`)}updateAllEffects(e,t){this.layerSystem&&this.layerSystem.update(e,t);for(const i of this.effects.values())if(i.enabled&&i.effect.update)try{i.effect.update(e,t)}catch(o){console.error(`Error updating effect ${i.type}:`,o)}}updateLightForAllEffects(e){console.log("🔆 updateLightForAllEffects called with light position:",e.position),this.layerSystem&&this.layerSystem.updateFromThreeLight(e),console.log("🔆 Checking",this.effects.size,"effects for light updates");for(const t of this.effects.values())if(console.log(`🔆 Effect ${t.type}, enabled: ${t.enabled}, hasUpdateFromThreeLight: ${!!t.effect.updateFromThreeLight}`),t.enabled&&t.effect.updateFromThreeLight)try{console.log(`🔆 Updating light for effect: ${t.type}`),t.effect.updateFromThreeLight(e)}catch(i){console.error(`Error updating light for effect ${t.type}:`,i)}}removeEffect(e){const t=this.effects.get(e);t&&(t.effect.dispose&&t.effect.dispose(),this.effects.delete(e))}clearAllEffects(){this.layerSystem&&(this.layerSystem.dispose(),this.layerSystem=void 0);for(const e of this.effects.values())e.effect.dispose&&e.effect.dispose();this.effects.clear(),this.nextId=1}getStats(){const e=Array.from(this.effects.values());return{registeredTypes:this.creators.size,activeEffects:e.length,enabledEffects:e.filter(t=>t.enabled).length}}getAvailableEffectTypes(){return Array.from(this.creators.keys())}}const Re=He.getInstance(),Ye={atmosphere:{type:"Thin",width:12,opacity:.2,density:1},cloud_bands:{numBands:8,animationSpeed:1,turbulence:.5},cloud_gyros:{stormIntensity:.8,spiralSpeed:2,animationSpeed:1},atmosphere_glow:{particleCount:500,speed:.4,size:1,opacity:1}};function So(r){const e=[];switch(r.toLowerCase()){case"metallic":e.push({type:"atmosphere",params:{...Ye.atmosphere,color:[.6,.1,.9,.2]},priority:10},{type:"atmospheric_streaks",params:{color:[.95,.95,1],particleCount:100},priority:20});break;case"gas giant":e.push({type:"cloud_bands",params:Ye.cloud_bands,priority:0},{type:"cloud_gyros",params:Ye.cloud_gyros,priority:1},{type:"atmosphere",params:{...Ye.atmosphere,color:[1,.6,.2,.2]},priority:10},{type:"atmosphere_glow",params:Ye.atmosphere_glow,priority:20});break;case"icy":e.push({type:"atmosphere",params:{...Ye.atmosphere,color:[.5,.8,1,.15]},priority:10});break;default:e.push({type:"atmosphere",params:{color:[.5,.5,.8,.15]},priority:10});break}return e}const Ie={log:(r,e)=>{},warn:(r,e)=>{console.warn(`[Effects] ${r}`,e||"")},error:(r,e)=>{console.error(`[Effects] ${r}`,e||"")},debug:(r,e)=>{}};new Date().toISOString();const _o=({planetData:r,showInConsole:e=!0,showInPage:t=!1})=>{const[i,o]=M.useState([]),[a,n]=M.useState({});M.useEffect(()=>{if(!r)return;const l=c(r);n(l),o(d(r)),typeof window<"u"&&(window.__DEBUG_PLANET_DATA=r,window.__DEBUG_PLANET_ANALYSIS=l)},[r,e]);function c(l){const s={hasValidStructure:!1,missingFields:[],dataIntegrity:"unknown",renderingIssues:[],colorConsistency:"unknown"};if(l.planet_info&&l.surface_elements?s.hasValidStructure=!0:(l.planet_info||s.missingFields.push("planet_info"),l.surface_elements||s.missingFields.push("surface_elements")),l.surface_elements?.type==="oceanic"&&(s.oceanicData={hasAbstractLands:!!l.surface_elements.abstract_lands?.length,numGreenPatches:l.surface_elements.green_patches?.length||0,numClouds:l.surface_elements.clouds?.length||0,hasDepths:l.surface_elements.depths?.enabled||!1,baseColorIsBlue:l.planet_info?.base_color==="#0000FF",greenPatchColor:l.surface_elements.green_patches?.[0]?.color,issues:[]},s.oceanicData.numGreenPatches>15&&s.oceanicData.issues.push("Muchos parches verdes pueden ocultar el océano azul"),s.oceanicData.baseColorIsBlue||s.oceanicData.issues.push(`Color base no es azul puro: ${l.planet_info?.base_color}`),s.renderingIssues=s.oceanicData.issues),l.planet_info?.base_color&&l.planet_info?.type){const f={Oceanic:"#0000FF",Rocky:"#808080",Icy:"#ADD8E6",Desert:"#FFD700",Lava:"#FF0000"}[l.planet_info.type];f&&l.planet_info.base_color!==f?s.colorConsistency=`Inconsistente: esperado ${f}, recibido ${l.planet_info.base_color}`:s.colorConsistency="Correcto"}return s}function d(l){const s=[];if(!l.surface_elements?.type)return["No surface type defined"];const u=l.surface_elements.type.toLowerCase();switch(u){case"oceanic":s.push("OceanWavesEffect (PROBLEMA: ignora green_patches de Python)");break;case"rocky":s.push("RockyTerrainEffect");break;case"icy":s.push("IcyTerrainEffect");break;case"gas giant":s.push("GasGiantBandsEffect");break;default:s.push(`Generic effect for type: ${u}`)}return l.atmosphere?.density>0&&s.push("AtmosphericEffect"),l.rings&&s.push("RingSystemEffect"),s}return t?h.jsxs("div",{style:{position:"fixed",top:10,right:10,background:"rgba(0, 0, 0, 0.9)",color:"#00ff00",padding:"10px",borderRadius:"5px",fontFamily:"monospace",fontSize:"12px",maxWidth:"400px",maxHeight:"600px",overflow:"auto",zIndex:1e4,border:"1px solid #00ff00"},children:[h.jsxs("h3",{style:{margin:"0 0 10px 0",color:"#00ff00"},children:["🔍 Planet Debug: ",r.planet_info?.name]}),h.jsxs("div",{style:{marginBottom:"10px"},children:[h.jsx("strong",{children:"Type:"})," ",r.planet_info?.type,h.jsx("br",{}),h.jsx("strong",{children:"Base Color:"})," ",r.planet_info?.base_color,h.jsx("br",{}),h.jsx("strong",{children:"Radius:"})," ",r.planet_info?.radius]}),r.surface_elements?.type==="oceanic"&&h.jsxs("div",{style:{marginBottom:"10px",borderTop:"1px solid #00ff00",paddingTop:"10px"},children:[h.jsx("strong",{children:"🌊 Oceanic Data:"}),h.jsx("br",{}),h.jsxs("span",{style:{color:a.oceanicData?.baseColorIsBlue?"#00ff00":"#ff0000"},children:["Base Color: ",a.oceanicData?.baseColorIsBlue?"✓ Blue":"✗ Not Blue"]}),h.jsx("br",{}),"Green Patches: ",a.oceanicData?.numGreenPatches,h.jsx("br",{}),"Clouds: ",a.oceanicData?.numClouds,h.jsx("br",{}),"Has Depths: ",a.oceanicData?.hasDepths?"Yes":"No",h.jsx("br",{}),a.oceanicData?.issues?.length>0&&h.jsxs("div",{style:{color:"#ffaa00",marginTop:"5px"},children:["⚠️ Issues:",h.jsx("br",{}),a.oceanicData.issues.map((l,s)=>h.jsxs("div",{children:["- ",l]},s))]})]}),h.jsxs("div",{style:{borderTop:"1px solid #00ff00",paddingTop:"10px"},children:[h.jsx("strong",{children:"🎨 Effects Applied:"}),h.jsx("br",{}),i.map((l,s)=>h.jsxs("div",{style:{color:l.includes("PROBLEMA")?"#ff0000":"#00ff00"},children:["- ",l]},s))]}),h.jsx("button",{style:{marginTop:"10px",background:"#00ff00",color:"#000",border:"none",padding:"5px 10px",cursor:"pointer",borderRadius:"3px"},children:"Log to Console"})]}):null};function wo(r){M.useEffect(()=>{if(r&&r.surface_elements?.type==="oceanic"){r.surface_elements.green_patches?.length>0;const e=r.planet_info?.base_color;e!=="#0000FF"&&console.warn("⚠️ Planeta oceánico sin color azul base!",e)}},[r])}const vt=2.5,Xt=()=>{const r=45*Math.PI/180;return vt/(Math.tan(r/2)*.5)},Eo=({planetName:r,containerClassName:e="",width:t=800,height:i=600,autoRotate:o=!0,enableControls:a=!0,showDebugInfo:n=!1,planetData:c,cosmicOriginTime:d,initialAngleRotation:l,onDataLoaded:s,onEffectsCreated:u,onError:f})=>{const p=M.useRef(null),v=M.useRef(null),S=M.useRef(null),E=M.useRef(null),y=M.useRef(null),x=M.useRef(null),g=M.useRef(new Ii),b=M.useRef(null),I=M.useRef(0),T=M.useRef(null),[P,L]=M.useState(!0),[O,k]=M.useState(null),[C,V]=M.useState(null),[W,G]=M.useState([]),[ee,Z]=M.useState({activeEffects:0,enabledEffects:0,frameRate:0,renderTime:0}),K=M.useRef([]),D=M.useRef(0),F=M.useRef(null),z=M.useRef(null),q=Math.floor(Date.now()/1e3),[ie,fe]=M.useState(0),oe=d||C?.timing?.cosmic_origin_time||Date.now()/1e3-3600,pe=q-oe+ie;I.current=pe;const ve=M.useCallback(()=>{if(!p.current||!S.current||!E.current)return;const _=p.current,N=_.clientWidth||400,w=_.clientHeight||400;S.current.setSize(N,w),E.current.aspect=N/w,E.current.updateProjectionMatrix()},[]),Se=async _=>{if(!(!y.current||!v.current||!z.current)){Ie.log("Applying modular effects from API data",{planet:_.planet_info.name,type:_.planet_info.type});try{Me();const N=Be(_);z.current.updateBaseColor(N);const w=Re.createEffectsFromPythonPlanetData(_,vt,y.current,v.current,z.current);console.log(`Planet: ${_.planet_info?.name}, Effects:`,w.map(R=>R.type)),G(w),K.current=w,u&&u(w),Ie.log(`Successfully applied ${w.length} modular effects`),et()}catch(N){Ie.error("Error applying modular effects",N),We()}}},ye=M.useCallback(()=>{if(!p.current)return!1;try{for(;p.current.firstChild;)p.current.removeChild(p.current.firstChild);v.current=null,E.current=null,S.current=null,y.current=null,re.current=null;const _=p.current,N=_.clientWidth||t||400,w=_.clientHeight||i||400,R=new Ni;R.background=new m(1297),v.current=R;const ae=new Di(45,N/w,.1,1e4),X=Xt();ae.position.set(0,0,X),ae.lookAt(0,0,0),E.current=ae;const Y=new Ri({antialias:!0,alpha:!0,powerPreference:"high-performance"});return Y.setSize(N,w),Y.setPixelRatio(Math.min(window.devicePixelRatio,2)),Y.shadowMap.enabled=!0,Y.shadowMap.type=Li,Y.toneMapping=Oi,Y.toneMappingExposure=1.2,Y.outputColorSpace=zi,p.current.appendChild(Y.domElement),S.current=Y,Qe(R,null),Je(R),a&&ht(ae,Y.domElement),!0}catch(_){return console.error("Error initializing Three.js:",_),!1}},[C,c,d]),Ce=_=>{if(!_)return 0;const N=_.sun_angle||_.lighting?.sun_angle;if(N!==void 0)return N;const w=_.timing?.current_orbital_angle||_.timing?.orbital_angle;return w??0},de=M.useRef(null),Ne=M.useRef(null),Te=M.useRef(null),re=M.useRef(null),De=_=>{_.castShadow=!0,_.shadow.mapSize.width=2048,_.shadow.mapSize.height=2048,_.shadow.camera.near=.5,_.shadow.camera.far=50,_.shadow.camera.left=-10,_.shadow.camera.right=10,_.shadow.camera.top=10,_.shadow.camera.bottom=-10},Fe=_=>{if(!de.current||!v.current)return;const N=Ce(_),w=10,R=N+Math.PI,ae=Math.sin(N)*5,X=w*Math.cos(R),Y=ae,ke=w*Math.sin(R);de.current.position.set(X,Y,ke),de.current.target.position.set(0,0,0),v.current.children.includes(de.current.target)||v.current.add(de.current.target),Ne.current&&Ne.current.position.set(-X*.5,0,-ke*.5),z.current&&de.current&&z.current.updateFromThreeLight(de.current),de.current&&Re.updateLightForAllEffects(de.current)},Qe=(_,N)=>{{const w=new Ft(16777215,2);w.position.set(-10,5,10),w.target.position.set(0,0,0),w.castShadow=!0,De(w),_.add(w),_.add(w.target),de.current=w;const R=new Ft(16777215,.05);R.position.set(8,-3,-5),_.add(R),Ne.current=R;const ae=new Fi(2236996,.1);_.add(ae),setTimeout(()=>{z.current&&w&&z.current.updateFromThreeLight(w),w&&Re.updateLightForAllEffects(w)},50);return}},Je=_=>{const N=new dt(vt,128,64),w=new ti({color:8421504}),R=new xe(N,w);R.castShadow=!0,R.receiveShadow=!0,R.position.set(0,0,0),_.add(R),y.current=R;const ae=new m(8421504);z.current=new nt(R,ae),z.current.addToScene(_)},ht=(_,N)=>{const w=new Vi(_,N);w.enableDamping=!0,w.dampingFactor=.05;const R=Xt();w.minDistance=R*.5,w.maxDistance=R*2,w.autoRotate=o,w.autoRotateSpeed=.5,w.enablePan=!0,w.enableZoom=!0,w.target.set(0,0,0),x.current=w},je=M.useCallback(async()=>{if(!window.isLoadingPlanetData){window.isLoadingPlanetData=!0;try{L(!0),k(null),Ie.log("Loading planet data from API",{planetName:r});const N=await fetch("/api/planet/rendering-data");if(!N.ok)throw new Error(`HTTP error! status: ${N.status}`);const w=await N.json();if(!w.success)throw new Error(w.error||"Failed to fetch planet data");const R=w.planet_data,ae=w.timing,X=w.rendering_data,Y={planet_info:X?.planet_info||{name:R.name,type:R.planet_type,base_color:"#808080",radius:R.diameter/15e3,orbital_radius:R.orbital_radius},surface_elements:X?.surface_elements,atmosphere:X?.atmosphere,rings:X?.rings,effects_3d:X?.effects_3d,shader_uniforms:X?.shader_uniforms,universal_actions:X?.universal_actions,timing:{cosmic_origin_time:ae.cosmic_origin_time,current_time_seconds:ae.current_time_seconds,elapsed_time:ae.elapsed_time,initial_orbital_angle:R.initial_orbital_angle,current_orbital_angle:R.current_orbital_angle,max_orbital_radius:ae.max_orbital_radius,system_max_orbital_radius:R.system_max_orbital_radius},original_planet_data:R,seeds:X?.seeds};return V(Y),T.current=Y,Ie.log("API data loaded successfully",{planet:Y.planet_info.name,type:Y.planet_info.type,hasEffects:!!Y.surface_elements,fullRenderingData:X}),s&&s(Y),Y}catch(_){const N=_ instanceof Error?_.message:"Unknown error";return k(N),f&&f(N),null}finally{L(!1),window.isLoadingPlanetData=!1}}},[r,s,f]);M.useCallback(async()=>{if(!window.isLoadingPlanetData){window.isLoadingPlanetData=!0;try{L(!0),k(null),Ie.log("Loading planet data from API",{planetName:r});const N=await fetch("/api/planet/rendering-data");if(!N.ok)throw new Error(`HTTP error! status: ${N.status}`);const w=await N.json();if(!w.success)throw new Error(w.error||"Failed to fetch planet data");const R=w.planet_data,ae=w.timing,X=w.rendering_data,Y={planet_info:X?.planet_info||{name:R.name,type:R.planet_type,base_color:"#808080",radius:R.diameter/15e3,orbital_radius:R.orbital_radius},surface_elements:X?.surface_elements,atmosphere:X?.atmosphere,rings:X?.rings,effects_3d:X?.effects_3d,shader_uniforms:X?.shader_uniforms,universal_actions:X?.universal_actions,timing:{cosmic_origin_time:ae.cosmic_origin_time,current_time_seconds:ae.current_time_seconds,elapsed_time:ae.elapsed_time,initial_orbital_angle:R.initial_orbital_angle,current_orbital_angle:R.current_orbital_angle,max_orbital_radius:ae.max_orbital_radius,system_max_orbital_radius:R.system_max_orbital_radius},original_planet_data:R,seeds:X?.seeds};V(Y),T.current=Y,Ie.log("API data loaded successfully",{planet:Y.planet_info.name,type:Y.planet_info.type,hasEffects:!!Y.surface_elements,fullRenderingData:X}),Fe(Y),re.current&&v.current&&(v.current.remove(re.current),re.current.geometry.dispose(),re.current.material.dispose(),re.current=null),await Se(Y),s&&s(Y)}catch(_){const N=_ instanceof Error?_.message:"Unknown error";k(N),f&&f(N),We()}finally{L(!1),window.isLoadingPlanetData=!1}}},[r,c,d,l]);const Le=M.useCallback(()=>{if(!C||!y.current)return;const _=c?.orbital_period_seconds||365.25*24*3600,N=2*Math.PI/_,w=C.timing?.initial_orbital_angle||0,R=Date.now()/1e3,ae=0,X=d||C.timing?.cosmic_origin_time||Date.now()/1e3-3600,Y=R-X+ae,ke=(w+Y*N)%(2*Math.PI),bt=C.timing?.max_orbital_radius||100,ut=20+C.planet_info?.orbital_radius/bt*80,ci=ut,di=ut*Math.cos(ke),hi=ci*Math.sin(ke);y.current.position.x=di,y.current.position.z=hi,y.current.position.y=0},[C,c,d]),xt=M.useCallback(async _=>{const N=_||C;if(N&&v.current)try{Fe(N),re.current&&v.current&&(v.current.remove(re.current),re.current.geometry.dispose(),re.current.material.dispose(),re.current=null),await Se(N)}catch(w){Ie.error("Error in applyProceduralShadersFromAPI:",w),We()}},[C]),We=()=>{if(!(!v.current||!y.current)){Ie.warn("Applying fallback effects for planet type:",c?.planet_type);try{Me(),y.current.material instanceof qe&&y.current.material.color.setHex(6710886);try{const _=So("generic"),N=Re.createEffectsFromList(_,vt,y.current);N.forEach(w=>{w.effect.addToScene&&v.current&&y.current&&w.effect.addToScene(v.current,y.current.position)}),K.current=N,G(N)}catch(_){console.warn("Could not create fallback effects, using basic material only:",_)}et()}catch(_){Ie.error("Error applying fallback effects",_)}}},Me=()=>{Re.clearAllEffects(),K.current.forEach(_=>{try{_.effect.dispose&&_.effect.dispose()}catch{}}),K.current=[],G([])},mt=M.useCallback(()=>{b.current=requestAnimationFrame(mt);const _=performance.now(),N=g.current.getDelta();x.current&&x.current.update();try{Re.updateAllEffects(N,y.current?.rotation.y)}catch{}if(y.current&&T.current){T.current.planet_info?.name;const w=T.current.original_planet_data,R=w?.orbital_period_seconds||365.25*24*3600,ae=T.current.timing?.initial_orbital_angle||0;d||T.current.timing?.cosmic_origin_time||Date.now()/1e3-3600;const X=w?.axial_tilt||0,Y=2*Math.PI/R;(ae+I.current*Y)%(2*Math.PI);const ke=T.current.timing?.max_orbital_radius||T.current.timing?.system_max_orbital_radius,bt=w?.orbital_radius;if(!ke||!bt)return;w?.eccentricity_factor,y.current.position.set(0,0,0);const Lt=w?.rotation_period_seconds||86400,ut=2*Math.PI/Lt;y.current.rotation.y=I.current*ut%(2*Math.PI),y.current.rotation.z=X*(Math.PI/180)}if(K.current.forEach(w=>{w.effect.updateUniforms&&w.effect.updateUniforms(N)}),S.current&&v.current&&E.current){const w=performance.now();S.current.render(v.current,E.current);const R=performance.now()-w;if(_-D.current>5e3){const ae=1e3/(_-D.current);et(),Z(X=>({...X,frameRate:Math.round(ae),renderTime:Math.round(R*100)/100})),D.current=_}}},[]),et=M.useCallback(()=>{const _=Re.getStats();Z(N=>({...N,activeEffects:_.activeEffects,enabledEffects:_.enabledEffects}))},[]);return M.useEffect(()=>{let _=!0;return window.tonnirLoggedInPlanet=!1,window.orbitChecked=!1,window.debugOrbitRadius=null,window.debugSystemMaxRadius=null,window.planetNameLogged=!1,window.timingDataLogged=!1,window.isLoadingPlanetData=!1,window.orbitalAngleSourceLogged=!1,window.orbitalAngleDebugged=!1,window.positionDebugged=!1,window.animationLoopDebugged=!1,(async()=>{try{if(!_)return;const w=await je();if(!_)return;if(!ye()){_&&k("Failed to initialize 3D renderer");return}if(!_||(mt(),p.current&&"ResizeObserver"in window&&(F.current=new ResizeObserver(ve),F.current.observe(p.current)),window.addEventListener("resize",ve),!_))return;w?await xt(w):We()}catch(w){_&&k(w instanceof Error?w.message:"Unknown initialization error")}})(),()=>{if(_=!1,T.current=null,b.current&&cancelAnimationFrame(b.current),F.current&&F.current.disconnect(),window.removeEventListener("resize",ve),Me(),z.current&&(z.current.dispose(),z.current=null),x.current&&x.current.dispose(),Te.current&&v.current&&(v.current.remove(Te.current),Te.current.geometry.dispose(),Te.current.material.dispose(),Te.current=null),re.current&&v.current&&(v.current.remove(re.current),re.current.geometry.dispose(),re.current.material.dispose(),re.current=null),S.current&&p.current)try{p.current.contains(S.current.domElement)&&p.current.removeChild(S.current.domElement),S.current.dispose()}catch{}}},[]),M.useEffect(()=>{const _=setInterval(()=>{const N=Re.getStats();Z(w=>({...w,activeEffects:N.activeEffects,enabledEffects:N.enabledEffects}))},1e4);return()=>clearInterval(_)},[]),M.useEffect(()=>{C&&v.current&&y.current&&Le()},[C,Le]),wo(C),h.jsxs("div",{className:`relative ${e}`,children:[n&&C&&h.jsx(_o,{planetData:C,showInPage:!0,showInConsole:!0}),h.jsx("div",{ref:p,className:"w-full h-full",style:{minHeight:"300px",aspectRatio:"1"}}),P&&h.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black bg-opacity-50",children:h.jsxs("div",{className:"text-white text-center",children:[h.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-white mx-auto mb-2"}),h.jsx("div",{children:"Loading planet..."})]})}),O&&h.jsxs("div",{className:"absolute top-0 left-0 right-0 p-2 bg-red-500 text-white text-sm",children:[h.jsx("strong",{children:"Error:"})," ",O]}),C&&!P&&h.jsxs("div",{className:"absolute bottom-0 left-0 p-4 text-white bg-black bg-opacity-50 max-w-xs",children:[h.jsx("h3",{className:"text-lg font-bold",children:C.planet_info.name}),h.jsx("p",{className:"text-sm opacity-80",children:C.planet_info.type}),h.jsxs("p",{className:"text-xs mt-1 opacity-60",children:[W.length," effects active"]}),C.surface_elements?.description&&h.jsx("p",{className:"text-xs mt-2 opacity-60",children:C.surface_elements.description.appearance})]}),n&&h.jsxs("div",{className:"absolute top-0 right-0 p-4 text-white bg-black bg-opacity-70 text-xs font-mono",children:[h.jsx("h4",{className:"font-bold mb-2",children:"Debug Info"}),h.jsxs("div",{children:["Frame Rate: ",ee.frameRate," FPS"]}),h.jsxs("div",{children:["Render Time: ",ee.renderTime,"ms"]}),h.jsxs("div",{children:["Active Effects: ",ee.activeEffects]}),h.jsxs("div",{children:["Enabled Effects: ",ee.enabledEffects]}),h.jsxs("div",{className:"mt-2",children:[h.jsx("div",{className:"font-semibold",children:"Effects:"}),W.map(_=>h.jsxs("div",{className:"ml-2",children:[_.type," (",_.enabled?"ON":"OFF",")"]},_.id))]})]})]})};class Co extends Kt.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return console.error("🚨 ErrorBoundary caught error:",e),console.error("🚨 Error stack:",e.stack),{hasError:!0,error:e.message}}componentDidCatch(e,t){console.error("🚨 componentDidCatch:",e,t)}render(){return this.state.hasError?h.jsx("div",{className:"flex items-center justify-center w-full h-full bg-gray-900/50 rounded",children:h.jsxs("div",{className:"text-center p-4",children:[h.jsx("div",{className:"text-red-400 text-sm mb-2",children:"3D Renderer Error"}),h.jsx("div",{className:"text-xs text-gray-400",children:this.state.error})]})}):this.props.children}}const To=r=>h.jsx(Co,{children:h.jsx(Eo,{...r})}),Mo=({planetUrl:r,imageUrl:e,planet:t,cosmicOriginTime:i,initialAngleRotation:o,onEffectsCreated:a,effects:n,onToggleEffect:c})=>{const d=M.useRef(null),l=M.useRef(null),[s,u]=M.useState("Aligning Stargate..."),[f,p]=M.useState(!1),[v,S]=M.useState(!1),[E,y]=M.useState(!1),[x,g]=M.useState(!0),[b,I]=M.useState(!0),[T,P]=M.useState(null),[L,O]=M.useState(null);M.useEffect(()=>{n&&c&&n.forEach(C=>{Re.toggleEffect(C.id,C.enabled)})},[n]),M.useEffect(()=>{const C=document.createElement("style");return C.textContent=`
    ...
    `,document.head.appendChild(C),()=>{document.head.removeChild(C)}},[]),M.useEffect(()=>{const C=d.current;if(!C)return;const V=C.getContext("2d");if(!V)return;let W=[];const G=800;let ee,Z;const K=800;let D,F=.5;function z(){const oe=C?.parentElement;if(!oe||!C)return;const pe=oe.clientWidth,ve=oe.clientHeight;C.width=Math.min(pe,K),C.height=Math.min(ve,K),ee=C.width/2,Z=C.height/2}function q(){z(),W=[];for(let oe=0;oe<G;oe++)W.push({x:Math.random()*(C?.width||800),y:Math.random()*(C?.height||800),z:Math.random()*(C?.width||800),o:Math.random()});ie()}function ie(){!C||!V||(V.clearRect(0,0,C.width,C.height),W.forEach(oe=>{oe.z-=F,oe.z<=0&&(oe.z=C.width,oe.x=Math.random()*C.width,oe.y=Math.random()*C.height,oe.o=Math.random());const pe=C.width/oe.z,ve=(oe.x-ee)*pe+ee,Se=(oe.y-Z)*pe+Z,ye=2*pe;V.beginPath(),V.fillStyle=`rgba(255, 255, 255, ${oe.o})`,V.arc(ve,Se,ye,0,2*Math.PI),V.fill()}),F<60&&(F+=1),D=requestAnimationFrame(ie))}q();const fe=()=>z();return window.addEventListener("resize",fe),()=>{window.removeEventListener("resize",fe),D&&cancelAnimationFrame(D)}},[]),M.useEffect(()=>{if(e&&!x){const C=new Image;C.onload=()=>{l.current&&(l.current.src=e,S(!0),y(!0))},C.onerror=()=>{console.error("Failed to load planet image:",e),setTimeout(()=>{S(!0),y(!0)},1500)},C.src=e}else(x||!e)&&setTimeout(()=>{S(!0),y(!0)},1500)},[e,x]),M.useEffect(()=>{if(sessionStorage.getItem("stargateAnimationShown")){u("Stargate system aligned");return}sessionStorage.setItem("stargateAnimationShown","true"),p(!0);const V=(K,D)=>Array.from({length:D},()=>K[Math.floor(Math.random()*K.length)]).join(""),W=[{chars:"01",duration:40,iterations:20},{chars:"0123456789",duration:25,iterations:30},{chars:"0123456789ABCDEF",duration:20,iterations:40},{chars:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()-_=+[]{}|;:\\'\",.<>?/`~",duration:10,iterations:100}];let G=0,ee=0;const Z=()=>{if(G>=W.length){const D="Stargate system aligned";let F=0;u("");const z=()=>{F<D.length?(u(D.substring(0,F+1)),F++,setTimeout(z,30)):p(!1)};z();return}const K=W[G];u(V(K.chars,32)),ee++,ee>=K.iterations&&(G++,ee=0),setTimeout(Z,K.duration)};Z()},[]);const k=()=>{g(!x),x||(S(!0),y(!0))};return h.jsxs("div",{className:"h-full flex flex-col",children:[h.jsxs("div",{className:"flex items-center justify-between mb-3",children:[h.jsx("h3",{className:"text-lg sm:text-xl font-bold text-white",children:"Planet Visualization"}),b&&h.jsx("div",{className:"flex items-center gap-2",children:h.jsx("button",{onClick:k,className:`px-3 py-1 text-xs font-medium rounded-full transition-all duration-300 ${x?"bg-blue-500 text-white shadow-lg shadow-blue-500/25":"bg-gray-600 text-gray-200 hover:bg-gray-500"}`,children:x?"2D View":"3D View"})})]}),h.jsxs("div",{className:"relative w-full max-w-80 sm:max-w-96 aspect-square mx-auto bg-black/50 flex justify-center items-center rounded-xl overflow-hidden border-2 border-blue-400/30 mb-4",children:[h.jsx("canvas",{ref:d,className:`absolute inset-0 w-full h-full object-cover transition-opacity duration-[2500ms] ${E?"opacity-0":"opacity-100"}`,style:{filter:E?"blur(50px)":"none"}}),x&&v&&t&&h.jsx("div",{className:`absolute inset-0 w-full h-full transition-all duration-500 ${v?"opacity-100 blur-0":"opacity-0 blur-[25px]"}`,children:h.jsx(To,{planetName:t.name,containerClassName:"w-full h-full",autoRotate:!1,enableControls:!0,showDebugInfo:!1,onEffectsCreated:a,planetData:{name:t.name,diameter:t.diameter,density:t.density,gravity:t.gravity,mass:t.mass,orbital_radius:t.orbital_radius,orbital_period_seconds:t.orbital_period_seconds,rotation_period_seconds:t.rotation_period_seconds,surface_temperature:t.surface_temperature,axial_tilt:t.axial_tilt,planet_type:t.planet_type,atmosphere:t.atmosphere,elements:t.elements,initial_orbital_angle:t.initial_orbital_angle||0},cosmicOriginTime:i,initialAngleRotation:o,onDataLoaded:C=>{P(C)},onError:C=>{O(C),console.error("❌ Planet rendering error:",C)}})}),!x&&h.jsx("div",{className:`absolute inset-0 w-full h-full transition-all duration-500 ${v?"opacity-100 blur-0":"opacity-0 blur-[25px]"}`,children:v&&e?h.jsx("div",{className:"w-full h-full flex items-center justify-center",children:h.jsx(gi,{zoomMargin:20,classDialog:"backdrop-blur-3xl",children:h.jsx("img",{ref:l,className:"max-w-full max-h-full object-contain rounded-xl shadow-2xl shadow-blue-500/20",src:e,alt:"Planet visualization",style:{width:"100%",height:"100%",objectFit:"contain",backgroundColor:"transparent"}})})}):h.jsx("img",{ref:l,className:"w-full h-full object-cover",src:"/static/images/placeholder-min.jpg",alt:"Planet visualization"})}),b&&h.jsx("div",{className:"absolute top-2 right-2 bg-black/70 text-white px-2 py-1 rounded text-xs",children:x?"🌍 3D":"🖼️ 2D"})]}),h.jsxs("div",{className:"text-center mt-auto",children:[h.jsxs("a",{href:r,className:`inline-block px-4 py-2 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-gray-200 font-medium text-sm rounded-lg border border-slate-600 hover:border-slate-500 shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden group ${f?"animate-pulse":""}`,style:{boxShadow:"0 2px 8px rgba(0, 0, 0, 0.3)"},children:[h.jsxs("span",{className:"relative z-10 font-mono flex items-center gap-2",children:[h.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 20 20",children:h.jsx("path",{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zM8.736 6.979C9.208 6.193 9.696 6 10 6s.792.193 1.264.979a1 1 0 001.715-1.029C12.279 4.784 11.232 4 10 4s-2.279.784-2.979 1.95a1 1 0 001.715 1.029zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM10 14c-.304 0-.792-.193-1.264-.979a1 1 0 00-1.715 1.029C7.721 15.216 8.768 16 10 16s2.279-.784 2.979-1.95a1 1 0 00-1.715-1.029C10.792 13.807 10.304 14 10 14z",clipRule:"evenodd"})}),s]}),h.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-slate-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"})]}),h.jsxs("div",{className:"mt-2 text-xs text-gray-500 text-center",children:["Gateway to the stars",x&&T&&h.jsxs("div",{className:"ml-2 text-blue-400 mt-1",children:["• ",T.planet_info?.type," Planet",T.atmosphere&&h.jsx("span",{className:"text-purple-400",children:" • Atmosphere"}),T.rings?.has_rings&&h.jsx("span",{className:"text-yellow-400",children:" • Rings"})]}),x&&L&&h.jsx("div",{className:"ml-2 text-red-400 mt-1",children:"• Rendering Error"})]})]})]})},Po=({currentPlanet:r,system:e,galaxy:t,systemPlanets:i})=>{const[o,a]=M.useState(null),[n,c]=M.useState(null),[d,l]=M.useState(!1),[s,u]=M.useState(!1),[f,p]=M.useState(!0);M.useEffect(()=>{if(i&&i.length>0){const E=i.findIndex(y=>y.name.toLowerCase()===r.toLowerCase());E!==-1?(E>0?(a(i[E-1].name.toLowerCase()),l(!0)):e.index>0?(a("__prev_system__"),l(!0)):l(!1),E<i.length-1?(c(i[E+1].name.toLowerCase()),u(!0)):(c("__next_system__"),u(!0))):(l(!1),u(!1))}else l(!1),u(!1);p(!1)},[r,e.index,i]);const v=async()=>{const E=t.coordinates.join(",");if(o==="__prev_system__")try{const y=await fetch(`/system/${e.index-1}`,{headers:{Accept:"application/json"}});if(y.ok){const x=await y.json();if(x.system&&x.system.planets&&x.system.planets.length>0){const b=x.system.planets[x.system.planets.length-1].name.toLowerCase();it(E,e.index-1,b,x.system.planets),Et(E,e.index-1),window.location.href=`/planet/${b}`;return}}window.location.href=`/system/${e.index-1}`}catch{window.location.href=`/system/${e.index-1}`}else o&&(it(E,e.index,o,i),window.location.href=`/planet/${o}`)},S=async()=>{const E=t.coordinates.join(",");if(n==="__next_system__")try{const y=await fetch(`/system/${e.index+1}`,{headers:{Accept:"application/json"}});if(y.ok){const x=await y.json();if(x.system&&x.system.planets&&x.system.planets.length>0){const b=x.system.planets[0].name.toLowerCase();it(E,e.index+1,b,x.system.planets),Et(E,e.index+1),window.location.href=`/planet/${b}`;return}}window.location.href=`/system/${e.index+1}`}catch{window.location.href=`/system/${e.index+1}`}else n&&(it(E,e.index,n,i),window.location.href=`/planet/${n}`)};return f?null:h.jsxs("div",{className:"flex items-center justify-between mb-4",children:[h.jsx("button",{onClick:v,disabled:!d,className:`flex items-center justify-center px-3 py-1.5 rounded-lg transition-all duration-200 ${d?"bg-white/10 hover:bg-white/20 border border-white/20 text-white hover:text-blue-300":"bg-white/5 border border-white/10 text-gray-600 cursor-not-allowed"}`,children:h.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:h.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),h.jsx("button",{onClick:S,disabled:!s,className:`flex items-center justify-center px-3 py-1.5 rounded-lg transition-all duration-200 ${s?"bg-white/10 hover:bg-white/20 border border-white/20 text-white hover:text-blue-300":"bg-white/5 border border-white/10 text-gray-600 cursor-not-allowed"}`,children:h.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:h.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]})},Ao=({planet:r,system:e,galaxy:t,planet_url:i,version:o,image_url:a,cosmic_origin_time:n,initial_angle_rotation:c})=>{const[d]=M.useState(t.coordinates.join(",")),[l,s]=M.useState([]),u=E=>{s(E)},f=(E,y)=>{s(x=>x.map(g=>g.id===E?{...g,enabled:y}:g))};M.useEffect(()=>{document.body.setAttribute("data-coordinates",d),document.body.setAttribute("data-system-index",e.index.toString()),document.body.setAttribute("data-planet-name",r.name.toLowerCase()),it(d,e.index,r.name,e.planets||[]),Et(d,e.index)},[d,e.index,r.name]);const p=E=>E.replace(/_/g," "),v=E=>E.replace(/_/g," "),S=E=>E.replace(/_/g," ");return h.jsxs("div",{className:"w-full h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-auto",children:[h.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`}}),h.jsxs("div",{className:"relative z-10",children:[h.jsx(fi,{}),h.jsxs("div",{className:"w-full px-2 sm:px-4 lg:px-6 py-4 sm:py-8",children:[h.jsxs("div",{className:"text-center mb-8",children:[h.jsx("div",{className:"flex items-center justify-center gap-4 mb-4",children:h.jsxs("h1",{className:"text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent",children:["Planet '",p(r.name),"'"]})}),h.jsxs("p",{className:"text-lg sm:text-xl text-gray-300",children:["in System '",v(e.name),"' - Galaxy '",S(t.name),"'"]}),h.jsxs("p",{className:"text-sm sm:text-base text-gray-400",children:["Coordinates ",t.coordinates.join(", ")]})]}),h.jsx(Po,{currentPlanet:r.name,system:e,galaxy:t,systemPlanets:e.planets||[]}),h.jsx("div",{className:"bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 mb-8 shadow-2xl p-4 sm:p-6",children:h.jsxs("div",{className:"flex flex-col lg:grid lg:grid-cols-[400px_1fr] gap-6 lg:gap-8 relative",children:[h.jsx("div",{className:"order-1 lg:order-1",children:h.jsx(Mo,{planetUrl:i,imageUrl:a,planet:r,cosmicOriginTime:n,initialAngleRotation:c,onEffectsCreated:u,effects:l,onToggleEffect:f})}),h.jsx("div",{className:"hidden lg:block absolute left-[416px] top-0 bottom-0 w-1 rounded-full bg-white/10 -translate-x-1.5"}),h.jsx("div",{className:"order-2 lg:order-2",children:h.jsx(ki,{planet:r,system:e,galaxy:t,cosmicOriginTime:n,initialAngleRotation:c,effects:l,onToggleEffect:f})})]})}),h.jsx("div",{className:"bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 mb-8 shadow-2xl p-4 sm:p-6 text-center",children:h.jsx("button",{onClick:()=>window.location.href=`/system/${e.index}`,className:"w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-gray-600 via-gray-700 to-gray-600 hover:from-gray-700 hover:via-gray-800 hover:to-gray-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg backdrop-blur-sm",children:h.jsxs("span",{className:"text-base sm:text-lg",children:["← Back to System '",v(e.name),"'"]})})})]}),h.jsx(mi,{version:o})]}),h.jsx(vi,{currentLocation:{type:"planet",name:r.name,coordinates:t.coordinates.join(","),systemIndex:e.index,planetName:r.name}})]})};document.addEventListener("DOMContentLoaded",async()=>{try{const r=document.getElementById("planet-data"),e=document.getElementById("system-data"),t=document.getElementById("galaxy-data"),i=document.getElementById("meta-data");if(!r||!e||!t||!i){console.error("Missing required data elements");return}const o=JSON.parse(r.textContent||"{}"),a=JSON.parse(e.textContent||"{}"),n=JSON.parse(t.textContent||"{}"),c=JSON.parse(i.textContent||"{}"),d={planet:o,system:a,galaxy:n,planet_url:c.planet_url,version:c.version,image_url:c.image_url,cosmic_origin_time:c.cosmic_origin_time,initial_angle_rotation:c.initial_angle_rotation},l=document.getElementById("atlas-react-root");l&&ui.createRoot(l).render(Kt.createElement(Ao,d))}catch(r){console.error("Error initializing Planet React app:",r)}});
