import{S as C}from"./atlas_CGrAwTYnSDNTtni2msvpu.js";import{G as _,d as z,V as u,e as L,f as A,M as V,S as Y,F as R,N as B}from"./atlas_BptVXGp7hwWSDe7IbaYgj.js";const o={CLOUD_COUNT:{min:15,max:25},SIZE:{min:3.8,max:5.5},OPACITY:{min:.4,max:.8},DENSITY:{min:.5,max:1.5},ROTATION_SPEED:{min:.002,max:.008},MOVEMENT_AMPLITUDE:{min:.003,max:.02},TURBULENCE:{min:1,max:2},TIME_SPEED:{min:.1,max:3}};class E{cloudSystem;material;params;cloudCount;clouds=[];cosmicOriginTime;cosmicOffset;static vertexShader=`
