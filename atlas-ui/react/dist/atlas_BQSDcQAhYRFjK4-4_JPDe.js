import{S as C}from"./atlas_BMpNx4AK3tYXnXF6p046V.js";import{a as H,D as U}from"./atlas_T7JJ8afK2bnKNLBS_Xpir.js";import{C as E,cp as A,V as m,au as N,D as V,bA as D,m as z,M as L,i as O,j as b}from"./atlas_CP-qo6TeGb-XhtmtHX5P6.js";const r={PATCH_COUNT:{min:20,max:40},DENSITY:{min:.8,max:1.5},SIZE:{min:.08,max:.25},OPACITY:{min:.7,max:.95},TREE_HEIGHT:{min:.015,max:.035},TIME_SPEED:{min:.05,max:.2}};class T{vegetationGroup;vegetationPatches=[];treeLayers=[];params;cosmicOriginTime;cosmicOffset;static vegetationVertexShader=`
