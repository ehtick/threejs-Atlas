import{S as m}from"./atlas_DhOreEVM1uBHzRPTt7uMw.js";import{C as c,S as M,D as N,N as T,V as u}from"./atlas_CLp6T-BwF8hBVTNM0OiQd.js";const a={STORM_COUNT:{min:1,max:4},STORM_SIZE:{min:.15,max:.3},STORM_INTENSITY:{min:.6,max:1.2},SPIRAL_SPEED:{min:.5,max:1.5},ANIMATION_SPEED:{min:.1,max:.5},OPACITY:{min:.1,max:.3}};class d{layerMesh;material;params;layerSystem;static vertexShader=`
