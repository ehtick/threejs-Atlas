import{C as i,S as n,F as c,V as r,b as m,M as d,N as v,D as u}from"./atlas_CLp6T-BwF8hBVTNM0OiQd.js";class f{baseMesh;baseMaterial;effectLayers=[];scene;planetRadius;static baseVertexShader=`
  ...
  `;constructor(e,o=new i(16753920)){this.baseMesh=e;const t=e.geometry;this.planetRadius=t.parameters.radius||1;const a=o instanceof i?o:new i(o);this.baseMaterial=new n({vertexShader:f.baseVertexShader,fragmentShader:f.baseFragmentShader,uniforms:{baseColor:{value:a},lightDirection:{value:new r(1,1,1).normalize()},lightPosition:{value:new r(0,0,0)},ambientStrength:{value:.15},lightIntensity:{value:.85}},side:c}),this.baseMesh.material=this.baseMaterial}addEffectLayer(e,o,t=1.001,a){const l=new m(this.planetRadius*t,256,256),s=new d(l,o);return s.position.copy(this.baseMesh.position),s.rotation.copy(this.baseMesh.rotation),this.effectLayers.push({name:e,mesh:s,material:o,layerObject:a}),this.scene&&this.scene.add(s),s}createCloudBandsLayerMaterial(e){const o=`
    ...
    `;return new n({vertexShader:o,fragmentShader:t,uniforms:{time:{value:0},seed:{value:e.seed||Math.random()*1e3},bandColor:{value:e.bandColor||new i(16747520)},numBands:{value:e.numBands||8},rotationAngle:{value:e.rotationAngle||0},bandPositions:{value:e.bandPositions||new Array(20).fill(0)},bandWidths:{value:e.bandWidths||new Array(20).fill(.1)},animationSpeed:{value:e.animationSpeed||1},turbulence:{value:e.turbulence||.5},noiseScale:{value:e.noiseScale||3},lightDirection:{value:new r(1,1,1).normalize()},opacity:{value:e.opacity||.4}},transparent:!0,blending:v,side:c,depthWrite:!1})}createMetallicSurfaceLayerMaterial(e){const o=`
      varying vec3 vPosition;
      varying vec3 vNormal;
      varying vec3 vWorldPosition;
      varying vec3 vWorldNormal;
    ...
    `,a=e.waterColor instanceof i?e.waterColor:new i(e.waterColor||3050379),l=e.deepWaterColor instanceof i?e.deepWaterColor:new i(e.deepWaterColor||13158),s=e.foamColor instanceof i?e.foamColor:new i(e.foamColor||16777215);return new n({vertexShader:o,fragmentShader:t,uniforms:{time:{value:0},seedOffset:{value:(e.seed||0)%100},waveHeight:{value:e.waveHeight||.08},waveFrequency:{value:e.waveFrequency||3},waveSpeed:{value:e.waveSpeed||.5},waterColor:{value:a},deepWaterColor:{value:l},foamColor:{value:s},specularIntensity:{value:e.specularIntensity||3},transparency:{value:e.transparency||.6},roughness:{value:e.roughness||.1},lightDirection:{value:new r(1,1,1).normalize()},lightPosition:{value:new r(0,0,0)},ambientStrength:{value:.15},lightIntensity:{value:.85}},transparent:!0,blending:v,side:c,depthWrite:!1})}createOceanCurrentsLayerMaterial(e){const o=`
      varying vec3 vPosition;
      varying vec3 vNormal;
      varying vec3 vWorldPosition;
      varying vec3 vWorldNormal;
    ...
    `,a=e.currentColor instanceof i?e.currentColor:new i(e.currentColor||4889486),l=e.deepCurrentColor instanceof i?e.deepCurrentColor:new i(e.deepCurrentColor||2973010);return new n({vertexShader:o,fragmentShader:t,uniforms:{time:{value:0},seedOffset:{value:(e.seed||0)%100},currentIntensity:{value:e.currentIntensity||.5},currentScale:{value:e.currentScale||2},currentSpeed:{value:e.currentSpeed||.2},secondaryCurrentIntensity:{value:e.secondaryCurrentIntensity||.3},secondaryCurrentScale:{value:e.secondaryCurrentScale||3},secondaryCurrentSpeed:{value:e.secondaryCurrentSpeed||.15},currentColor:{value:a},deepCurrentColor:{value:l},opacity:{value:e.opacity||.25},lightDirection:{value:new r(1,1,1).normalize()},lightPosition:{value:new r(0,0,0)},ambientStrength:{value:.15},lightIntensity:{value:.85}},transparent:!0,blending:v,side:c,depthWrite:!1})}addToScene(e){this.scene=e,this.effectLayers.forEach(o=>{o.mesh&&e.add(o.mesh)})}update(e,o){this.effectLayers.forEach(t=>{if(t.material.uniforms.time&&(t.material.uniforms.time.value+=e),o!==void 0&&t.material.uniforms.rotationAngle&&(t.material.uniforms.rotationAngle.value=o),t.layerObject&&typeof t.layerObject=="object"&&t.layerObject!==null&&"update"in t.layerObject)try{t.layerObject.update(e,o)}catch{}t.mesh&&t.mesh.rotation.copy(this.baseMesh.rotation)})}updateBaseColor(e){const o=e instanceof i?e:new i(e);this.baseMaterial.uniforms.baseColor.value=o}updateLightDirection(e){this.baseMaterial.uniforms.lightDirection.value=e.clone().normalize(),this.effectLayers.forEach(o=>{o.material.uniforms.lightDirection&&(o.material.uniforms.lightDirection.value=e.clone().normalize())})}updateLightPosition(e){this.baseMaterial.uniforms.lightPosition.value=e.clone(),this.effectLayers.forEach(o=>{o.material.uniforms.lightPosition&&(o.material.uniforms.lightPosition.value=e.clone())})}updateFromThreeLight(e){this.updateLightPosition(e.position);const o=e.target.position.clone().sub(e.position).normalize();this.updateLightDirection(o)}applyHoleShader(e){this.baseMaterial&&this.baseMaterial.dispose(),this.baseMaterial=e,this.baseMesh.material=e}createGenericLayerMaterial(e,o,t,a=!0,l=v){return t.lightDirection||(t.lightDirection={value:new r(1,1,1).normalize()}),t.lightPosition||(t.lightPosition={value:new r(0,0,0)}),new n({vertexShader:e,fragmentShader:o,uniforms:t,transparent:a,blending:l,side:c,depthWrite:!1})}convertEffectToLayer(e,o,t=1.001){if(o instanceof n){const a=o.clone();return a.transparent=!0,a.depthWrite=!1,a.uniforms.lightDirection||(a.uniforms.lightDirection={value:new r(1,1,1).normalize()}),this.addEffectLayer(e,a,t)}return null}createDiamondSurfaceLayerMaterial(e){const o=`
      varying vec3 vPosition;
      varying vec3 vNormal;
      varying vec3 vWorldPosition;
      varying vec3 vWorldNormal;
