import{S as F,g as N,D as U}from"./atlas_CZFakru7GGKiPV4DHwGyu.js";import{C as n,G as W,V as r,d as _,e as D,M as O,S as G,F as H,A as j,i as V}from"./atlas_BjkcO1_mNssSqp05cLhjd.js";const t={FLOW_COUNT:{min:20,max:35},FLOW_LENGTH:{min:.4,max:1.2},FLOW_WIDTH:{min:.015,max:.08},FLOW_INTENSITY:{min:1.5,max:3},FLOW_SPEED:{min:.05,max:.3},PULSE_SPEED:{min:.5,max:1.2},TURBULENCE:{min:.8,max:2},EMISSIVE_INTENSITY:{min:3,max:5},GLOW_RADIUS:{min:1.1,max:1.3},TIME_SPEED:{min:.1,max:2},EMERGENCE_HEIGHT:{min:.01,max:.03}};class h{lavaGroup;lavaFlows=[];material;params;startTime;static vertexShader=`
