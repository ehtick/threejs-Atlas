import{S as f,D as y,g as M}from"./atlas_BJ-3dIBoTMvLRTvbW4jvB.js";import{C as m,V as c,B as N,P,a as l,S as R,A as B}from"./atlas_CqUMNY_RyRklhCsbOI68T.js";const e={STAR_COUNT:{min:650,max:1500},MIN_BRIGHTNESS:{min:.6,max:.8},MAX_BRIGHTNESS:{min:.9,max:1},MIN_SIZE:{min:1,max:1.2},MAX_SIZE:{min:2.5,max:4},DISTANCE:{min:250,max:450},TWINKLE_SPEED:{min:1,max:2},PARALLAX_STRENGTH:{min:1,max:3},VARIABLE_CHANCE:{min:.002,max:.005}};class S{starSystem;material;geometry;params;starCount;cameraPosition=new c;lastCameraPosition=new c;startTime;static vertexShader=`
