import{C as a,b as m,S as d,N as u,F as x,M as y}from"./atlas_DfFO9DeAqJfHmKzNHJUiw.js";class t{mesh;material;params;static vertexShader=`
  ...
  `;constructor(e,o={}){this.params={radius:o.radius||e*.999,detail:o.detail||128,flowSpeed:o.flowSpeed||.5,waveAmplitude:o.waveAmplitude||.02,opacity:o.opacity||.75,colorDeep:o.colorDeep||new a(4147),colorShallow:o.colorShallow||new a(26333),...o};const i=new m(this.params.radius,this.params.detail,this.params.detail);this.material=new d({vertexShader:t.vertexShader,fragmentShader:t.fragmentShader,uniforms:{uTime:{value:0},uFlowSpeed:{value:this.params.flowSpeed},uWaveAmplitude:{value:this.params.waveAmplitude},uFresnelPower:{value:1.5},uOpacity:{value:this.params.opacity},uColorDeep:{value:this.params.colorDeep instanceof a?this.params.colorDeep:new a(this.params.colorDeep)},uColorShallow:{value:this.params.colorShallow instanceof a?this.params.colorShallow:new a(this.params.colorShallow)},uNoiseScale:{value:3},uSecondaryWaveScale:{value:6},uPrimaryFlowSpeed:{value:this.params.flowSpeed||.5},uSecondaryFlowSpeed:{value:(this.params.flowSpeed||.5)*1.6},uUvPatternSpeed1:{value:(this.params.flowSpeed||.5)*4},uUvPatternSpeed2:{value:(this.params.flowSpeed||.5)*3}},transparent:!0,depthWrite:!1,depthTest:!0,side:x,blending:u}),this.mesh=new y(i,this.material),this.mesh.renderOrder=-1,console.log("🌊 FluidLayersEffect created with params:",this.params)}addToScene(e,o){o&&this.mesh.position.copy(o),e.add(this.mesh),console.log("🌊 FluidLayers mesh added to scene at position:",this.mesh.position)}update(e,o){this.material.uniforms.uTime.value+=e,o!==void 0&&(this.mesh.rotation.y=o)}updateParams(e){if(this.params={...this.params,...e},e.flowSpeed!==void 0&&(this.material.uniforms.uFlowSpeed.value=e.flowSpeed,this.material.uniforms.uPrimaryFlowSpeed.value=e.flowSpeed,this.material.uniforms.uSecondaryFlowSpeed.value=e.flowSpeed*1.6,this.material.uniforms.uUvPatternSpeed1.value=e.flowSpeed*4,this.material.uniforms.uUvPatternSpeed2.value=e.flowSpeed*3),e.waveAmplitude!==void 0&&(this.material.uniforms.uWaveAmplitude.value=e.waveAmplitude),e.opacity!==void 0&&(this.material.uniforms.uOpacity.value=e.opacity),e.colorDeep){const o=e.colorDeep instanceof a?e.colorDeep:new a(e.colorDeep);this.material.uniforms.uColorDeep.value=o}if(e.colorShallow){const o=e.colorShallow instanceof a?e.colorShallow:new a(e.colorShallow);this.material.uniforms.uColorShallow.value=o}}getObject3D(){return this.mesh}dispose(){this.mesh.geometry&&this.mesh.geometry.dispose(),this.material&&this.material.dispose()}}function w(s,e){let o=.5,i=.025,c=.75;if(e.seeds){const v=e.seeds.shape_seed||e.seeds.planet_seed,l=(p=>{let r=p;return()=>(r=(r*1664525+1013904223)%4294967296,r/4294967296)})(v);o=.05+l()*.3,i=.02+l()*.02,c=.25+l()*.6}const n={radius:s*.999,detail:128,flowSpeed:o,waveAmplitude:i*.4,opacity:c,colorDeep:new a(4147),colorShallow:new a(26333)};return new t(s,n)}export{t as F,w as c};
