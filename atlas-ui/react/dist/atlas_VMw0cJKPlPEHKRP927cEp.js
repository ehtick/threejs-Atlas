...
#define LOW_PRECISION`),n}function nf(e){let n="SHADOWMAP_TYPE_BASIC";return e.shadowMapType===ar?n="SHADOWMAP_TYPE_PCF":e.shadowMapType===Fa?n="SHADOWMAP_TYPE_PCF_SOFT":e.shadowMapType===St&&(n="SHADOWMAP_TYPE_VSM"),n}function rf(e){let n="ENVMAP_TYPE_CUBE";if(e.envMap)switch(e.envMapMode){case Jt:case Vt:n="ENVMAP_TYPE_CUBE";break;case mn:n="ENVMAP_TYPE_CUBE_UV";break}return n}function af(e){let n="ENVMAP_MODE_REFLECTION";return e.envMap&&e.envMapMode===Vt&&(n="ENVMAP_MODE_REFRACTION"),n}function of(e){let n="ENVMAP_BLENDING_NONE";if(e.envMap)switch(e.combine){case Za:n="ENVMAP_BLENDING_MULTIPLY";break;case $a:n="ENVMAP_BLENDING_MIX";break;case qa:n="ENVMAP_BLENDING_ADD";break}return n}function sf(e){const n=e.envMapCubeUVHeight;if(n===null)return null;const t=Math.log2(n)-2,i=1/n;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function cf(e,n,t,i){const c=e.getContext(),o=t.defines;let h=t.vertexShader,f=t.fragmentShader;const b=nf(t),x=rf(t),U=af(t),E=of(t),M=sf(t),R=ql(t),F=$l(o),L=c.createProgram();let l,r,I=t.glslVersion?"#version "+t.glslVersion+`
