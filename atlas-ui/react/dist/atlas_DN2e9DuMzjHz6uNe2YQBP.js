import{S as C}from"./atlas_BRxuskCzJ8TfEkc5-9Hxt.js";import{G as T,V as l,b as Y,S as k,C as J,M as W}from"./atlas_Dg_ET6FsNHb7HwLobcNa6.js";const i={ERUPTION_INTENSITY:{min:.5,max:1.5},ERUPTION_FREQUENCY:{min:3,max:8},PROJECTILE_COUNT:{min:3,max:8},PROJECTILE_SIZE:{min:.001,max:.004},ARC_HEIGHT:{min:.01,max:.04},FLARE_LENGTH:{min:.08,max:.25},TIME_SPEED:{min:.8,max:1.2}};class S{eruptionsGroup;projectilesGroup;trailsGroup;splashGroup;eruptionPatterns=[];params;planetRadius;cosmicOriginTime;cosmicOffset;rng;projectilePool=[];trailPool=[];splashPool=[];static projectileVertexShader=`
