import{b as j,C as p,S as L,c as k,A as Y,M as W,B as G,P as q,a as M,G as X,d as $,V as h,e as H,f as B,F as J,N as K}from"./atlas_BjkcO1_mNssSqp05cLhjd.js";import{S as E}from"./atlas_C7ZhNUnMOt3kEE8jtIwhb.js";class D{mesh;material;geometry;params;static vertexShader=`
  ...
  `;constructor(o,e={}){this.params={type:e.type||"Thin",color:e.color||[.7,.7,.7,.2],width:e.width||12,opacity:e.opacity||.2,density:e.density||1};const t=o*(1+this.params.width/100);this.geometry=new j(t,32,32);const i=new p(this.params.color[0],this.params.color[1],this.params.color[2]);this.material=new L({vertexShader:D.vertexShader,fragmentShader:D.fragmentShader,uniforms:{atmosphereColor:{value:i},atmosphereOpacity:{value:this.params.opacity},fresnelPower:{value:2}},transparent:!0,blending:Y,side:k,depthWrite:!1}),this.mesh=new W(this.geometry,this.material)}addToScene(o,e){e&&this.mesh.position.copy(e),o.add(this.mesh)}update(o){}updateParams(o){if(this.params={...this.params,...o},o.color){const e=new p(o.color[0],o.color[1],o.color[2]);this.material.uniforms.atmosphereColor.value=e}o.opacity!==void 0&&(this.material.uniforms.atmosphereOpacity.value=o.opacity),o.density!==void 0&&(this.material.uniforms.atmosphereOpacity.value=(this.params.opacity||.3)*o.density)}getObject3D(){return this.mesh}dispose(){this.geometry.dispose(),this.material.dispose()}}function oe(S,o){let e=[.7,.7,.7,.15],t=12;if(o){if(o.color&&Array.isArray(o.color)){const s=o.color;e=[s[0],s[1],s[2],(s[3]||.15)*.7]}o.width&&(t=o.width)}const i={type:o?.type||"Thin",color:e,width:t,opacity:e[3],density:1};return new D(S,i)}const a={PARTICLE_COUNT:{min:25,max:150},SPEED:{min:.05,max:.5},SIZE:{min:.3,max:1.5},OPACITY:{min:.1,max:.3},TURBULENCE:{min:.1,max:.5},ROTATION_SPEED:{min:.01,max:.05},MOVEMENT_AMPLITUDE:{min:.005,max:.05},TIME_SPEED:{min:.1,max:3}};class N{particleSystem;material;geometry;params;particleCount;startTime;static vertexShader=`
