import{S as d,D as w,g as M}from"./atlas_devLC-KyT9W7vfPUn064J.js";import{C as l,V as c,B as R,P as b,a as m,S as B,A as P}from"./atlas_B2lpKXcKkLCAPkjGiW29w.js";const i={STAR_COUNT:{min:650,max:1500},MIN_BRIGHTNESS:{min:.6,max:.8},MAX_BRIGHTNESS:{min:.9,max:1},MIN_SIZE:{min:1,max:1.2},MAX_SIZE:{min:2.5,max:4},DISTANCE:{min:250,max:450},TWINKLE_SPEED:{min:1,max:2},PARALLAX_STRENGTH:{min:1,max:3},VARIABLE_CHANCE:{min:.002,max:.005}};class S{starSystem;material;geometry;params;starCount;cameraPosition=new c;lastCameraPosition=new c;startTime;static vertexShader=`
