import{S as N}from"./atlas_BrNrnv36SE53jZ2fSHjkt.js";import{C as r,G as W,V as a,d as b,e as D,M as _,S as U,F as G,A as O,i as H}from"./atlas_BoQAiljVnjMCunoRfsYFA.js";const t={FLOW_COUNT:{min:20,max:35},FLOW_LENGTH:{min:.4,max:1.2},FLOW_WIDTH:{min:.015,max:.08},FLOW_INTENSITY:{min:1.5,max:3},FLOW_SPEED:{min:.05,max:.3},PULSE_SPEED:{min:.5,max:1.2},TURBULENCE:{min:.8,max:2},EMISSIVE_INTENSITY:{min:3,max:5},GLOW_RADIUS:{min:1.1,max:1.3},TIME_SPEED:{min:.1,max:2},EMERGENCE_HEIGHT:{min:.01,max:.03}};class d{lavaGroup;lavaFlows=[];material;params;startTime;static vertexShader=`
