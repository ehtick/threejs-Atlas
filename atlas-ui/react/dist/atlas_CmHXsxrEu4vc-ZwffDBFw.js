import{S as C,g as Y,D as k}from"./atlas_D5TkNrZ-UIh1OV1m_7qMi.js";import{G as T,V as s,b as J,S as W,C as q,M as Q}from"./atlas_Bd-08EnGHvuA4jxvJ1T-8.js";const i={ERUPTION_INTENSITY:{min:.5,max:1.5},ERUPTION_FREQUENCY:{min:3,max:8},PROJECTILE_COUNT:{min:3,max:8},PROJECTILE_SIZE:{min:.001,max:.004},ARC_HEIGHT:{min:.01,max:.04},FLARE_LENGTH:{min:.08,max:.25},TIME_SPEED:{min:.8,max:1.2}};class I{eruptionsGroup;projectilesGroup;trailsGroup;splashGroup;eruptionPatterns=[];params;planetRadius;cosmicOriginTime;cosmicOffset;rng;projectilePool=[];trailPool=[];splashPool=[];static projectileVertexShader=`
