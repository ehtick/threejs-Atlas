import{S as d}from"./atlas_C7ZhNUnMOt3kEE8jtIwhb.js";import{C as r,B as x,P as T,a as m,S as C,A as N}from"./atlas_BjkcO1_mNssSqp05cLhjd.js";const e={STAR_COUNT:{min:150,max:450},MIN_BRIGHTNESS:{min:.4,max:.7},MAX_BRIGHTNESS:{min:.8,max:1},MIN_SIZE:{min:1.2,max:1.8},MAX_SIZE:{min:3.5,max:5},DISTANCE:{min:300,max:600},TWINKLE_SPEED:{min:.002,max:.008}};class l{starSystem;material;geometry;params;starCount;static vertexShader=`
