import{S as l}from"./atlas_DSDeNuR3l3HMz0UA3yLvy.js";import{C as n,S as f,F as u,V as v}from"./atlas_BjkcO1_mNssSqp05cLhjd.js";const o={ROUGHNESS:{min:.6,max:.9},ROCK_DENSITY:{min:.4,max:.8},CRATER_COUNT:{min:.2,max:.6},OPACITY:{min:.7,max:.95}};class c{layerMesh;material;params;layerSystem;static vertexShader=`
