import{S as E,D as T,g as P}from"./atlas_DhOreEVM1uBHzRPTt7uMw.js";import{C as M,d as C,V as v,M as _,S as A,D as I,A as O}from"./atlas_CLp6T-BwF8hBVTNM0OiQd.js";const s={OBJECT_COUNT:{min:16,max:32},SPOT_SIZE:{min:.4,max:1.2},SPOT_SIZE_SPECIAL:{min:3.2,max:4.2},MOVE_SPEED:{min:.01,max:.1},INNER_ROTATION_SPEED:{min:-300,max:300},PULSE_AMPLITUDE:{min:.1,max:2.5},TIME_SPEED:{min:.1,max:3}},R=.04;function y(c,i,t){return new A({uniforms:{uTime:{value:0},uToxicColor:{value:c},uSize:{value:i},uSeed:{value:t},uPulseAmplitude:{value:.2}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
