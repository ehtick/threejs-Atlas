import{S as v,D as T,g as P}from"./atlas_devLC-KyT9W7vfPUn064J.js";import{G as M,C as _,d as A,V as g,M as C,S as I,D as O,A as R}from"./atlas_B2lpKXcKkLCAPkjGiW29w.js";const s={OBJECT_COUNT:{min:16,max:32},SPOT_SIZE:{min:.4,max:1.2},SPOT_SIZE_SPECIAL:{min:3.2,max:4.2},MOVE_SPEED:{min:.01,max:.1},INNER_ROTATION_SPEED:{min:-300,max:300},PULSE_AMPLITUDE:{min:.1,max:2.5},TIME_SPEED:{min:.1,max:3}},y=.04;function D(u,i,e){return new I({uniforms:{uTime:{value:0},uToxicColor:{value:u},uSize:{value:i},uSeed:{value:e},uPulseAmplitude:{value:.2}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
