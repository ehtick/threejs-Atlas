import{r as N,j as m,R as Jt,V as pi,c as gi}from"./atlas_bDOTfl6YifhEgi64OZoGp.js";import{H as vi}from"./atlas_DAPSgiEQDbHKEp53GoVrV.js";import{S as yi,U as xi,m as at,c as Pt,a as Si}from"./atlas_HOF5V4Y7Q3DW-IYNsZLlc.js";import{m as bi,V as T,n as qe,T as He,Q as Ft,l as jt,o as Ce,R as _i,p as Ei,q as ei,e as Te,r as ie,s as fe,N as Pe,t as Je,c as ft,C as h,u as wi,v as ze,d as be,G as Fe,w as ti,x as Rt,F as Ee,y as It,z as Nt,h as Ci,H as Ti,I as Mi,J as Xe,B as ii,K as At,O as Pi,U as Ii,X as Ni,L as st,g as nt,Y as Ai,Z as Ri,_ as Ke,M as oi,$ as Di,S as Li,P as Oi,W as zi,a0 as Fi,a1 as ji,a2 as ki,D as kt,A as Ui}from"./atlas_BVw4Oz7k70lSX13lINg8j.js";const Vi=({effects:r,onToggleEffect:e})=>{const[t,i]=N.useState(r),[o,a]=N.useState(!1);N.useEffect(()=>{i(r)},[r]);const n=(d,l)=>{i(s=>s.map(u=>u.id===d?{...u,enabled:l}:u)),e(d,l)},c=d=>d;return t.length===0?null:m.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-2",children:[m.jsx("div",{className:"text-xs text-gray-400",children:"3D Effects Control"}),m.jsxs("button",{onClick:()=>a(!o),className:"text-xs text-blue-400 hover:text-blue-300 transition-colors",children:[o?"Hide":"Show"," (",t.filter(d=>d.enabled).length,"/",t.length,")"]})]}),o&&m.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs",children:t.map(d=>m.jsxs("div",{className:"bg-white/5 rounded p-2 flex items-center justify-between",children:[m.jsxs("label",{className:"flex items-center gap-2 cursor-pointer flex-1",children:[m.jsx("input",{type:"checkbox",checked:d.enabled,onChange:l=>n(d.id,l.target.checked),className:"rounded border-gray-400 text-blue-500 focus:ring-blue-500 focus:ring-offset-0 bg-white/10"}),m.jsx("span",{className:`${d.enabled?"text-white":"text-gray-500"} transition-colors`,children:c(d.type)})]}),m.jsx("span",{className:`text-[10px] ${d.enabled?"text-green-400":"text-gray-600"}`,children:d.enabled?"ON":"OFF"})]},d.id))}),o&&t.length>3&&m.jsxs("div",{className:"mt-2 flex gap-2",children:[m.jsx("button",{onClick:()=>{t.forEach(d=>n(d.id,!0))},className:"text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded hover:bg-green-500/30 transition-colors",children:"Enable All"}),m.jsx("button",{onClick:()=>{t.forEach(d=>n(d.id,!1))},className:"text-xs px-2 py-1 bg-red-500/20 text-red-400 rounded hover:bg-red-500/30 transition-colors",children:"Disable All"})]})]})},Yi=({planet:r,system:e,galaxy:t,cosmicOriginTime:i,initialAngleRotation:o,effects:a,onToggleEffect:n})=>{const[c,d]=N.useState(!1),l=y=>y.replace(/_/g," "),s=y=>{const S=y/86400;return S<30?`${S.toFixed(2)} days`:S<365?`${(S/30).toFixed(2)} months`:`${(S/365).toFixed(2)} years`},u=y=>{const S=y*9/5+32;return`${y.toFixed(1)}°C (${S.toFixed(1)}°F)`},f=y=>`${y.toExponential(2)} kg`,p=y=>y>=1e3?`${(y/1e3).toFixed(2)} km`:`${y.toFixed(2)} m`;return m.jsxs("div",{className:"h-full flex flex-col relative",children:[m.jsx("div",{className:"absolute top-0 right-0 bg-green-500/20 border border-green-500/50 text-green-400 text-[10px] px-1.5 py-0.5 rounded z-10",children:"VISITED"}),m.jsxs("div",{className:"flex items-center justify-between mb-3 pr-16",children:[m.jsx("h3",{className:"text-lg sm:text-xl font-bold text-white",children:"Planet Information"}),m.jsx(yi,{type:"planet",name:r.name,coordinates:t.coordinates.join(","),systemIndex:e.index,planetName:r.name,className:"text-xs"})]}),m.jsxs("div",{className:"grid grid-cols-3 gap-2 mb-3",children:[m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-blue-500/30",children:[m.jsx("div",{className:"text-xs text-gray-200",children:"Type"}),m.jsx("div",{className:"text-sm font-bold text-blue-300 capitalize",children:r.planet_type})]}),m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-purple-500/30",children:[m.jsx("div",{className:"text-xs text-gray-200",children:"Atmosphere"}),m.jsx("div",{className:"text-sm font-bold text-purple-300 capitalize",children:r.atmosphere})]}),m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-green-500/30",children:[m.jsx("div",{className:"text-xs text-gray-200",children:"Life Forms"}),m.jsx("div",{className:"text-sm font-bold text-green-300 capitalize",children:r.life_forms})]})]}),m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-orange-500/30 mb-3",children:[m.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Physical Properties"}),m.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-1",children:[m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Mass"}),m.jsx("div",{className:"text-xs font-bold text-orange-300",children:f(r.mass)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Diameter"}),m.jsx("div",{className:"text-xs font-bold text-orange-300",children:p(r.diameter)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Density"}),m.jsxs("div",{className:"text-xs font-bold text-orange-300",children:[r.density.toFixed(2)," kg/m³"]})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-orange-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Gravity"}),m.jsxs("div",{className:"text-xs font-bold text-orange-300",children:[r.gravity.toFixed(2)," m/s²"]})]})]})]}),m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-cyan-500/30 mb-3",children:[m.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Orbital Properties"}),m.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-1",children:[m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Radius"}),m.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.orbital_radius.toFixed(2)," AU"]})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Period"}),m.jsx("div",{className:"text-xs font-bold text-cyan-300",children:s(r.orbital_period_seconds)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Speed"}),m.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.orbital_speed.toFixed(2)," m/s"]})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-cyan-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Tilt"}),m.jsxs("div",{className:"text-xs font-bold text-cyan-300",children:[r.axial_tilt.toFixed(2),"°"]})]})]})]}),m.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-2",children:[m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-red-500/30",children:[m.jsx("div",{className:"text-xs text-gray-200 mb-2",children:"Surface Conditions"}),m.jsxs("div",{className:"grid grid-cols-2 gap-1",children:[m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-red-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Temperature"}),m.jsx("div",{className:"text-xs font-bold text-red-300",children:u(r.surface_temperature)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-1.5 border border-red-500/20",children:[m.jsx("div",{className:"text-xs text-gray-300",children:"Rotation"}),m.jsx("div",{className:"text-xs font-bold text-red-300",children:s(r.rotation_period_seconds)})]})]})]}),m.jsxs("div",{className:"bg-white/10 rounded-lg p-2 border border-yellow-500/30",children:[m.jsxs("div",{className:"flex items-center justify-between mb-2",children:[m.jsxs("div",{className:"text-xs text-gray-200",children:["Elements (",r.elements.length,")"]}),r.elements.length>4&&m.jsx("button",{onClick:()=>d(!c),className:"text-xs text-yellow-400 hover:text-yellow-300 transition-colors duration-300",children:c?"▲ Less":"▼ All"})]}),m.jsx("div",{className:"flex flex-wrap gap-1",children:(c?r.elements:r.elements.slice(0,4)).map((y,S)=>m.jsx("span",{className:"text-xs bg-yellow-500/20 text-yellow-300 px-1.5 py-0.5 rounded border border-yellow-500/30",children:y},S))})]})]}),m.jsxs("div",{className:"mt-4 pt-3 border-t border-white/10",children:[m.jsx("div",{className:"text-xs text-gray-400 mb-2",children:"Technical Data"}),m.jsxs("div",{className:"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 text-xs",children:[m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"Status:"}),m.jsx("div",{className:"text-green-400 font-medium",children:"Visited"})]}),m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"Planet:"}),m.jsx("div",{className:"text-white truncate font-medium",children:l(r.name)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"System:"}),m.jsx("div",{className:"text-white truncate font-medium",children:l(e.name)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"System ID:"}),m.jsxs("div",{className:"text-white font-medium",children:["#",e.index+1]})]}),m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"Galaxy:"}),m.jsx("div",{className:"text-white truncate font-medium",children:l(t.name)})]}),m.jsxs("div",{className:"bg-white/5 rounded p-2",children:[m.jsx("span",{className:"text-gray-400",children:"Coordinates:"}),m.jsx("div",{className:"text-white font-medium",children:t.coordinates.join(", ")})]})]})]}),a&&n&&m.jsx(Vi,{effects:a,onToggleEffect:n})]})},Ut={type:"change"},Dt={type:"start"},ai={type:"end"},yt=new _i,Vt=new Ei,Wi=Math.cos(70*ei.DEG2RAD),pe=new T,_e=2*Math.PI,ee={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Ct=1e-6;class Gi extends bi{constructor(e,t=null){super(e,t),this.state=ee.NONE,this.target=new T,this.cursor=new T,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:qe.ROTATE,MIDDLE:qe.DOLLY,RIGHT:qe.PAN},this.touches={ONE:He.ROTATE,TWO:He.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new T,this._lastQuaternion=new Ft,this._lastTargetPosition=new T,this._quat=new Ft().setFromUnitVectors(e.up,new T(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new jt,this._sphericalDelta=new jt,this._scale=1,this._panOffset=new T,this._rotateStart=new Ce,this._rotateEnd=new Ce,this._rotateDelta=new Ce,this._panStart=new Ce,this._panEnd=new Ce,this._panDelta=new Ce,this._dollyStart=new Ce,this._dollyEnd=new Ce,this._dollyDelta=new Ce,this._dollyDirection=new T,this._mouse=new Ce,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Hi.bind(this),this._onPointerDown=Bi.bind(this),this._onPointerUp=$i.bind(this),this._onContextMenu=eo.bind(this),this._onMouseWheel=Xi.bind(this),this._onKeyDown=Ki.bind(this),this._onTouchStart=Qi.bind(this),this._onTouchMove=Ji.bind(this),this._onMouseDown=Zi.bind(this),this._onMouseMove=qi.bind(this),this._interceptControlDown=to.bind(this),this._interceptControlUp=io.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Ut),this.update(),this.state=ee.NONE}update(e=null){const t=this.object.position;pe.copy(t).sub(this.target),pe.applyQuaternion(this._quat),this._spherical.setFromVector3(pe),this.autoRotate&&this.state===ee.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,o=this.maxAzimuthAngle;isFinite(i)&&isFinite(o)&&(i<-Math.PI?i+=_e:i>Math.PI&&(i-=_e),o<-Math.PI?o+=_e:o>Math.PI&&(o-=_e),i<=o?this._spherical.theta=Math.max(i,Math.min(o,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+o)/2?Math.max(i,this._spherical.theta):Math.min(o,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const n=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=n!=this._spherical.radius}if(pe.setFromSpherical(this._spherical),pe.applyQuaternion(this._quatInverse),t.copy(this.target).add(pe),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let n=null;if(this.object.isPerspectiveCamera){const c=pe.length();n=this._clampDistance(c*this._scale);const d=c-n;this.object.position.addScaledVector(this._dollyDirection,d),this.object.updateMatrixWorld(),a=!!d}else if(this.object.isOrthographicCamera){const c=new T(this._mouse.x,this._mouse.y,0);c.unproject(this.object);const d=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=d!==this.object.zoom;const l=new T(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(c),this.object.updateMatrixWorld(),n=pe.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;n!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(n).add(this.object.position):(yt.origin.copy(this.object.position),yt.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(yt.direction))<Wi?this.object.lookAt(this.target):(Vt.setFromNormalAndCoplanarPoint(this.object.up,this.target),yt.intersectPlane(Vt,this.target))))}else if(this.object.isOrthographicCamera){const n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),n!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>Ct||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Ct||this._lastTargetPosition.distanceToSquared(this.target)>Ct?(this.dispatchEvent(Ut),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?_e/60*this.autoRotateSpeed*e:_e/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){pe.setFromMatrixColumn(t,0),pe.multiplyScalar(-e),this._panOffset.add(pe)}_panUp(e,t){this.screenSpacePanning===!0?pe.setFromMatrixColumn(t,1):(pe.setFromMatrixColumn(t,0),pe.crossVectors(this.object.up,pe)),pe.multiplyScalar(e),this._panOffset.add(pe)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const o=this.object.position;pe.copy(o).sub(this.target);let a=pe.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*a/i.clientHeight,this.object.matrix),this._panUp(2*t*a/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),o=e-i.left,a=t-i.top,n=i.width,c=i.height;this._mouse.x=o/n*2-1,this._mouse.y=-(a/c)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(_e*this._rotateDelta.x/t.clientHeight),this._rotateUp(_e*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(_e*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-_e*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(_e*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-_e*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._rotateStart.set(i,o)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._panStart.set(i,o)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,o=e.pageY-t.y,a=Math.sqrt(i*i+o*o);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),o=.5*(e.pageX+i.x),a=.5*(e.pageY+i.y);this._rotateEnd.set(o,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(_e*this._rotateDelta.x/t.clientHeight),this._rotateUp(_e*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),o=.5*(e.pageY+t.y);this._panEnd.set(i,o)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,o=e.pageY-t.y,a=Math.sqrt(i*i+o*o);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const n=(e.pageX+t.x)*.5,c=(e.pageY+t.y)*.5;this._updateZoomParameters(n,c)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Ce,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Bi(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function Hi(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function $i(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(ai),this.state=ee.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function Zi(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case qe.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=ee.DOLLY;break;case qe.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=ee.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=ee.ROTATE}break;case qe.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=ee.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=ee.PAN}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(Dt)}function qi(r){switch(this.state){case ee.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case ee.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case ee.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function Xi(r){this.enabled===!1||this.enableZoom===!1||this.state!==ee.NONE||(r.preventDefault(),this.dispatchEvent(Dt),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(ai))}function Ki(r){this.enabled!==!1&&this._handleKeyDown(r)}function Qi(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case He.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=ee.TOUCH_ROTATE;break;case He.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=ee.TOUCH_PAN;break;default:this.state=ee.NONE}break;case 2:switch(this.touches.TWO){case He.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=ee.TOUCH_DOLLY_PAN;break;case He.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=ee.TOUCH_DOLLY_ROTATE;break;default:this.state=ee.NONE}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(Dt)}function Ji(r){switch(this._trackPointer(r),this.state){case ee.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case ee.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case ee.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case ee.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=ee.NONE}}function eo(r){this.enabled!==!1&&r.preventDefault()}function to(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function io(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}class Yt{seed;constructor(e){this.seed=e}next(){return this.seed=this.seed*16807%2147483647,(this.seed-1)/2147483646}uniform(e,t){return e+(t-e)*this.next()}choice(e){return e[Math.floor(this.next()*e.length)]}}class si{ringSystem;material;params;planetRadius;constructor(e,t){this.planetRadius=e,this.params=t,this.createRingSystemFromAPI(t)}createRingSystemFromAPI(e){const{full_ring:t,ontop_ring:i,ring_inner_radius:o,ring_outer_radius:a,tilt_factor:n,planet_radius:c,shape_seed:d}=e;if(!t||!i){console.warn("No ring data provided");return}const l=[...t.particles,...i.particles],s=l.length,u=new Yt(d||12345),f=new Te,p=new Float32Array(s*3),y=new Float32Array(s*3),S=new Float32Array(s),_=[{baseGray:.18,variation:.04,name:"dark"},{baseGray:.25,variation:.06,name:"medium"},{baseGray:.32,variation:.06,name:"light"},{baseGray:.25,variation:.08,name:"mixed"}],v=u.choice(_);for(let x=0;x<s;x++){const A=l[x],g=this.planetRadius/(c||200),b=(d||12345)+x,P=new Yt(b),I=A.distance*g,M=A.angle,L=I*Math.sin(M),j=Math.asin((n||.2)*.5),w=L*Math.sin(j),V=L*Math.cos(j),Y=((a||400)-(o||200))*g*.4,G=P.uniform(-Y*.8,Y*.8),te=P.uniform(-Y*.3,Y*.3),Z=P.uniform(-.08,.08),K=I+te,D=M+Z;p[x*3]=K*Math.cos(D),p[x*3+1]=w+G+this.planetRadius*.15,p[x*3+2]=V+P.uniform(-Y*.4,Y*.4),A.color[0]/255;const z=(A.distance-(o||200))/((a||400)-(o||200)),q=v.baseGray,oe=v.variation,ge=P.uniform(-oe,oe),ae=Math.max(.12,Math.min(.45,q+ge)),ve=.8+z*.4,xe=P.uniform(.85,1.15),we=P.uniform(0,1),Se=we<.03?P.uniform(1.1,1.3):1,Ie=ae*ve*xe*Se,he=Math.max(.1,Math.min(.55,Ie));y[x*3]=he,y[x*3+1]=he,y[x*3+2]=he;const De=.15,Ne=P.uniform(.3,.7),ce=we<.1?P.uniform(1.05,1.2):1;S[x]=A.size*De*Ne*ce}f.setAttribute("position",new ie(p,3)),f.setAttribute("color",new ie(y,3)),f.setAttribute("size",new ie(S,1)),this.material=new fe({uniforms:{brightness:{value:2.2}},vertexShader:`
  ...
  `;constructor(e,t={}){const i=t.seed||Math.floor(Math.random()*1e6),o=new F(i);this.startTime=t.startTime||i%1e4/1e3,this.params={color:t.color||new h(16777215),cloudCount:t.cloudCount||Math.floor(o.uniform(H.CLOUD_COUNT.min,H.CLOUD_COUNT.max)),size:t.size||o.uniform(H.SIZE.min,H.SIZE.max),opacity:t.opacity||o.uniform(H.OPACITY.min,H.OPACITY.max),density:t.density||o.uniform(H.DENSITY.min,H.DENSITY.max),rotationSpeed:t.rotationSpeed||o.uniform(H.ROTATION_SPEED.min,H.ROTATION_SPEED.max),movementAmplitude:t.movementAmplitude||o.uniform(H.MOVEMENT_AMPLITUDE.min,H.MOVEMENT_AMPLITUDE.max),puffiness:t.puffiness||o.uniform(H.PUFFINESS.min,H.PUFFINESS.max),timeSpeed:t.timeSpeed||o.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max),seed:i,startTime:this.startTime},this.cloudCount=this.params.cloudCount,this.cloudSystem=new Fe,this.material=this.createMaterial(),this.generateClouds(e)}generateClouds(e){const t=this.params.color instanceof h?this.params.color:new h(this.params.color),i=this.params.seed||Math.floor(Math.random()*1e6),o=new F(i),a=this.params.cloudsFromPython;for(let n=0;n<this.cloudCount;n++){let c,d,l,s=t,u=this.params.size*o.uniform(.8,1.2);if(a&&n<a.length){const L=a[n];c=L.position[0]*e*1.04,d=L.position[1]*e*1.04,l=L.position[2]*e*1.04,L.color&&(s=new h().setRGB(L.color[0],L.color[1],L.color[2])),u=L.radius*e*.8}else{const L=o.uniform(0,2*Math.PI),j=o.uniform(-1,1),w=Math.acos(j),V=e*o.uniform(1.02,1.06);c=V*Math.sin(w)*Math.cos(L),d=V*Math.sin(w)*Math.sin(L),l=V*Math.cos(w)}const f=u*o.uniform(.3,.8),p=Math.max(8,Math.floor(f*15)),y=new ti(f*2,f*2,p,p),S=new T(c,d,l);new T(0,0,0);const _=S.clone().normalize(),v=new T,x=new T;Math.abs(_.y)<.99?v.crossVectors(_,new T(0,1,0)).normalize():v.crossVectors(_,new T(1,0,0)).normalize(),x.crossVectors(_,v).normalize();const A=new Rt;A.makeBasis(v,x,_);const g=y.attributes.position,b=new T,P=Math.sqrt(c*c+d*d+l*l);y.applyMatrix4(A);for(let L=0;L<g.count;L++){b.fromBufferAttribute(g,L);const Y=b.clone().add(S).clone().normalize().multiplyScalar(P).sub(S);g.setXYZ(L,Y.x,Y.y,Y.z)}g.needsUpdate=!0,y.computeVertexNormals(),y.translate(c,d,l);const I=this.material.clone();I.uniforms.cloudColor.value=s,I.uniforms.density.value=this.params.density*o.uniform(.8,1.2),I.uniforms.noiseOffset.value=new Ce(o.uniform(0,100),o.uniform(0,100)),I.uniforms.shapeVariation.value=o.uniform(-1,1),I.uniforms.lightDirection.value=this.material.uniforms.lightDirection.value.clone(),I.uniforms.lightPosition.value=this.material.uniforms.lightPosition.value.clone();const M=new be(y,I);M.userData.isAtmosphericCloud=!0,M.userData.planetNormal=_.clone(),this.clouds.push(M),this.cloudSystem.add(M)}}createMaterial(){return new fe({vertexShader:Qe.vertexShader,fragmentShader:Qe.fragmentShader,uniforms:{time:{value:0},opacity:{value:this.params.opacity},movementAmplitude:{value:this.params.movementAmplitude},cloudColor:{value:new h(16777215)},density:{value:this.params.density},noiseOffset:{value:new Ce(0,0)},shapeVariation:{value:0},lightDirection:{value:new T(1,1,1).normalize()},lightPosition:{value:new T(0,0,0)}},transparent:!0,blending:Pe,depthWrite:!1,side:Ee})}addToScene(e,t){t&&this.cloudSystem.position.copy(t),e.add(this.cloudSystem)}update(e,t){const o=(this.startTime+Date.now()/1e3*this.params.timeSpeed)%1e3;this.clouds.forEach(a=>{const n=a.material;n.uniforms.time.value=o}),this.cloudSystem.rotation.y=o*this.params.rotationSpeed}updateParams(e){this.params={...this.params,...e},this.clouds.forEach(t=>{const i=t.material;e.opacity!==void 0&&(i.uniforms.opacity.value=e.opacity),e.movementAmplitude!==void 0&&(i.uniforms.movementAmplitude.value=e.movementAmplitude)})}updateLightPosition(e){this.clouds.forEach(t=>{const i=t.material;i.uniforms.lightPosition&&i.uniforms.lightPosition.value.copy(e)})}updateLightDirection(e){this.clouds.forEach(t=>{const i=t.material;i.uniforms.lightDirection&&i.uniforms.lightDirection.value.copy(e)})}updateFromThreeLight(e){this.updateLightPosition(e.position);const t=e.target.position.clone().sub(e.position).normalize();this.updateLightDirection(t)}getObject3D(){return this.cloudSystem}dispose(){this.clouds.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),this.clouds=[],this.cloudSystem.clear()}}function We(r,e,t){const i=e.clouds||[];if(i.length===0){const c=t||Math.floor(Math.random()*1e6),d=new F(c+4e3),l={color:new h(1,1,1),cloudCount:15,size:.6,opacity:.7,density:.8,seed:c,rotationSpeed:.005,movementAmplitude:.02,puffiness:1.5,timeSpeed:d.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max)};return new Qe(r,l)}const o=t||Math.floor(Math.random()*1e6),a=new F(o+4e3),n={color:new h(16777215),cloudCount:i.length,size:a.uniform(H.SIZE.min,H.SIZE.max),opacity:a.uniform(H.OPACITY.min,H.OPACITY.max),density:a.uniform(H.DENSITY.min,H.DENSITY.max),seed:o,rotationSpeed:a.uniform(H.ROTATION_SPEED.min,H.ROTATION_SPEED.max),movementAmplitude:a.uniform(H.MOVEMENT_AMPLITUDE.min,H.MOVEMENT_AMPLITUDE.max),puffiness:a.uniform(H.PUFFINESS.min,H.PUFFINESS.max),timeSpeed:a.uniform(H.TIME_SPEED.min,H.TIME_SPEED.max),cloudsFromPython:i};return new Qe(r,n)}class Lt{landGroup;lands=[];constructor(e,t={}){this.landGroup=new Fe;const i=t.seed||Math.floor(Math.random()*1e6),o=new F(i);t.greenPatches&&t.greenPatches.length>0?this.generateLandsFromPython(e,t.greenPatches,o,t):this.generateProceduralLands(e,o,t)}generateLandsFromPython(e,t,i,o){t.forEach((a,n)=>{let c=a.position_3d||a.position||[0,0,1];if(c.length===2){const D=i.uniform(0,Math.PI*2),k=Math.acos(i.uniform(-1,1));c=[Math.sin(k)*Math.cos(D),Math.sin(k)*Math.sin(D),Math.cos(k)]}const d=(a.size||.1)*e*1.8;Math.max(8,Math.min(a.sides||20,12));let l=new h(4881497),s=1;a.color&&Array.isArray(a.color)&&(l=new h(a.color[0],a.color[1],a.color[2]),a.color.length>3&&(s=a.color[3]));const u=Math.max(24,Math.min(64,Math.floor(d*32))),f=new T(c[0],c[1],c[2]).normalize(),p=new T,y=new T;Math.abs(f.y)<.99?p.crossVectors(f,new T(0,1,0)).normalize():p.crossVectors(f,new T(1,0,0)).normalize(),y.crossVectors(f,p).normalize();const S=2/Math.max(d*.05,1),_=(D,k)=>{let z=0,q=1,oe=S,ge=0;const ae=Math.min(5,Math.max(3,Math.floor(d/40)+2));for(let ve=0;ve<ae;ve++){const xe=D*oe,we=k*oe,Se=(Ae,gt)=>{const it=Ae*12.9898+gt*78.233;return Math.sin(it+i.uniform(0,1e3))*43758.5453%1},Ie=Math.floor(xe),he=Math.floor(we),De=xe-Ie,Ne=we-he,ce=Ae=>Ae*Ae*Ae*(Ae*(Ae*6-15)+10),Le=ce(De),Ue=ce(Ne),et=Se(Ie,he),tt=Se(Ie+1,he),pt=Se(Ie,he+1),Ve=Se(Ie+1,he+1),je=et*(1-Le)+tt*Le,Et=pt*(1-Le)+Ve*Le,Ge=je*(1-Ue)+Et*Ue;z+=Ge*q,ge+=q,q*=.5,oe*=2.2}return z/ge},v=[],x=[],A=[],g=.35,b=new Map,P=new Map;let I=0;for(let D=0;D<=u;D++)for(let k=0;k<=u;k++){const z=(D/u-.5)*2,q=(k/u-.5)*2,oe=Math.sqrt(z*z+q*q),ge=_(z*2,q*2);if(1-oe*.5+ge*.6>g&&oe<1.2){const ve=z*d,xe=q*d,Se=new T().addScaledVector(p,ve).addScaledVector(y,xe).addScaledVector(f,0);v.push(Se.x,Se.y,Se.z),A.push((z+1)*.5,(q+1)*.5),b.set(`${D},${k}`,I),P.set(`${D},${k}`,ge),I++}}for(let D=0;D<u;D++)for(let k=0;k<u;k++){const z=b.get(`${D},${k}`),q=b.get(`${D+1},${k}`),oe=b.get(`${D},${k+1}`),ge=b.get(`${D+1},${k+1}`);z!==void 0&&q!==void 0&&oe!==void 0&&x.push(z,q,oe),q!==void 0&&ge!==void 0&&oe!==void 0&&x.push(q,ge,oe)}const M=new Te;M.setAttribute("position",new It(v,3)),M.setAttribute("uv",new It(A,2)),M.setIndex(x),M.computeVertexNormals();const L=M.attributes.position,j=f.clone().multiplyScalar(e),w=new T;for(let D=0;D<L.count;D++){w.fromBufferAttribute(L,D);const z=w.clone().add(j).clone().normalize(),q=M.attributes.uv;if(q){const oe=q.getX(D)*2-1,ge=q.getY(D)*2-1,ae=Math.sqrt(oe*oe+ge*ge),ve=_(oe*2,ge*2),we=Math.max(0,1-Math.pow(ae,.7))*.5+ve*.5,Ie=(je=>je*je*(3-2*je))(we),De=e*1.01-e,Ne=d*.15,ce=Math.min(Ne,De*.9),Le=e*.002,Ue=e+Le,et=e+Le+ce,tt=ei.lerp(Ue,et,Ie),Ve=z.multiplyScalar(tt).sub(j);L.setXYZ(D,Ve.x,Ve.y,Ve.z)}}L.needsUpdate=!0,M.computeVertexNormals(),M.translate(j.x,j.y,j.z);const V=new Nt({color:o.transparentMode?new h(15135743):l,opacity:o.transparentMode?.3:s,transparent:o.transparentMode||s<1,emissive:o.transparentMode?new h(13428479).multiplyScalar(.1):l.clone().multiplyScalar(.05),emissiveIntensity:o.transparentMode?.05:1e-7,shininess:o.transparentMode?30:8,flatShading:!1,bumpScale:.002}),Y=document.createElement("canvas");Y.width=Y.height=64;const G=Y.getContext("2d"),te=G.createImageData(64,64);for(let D=0;D<te.data.length;D+=4){const k=i.uniform(.8,1.2),z=Math.floor(128*k);te.data[D]=z,te.data[D+1]=z,te.data[D+2]=z,te.data[D+3]=255}G.putImageData(te,0,0);const Z=new Ci(Y);Z.wrapS=Z.wrapT=Ti,Z.repeat.set(2,2),V.bumpMap=Z;const K=new be(M,V);K.castShadow=!0,K.receiveShadow=!0,this.lands.push(K),this.landGroup.add(K)})}generateProceduralLands(e,t,i){const o=Math.floor(t.uniform(5,15));for(let a=0;a<o;a++){const n=t.uniform(0,Math.PI*2),c=Math.acos(t.uniform(-1,1)),d=new T(Math.sin(c)*Math.cos(n),Math.sin(c)*Math.sin(n),Math.cos(c)),l=e*t.uniform(.02,.08),s=new Mi(l,16),u=d.clone().multiplyScalar(e*1);s.lookAt(d),s.translate(u.x,u.y,u.z);const f=t.uniform(.3,.7),p=new h(.36*(1-f)+.22*f,.23*(1-f)+.36*f,0),S=i.tundraMode||!1?.25:1,_=new Nt({color:i.transparentMode?new h(15135743):p,opacity:i.transparentMode?.3:S,transparent:i.transparentMode||S<1,emissive:i.transparentMode?new h(13428479).multiplyScalar(.1):657920,shininess:i.transparentMode?30:5}),v=new be(s,_);this.lands.push(v),this.landGroup.add(v)}}addToScene(e,t){t&&this.landGroup.position.copy(t),e.add(this.landGroup)}update(e){}getObject3D(){return this.landGroup}dispose(){this.lands.forEach(e=>{e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.lands=[],this.landGroup.clear()}}function xt(r,e,t){const i=e.green_patches;if(!i||i.length===0)return null;const o=t||Math.floor(Math.random()*1e6);return new Lt(r,{greenPatches:i,seed:o+6e3})}function so(r,e,t){const i=t||Math.floor(Math.random()*1e6),o=new F(i+7e3),a=Math.floor(o.uniform(3,8)),n=[];for(let c=0;c<a;c++){const d=o.uniform(0,Math.PI*2),l=Math.acos(o.uniform(-1,1));n.push({position_3d:[Math.sin(l)*Math.cos(d),Math.sin(l)*Math.sin(d),Math.cos(l)],size:o.uniform(.05,.15),sides:Math.floor(o.uniform(8,16)),color:[0,0,0]})}return console.log(`🧊 Creating ${a} transparent ice formations for Icy planet with seed ${i+7e3}`),new Lt(r,{greenPatches:n,seed:i+7e3,transparentMode:!0})}class no{featuresGroup;crystals=[];cracks=[];iceCaps=[];planetRadius;constructor(e,t={}){this.featuresGroup=new Fe,this.planetRadius=e;const i=t.seed||Math.floor(Math.random()*1e6),o=new F(i);t.crystals&&t.crystals.length>0&&this.generateCrystals(t.crystals,o),t.cracks&&t.cracks.length>0&&this.generateCracks(t.cracks),t.iceCaps&&t.iceCaps.length>0&&this.generateIceCaps(t.iceCaps,o)}generateCrystals(e,t){e.forEach(i=>{const o=i.position||[0,0],a=(i.width||.05)*this.planetRadius*.8,n=(i.length||.1)*this.planetRadius*.08,c=i.angle||0,d=i.color||[172/255,215/255,230/255,1],l=this.planetRadius*.015,s=Math.max(n,l),u=new ii(a*2,s,a*1.5,4,2,4),f=u.attributes.position,p=new T;for(let Z=0;Z<f.count;Z++){if(p.fromBufferAttribute(f,Z),Math.abs(p.y)>s*.3){const K=Math.atan2(p.z,p.x),D=Math.sqrt(p.x*p.x+p.z*p.z),k=Math.round(K/(Math.PI/3))*(Math.PI/3),z=t.uniform(.8,1.2),q=D*z;p.x=Math.cos(k)*q,p.z=Math.sin(k)*q,p.y+=t.uniform(-s*.1,s*.1)}f.setXYZ(Z,p.x,p.y,p.z)}f.needsUpdate=!0,u.computeVertexNormals();const y=new At({color:new h(d[0],d[1],d[2]),transparent:!0,opacity:.8,metalness:0,roughness:.02,clearcoat:1,clearcoatRoughness:0,transmission:.7,ior:1.31,thickness:.5,emissive:new h(d[0],d[1],d[2]),emissiveIntensity:.02,flatShading:!1,side:Ee}),S=new be(u,y);let _=Math.min(1,Math.max(-1,o[1]));const v=Math.pow(Math.abs(_),.3),x=Math.sign(_)*v,A=t.uniform(-.3,.3)*(1-Math.abs(x)),g=Math.min(1,Math.max(-1,x+A)),b=Math.acos(Math.abs(g)),P=Math.atan2(o[0],.001)+c,I=this.planetRadius*t.uniform(1.0005,1.001),M=I*Math.sin(b)*Math.cos(P),L=I*g,j=I*Math.sin(b)*Math.sin(P);S.position.set(M,L,j);const w=S.position.clone().normalize(),V=new T,Y=new T;Math.abs(w.x)<.9?V.set(1,0,0):V.set(0,1,0),V.crossVectors(V,w).normalize(),Y.crossVectors(w,V).normalize();const G=new Rt;G.makeBasis(V,w,Y),S.rotation.setFromRotationMatrix(G),S.rotateY(t.uniform(0,Math.PI*2));const te=t.uniform(.8,1.2);S.scale.set(te,te,te),this.crystals.push(S),this.featuresGroup.add(S)})}generateCracks(e){const t=new F(42);e.forEach(i=>{const o=i.angle||0,a=(i.length||1)*this.planetRadius*2,n=i.color||[80/255,80/255,80/255,.4],c=(i.width||1)*5e-4*this.planetRadius,d=t.uniform(.6,1),l=t.uniform(0,1)>.5?1:-1,s=Math.acos(d*l),u=[],f=20;for(let v=0;v<=f;v++){const x=v/f,A=Math.sin(x*Math.PI)*.1,b=o+(x-.5)*a/(this.planetRadius*Math.sin(Math.abs(s)))+A,P=this.planetRadius*1.002*Math.sin(Math.abs(s))*Math.cos(b),I=this.planetRadius*1.002*Math.cos(Math.abs(s))*l,M=this.planetRadius*1.002*Math.sin(Math.abs(s))*Math.sin(b);u.push(new T(P,I,M))}const p=new Pi(u),y=new Ii(p,f*2,c,8,!1),S=new Nt({color:new h(n[0],n[1],n[2]),transparent:!0,opacity:n[3]||.4,emissive:new h(0,0,0),shininess:5}),_=new be(y,S);this.cracks.push(_),this.featuresGroup.add(_)})}generateIceCaps(e,t){e.forEach(i=>{const o=i.position||[0,0],a=(i.radius||.3)*this.planetRadius,n=i.color||[.678,.847,1,.8],c=Math.atan2(o[1],o[0]),d=Math.acos(Math.min(1,Math.max(-1,Math.sqrt(o[0]**2+o[1]**2)))),l=this.planetRadius*1.002*Math.sin(d)*Math.cos(c),s=this.planetRadius*1.002*Math.cos(d),u=this.planetRadius*1.002*Math.sin(d)*Math.sin(c),f=new T(l,s,u),p=f.clone().normalize(),y=new Fe,S=Math.floor(t.uniform(8,20));for(let _=0;_<S;_++){const v=t.uniform(0,Math.PI*2),x=t.uniform(0,a*.8),A=Math.cos(v)*x,g=Math.sin(v)*x,b=new T,P=new T;Math.abs(p.y)<.99?b.crossVectors(p,new T(0,1,0)).normalize():b.crossVectors(p,new T(1,0,0)).normalize(),P.crossVectors(p,b).normalize();const L=f.clone().addScaledVector(b,A).addScaledVector(P,g).normalize().multiplyScalar(this.planetRadius*t.uniform(1.002,1.008)),j=t.uniform(a*.05,a*.15),w=t.uniform(j*.4,j*4),V=new Ni(j,w,6,1,!1),Y=V.attributes.position,G=new T;for(let D=0;D<Y.count;D++)if(G.fromBufferAttribute(Y,D),G.y>.1&&G.y<w*.9){const k=Math.atan2(G.z,G.x),z=Math.sqrt(G.x*G.x+G.z*G.z),q=Math.round(k/(Math.PI/3))*(Math.PI/3),oe=z*1.1;G.x=Math.cos(q)*oe,G.z=Math.sin(q)*oe,Y.setXYZ(D,G.x,G.y,G.z)}Y.needsUpdate=!0,V.computeVertexNormals();const te=new At({color:new h(n[0],n[1],n[2]),transparent:!0,opacity:.85,metalness:0,roughness:.05,clearcoat:1,clearcoatRoughness:0,transmission:.6,ior:1.31,thickness:.8,emissive:new h(n[0],n[1],n[2]),emissiveIntensity:.03,flatShading:!0,side:Ee}),Z=new be(V,te);Z.position.copy(L),Z.lookAt(0,0,0),Z.rotateX(Math.PI/2),Z.rotateZ(t.uniform(0,Math.PI*2));const K=t.uniform(.7,1.3);Z.scale.set(K,K,K),y.add(Z),this.iceCaps.push(Z)}this.featuresGroup.add(y)})}addToScene(e,t){t&&this.featuresGroup.position.copy(t),e.add(this.featuresGroup)}update(){}getObject3D(){return this.featuresGroup}dispose(){this.crystals.forEach(e=>{e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.cracks.forEach(e=>{e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.iceCaps.forEach(e=>{e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.crystals=[],this.cracks=[],this.iceCaps=[],this.featuresGroup.clear()}}function Gt(r,e,t){const i=e.crystals,o=e.cracks,a=e.ice_caps;if(!i&&!o&&!a)return null;const n=t||Math.floor(Math.random()*1e6);return new no(r,{crystals:i||[],cracks:o||[],iceCaps:a||[],seed:n+9e3})}class ni{snowflakeGroup;planetRadius;materials=[];particleSystems=[];trailPositions=[];trailColors=[];globalWindDirection;rng;startTime;timeSpeed;trailLength=15;particleCount;rotationSpeed;particleOpacity;windSpeedMultiplier;verticalOscillation;gustCycles;gustPhases;gustZones;burstZone;burstCycleDuration;burstDuration;burstStartOffset;constructor(e,t={}){this.snowflakeGroup=new Fe,this.planetRadius=e;const i=t.seed||Math.floor(Math.random()*1e6);this.rng=new F(i),this.particleCount=t.particleCount||10,t.windSpeed;const o=(t.size||1)*(e*.2),a=t.opacity||1;this.globalWindDirection=this.rng.uniform(0,Math.PI*2),this.startTime=this.rng.uniform(0,1e3),this.timeSpeed=this.rng.uniform(2,4),this.rotationSpeed=this.rng.uniform(.2,.8),this.particleOpacity=this.rng.uniform(.05,.25),this.windSpeedMultiplier=this.rng.uniform(1.1,2.5),this.verticalOscillation=this.rng.uniform(.1,.4),this.gustCycles=[],this.gustPhases=[],this.gustZones=[];for(let c=0;c<this.particleCount;c++){this.gustCycles.push(this.rng.uniform(15,30)),this.gustPhases.push(this.rng.uniform(0,1));const d=this.rng.uniform(0,Math.PI*2),l=this.rng.uniform(Math.PI*.3,Math.PI*.6);this.gustZones.push({start:d,end:(d+l)%(Math.PI*2)})}this.burstZone={lat:this.rng.uniform(-Math.PI/3,Math.PI/3),lon:this.rng.uniform(0,Math.PI*2),radius:this.rng.uniform(1.2,2)},this.burstCycleDuration=this.rng.uniform(45,75),this.burstDuration=this.rng.uniform(8,15),this.burstStartOffset=this.rng.uniform(0,this.burstCycleDuration);const n=t.colors||[new h(1,1,1),new h(.9,.9,.9),new h(.7,.7,.7),new h(.5,.5,.5),new h(.3,.3,.3)];this.createSnowflakeSystem(this.particleCount,o,a,n)}createSnowflakeSystem(e,t,i,o){const a=[];for(let d=0;d<e;d++){let l,s,u,f=0;do{const v=(this.rng.uniform(-1,1)+this.rng.uniform(-1,1))*.2,x=this.rng.uniform(-1,1)*this.burstZone.radius;l=Math.max(0,Math.min(Math.PI,this.burstZone.lat+Math.PI/2+v)),s=(this.burstZone.lon+x)%(Math.PI*2);const A=Math.abs(l-(this.burstZone.lat+Math.PI/2)),g=Math.min(Math.abs(s-this.burstZone.lon),Math.PI*2-Math.abs(s-this.burstZone.lon));u=Math.max(A/.3,g/this.burstZone.radius),f++}while(u>1&&f<10);u>1&&(l=this.burstZone.lat+Math.PI/2+this.rng.uniform(-.1,.1),s=this.burstZone.lon+this.rng.uniform(-this.burstZone.radius,this.burstZone.radius));const p=this.planetRadius*this.rng.uniform(1.001,1.005),y=p*Math.sin(l)*Math.cos(s),S=p*Math.cos(l),_=p*Math.sin(l)*Math.sin(s);a.push(y,S,_)}const n=[],c=new h;for(let d=0;d<this.trailLength;d++){const l=Math.pow(1-d/(this.trailLength-1),1.5);c.setRGB(l,l,l),n.push(c.r,c.g,c.b)}for(let d=0;d<e;d++){const l=d*3,s=a[l],u=a[l+1],f=a[l+2],p=new Float32Array(this.trailLength*3);for(let v=0;v<this.trailLength;v++){const x=v*.1;p[v*3]=s+this.rng.uniform(-1,1)*x*this.planetRadius*.01,p[v*3+1]=u+this.rng.uniform(-1,1)*x*this.planetRadius*.01,p[v*3+2]=f+this.rng.uniform(-1,1)*x*this.planetRadius*.01}const y=new Te;y.setAttribute("position",new ie(p,3)),y.setAttribute("color",new ie(new Float32Array(n),3));const S=new st({vertexColors:!0,transparent:!0,opacity:this.particleOpacity,blending:Pe,depthTest:!0,linewidth:3}),_=new nt(y,S);this.materials.push(S),this.particleSystems.push(_),this.trailPositions.push(p),this.trailColors.push(new Float32Array(n)),_.rnd=this.rng.uniform(0,1),_.particleIndex=d,this.snowflakeGroup.add(_)}}update(e=.016){const i=(this.startTime+Date.now()/1e3*this.timeSpeed)%1e3,a=(Date.now()/1e3+this.burstStartOffset)%this.burstCycleDuration;let n=0;if(a<this.burstDuration){const c=a/this.burstDuration;c<.2?n=c/.2:c>.8?n=(1-c)/.2:n=1}this.snowflakeGroup.visible=!0,Math.floor(a)%5===0&&a%1<.1&&console.log("❄️ Burst Debug:",{burstTime:Math.round(a),burstIntensity:Math.round(n*100)/100,cycleDuration:Math.round(this.burstCycleDuration),burstDuration:Math.round(this.burstDuration)}),this.particleSystems.forEach((c,d)=>{const l=c.geometry.getAttribute("position"),s=l.array,u=c.rnd,f=c.particleIndex,p=this.calculateTrailPath(i,f,u);for(let M=this.trailLength-1;M>0;M--){const L=M*3,j=(M-1)*3;s[L]=s[j],s[L+1]=s[j+1],s[L+2]=s[j+2]}s[0]=p.x,s[1]=p.y,s[2]=p.z,l.needsUpdate=!0;const y=Date.now()/1e3,S=this.gustCycles[d],_=this.gustPhases[d],v=(y/S+_)%1;let x=0;v<.3?x=v/.3:v<.7?x=1:x=(1-v)/.3;const A=new T(s[0],s[1],s[2]),g=Math.atan2(A.z,A.x),b=g<0?g+Math.PI*2:g,P=this.gustZones[d];let I=!1;P.start<P.end?I=b>=P.start&&b<=P.end:I=b>=P.start||b<=P.end,this.materials[d].opacity=I?this.particleOpacity*x:0})}calculateTrailPath(e,t,i){e+=10*i+t*.1;const o=this.burstZone.lon+(i-.5)*this.burstZone.radius,a=this.burstZone.lat+Math.PI/2+(i-.5)*.2,n=this.windSpeedMultiplier,c=e*n,d=o+Math.cos(this.globalWindDirection)*c,l=a+this.verticalOscillation*Math.sin(e*.5+i),s=.015*Math.sin(e*2+i*10),u=this.planetRadius*(1.005+s),f=u*Math.sin(l)*Math.cos(d),p=u*Math.cos(l),y=u*Math.sin(l)*Math.sin(d);return{x:f,y:p,z:y}}addToScene(e,t){t&&this.snowflakeGroup.position.copy(t),e.add(this.snowflakeGroup)}getObject3D(){return this.snowflakeGroup}dispose(){this.materials.forEach(e=>e.dispose()),this.particleSystems.forEach(e=>e.geometry.dispose()),this.materials=[],this.particleSystems=[],this.trailPositions=[],this.trailColors=[],this.snowflakeGroup.clear()}}function Bt(r,e,t){if(e.type!=="tundra")return null;const i=t||Math.floor(Math.random()*1e6),o=e.snow_intensity||.7,a=e.wind_strength||1,n=Math.floor(o*200+50),c=a*5;return new ni(r,{particleCount:n,windSpeed:c,size:1.2,opacity:.9,seed:i+15e3})}const le={PARTICLE_COUNT:{min:60,max:150},PHASE_INTENSITY:{min:.4,max:.9},TRANSITION_SPEED:{min:1,max:4},COHERENCE_LEVEL:{min:.2,max:.7},TIME_SPEED:{min:.6,max:2.2},PHASE_STATES:{min:3,max:6}};class ct{phaseSystem;material;geometry;params;particleCount;startTime;static vertexShader=`
    attribute float size;
  ...
  `;constructor(e,t=new h(16753920)){this.baseMesh=e;const i=e.geometry;this.planetRadius=i.parameters.radius||1;const o=t instanceof h?t:new h(t);this.baseMaterial=new fe({vertexShader:dt.baseVertexShader,fragmentShader:dt.baseFragmentShader,uniforms:{baseColor:{value:o},lightDirection:{value:new T(1,1,1).normalize()},lightPosition:{value:new T(0,0,0)},ambientStrength:{value:.15},lightIntensity:{value:.85}},side:Ee}),this.baseMesh.material=this.baseMaterial}addEffectLayer(e,t,i=1.001,o){const a=new ft(this.planetRadius*i,256,256),n=new be(a,t);return n.position.copy(this.baseMesh.position),n.rotation.copy(this.baseMesh.rotation),this.effectLayers.push({name:e,mesh:n,material:t,layerObject:o}),this.scene&&this.scene.add(n),n}createCloudBandsLayerMaterial(e){const t=`
    ...
    `;return new fe({vertexShader:t,fragmentShader:i,uniforms:{time:{value:0},seed:{value:e.seed||Math.random()*1e3},bandColor:{value:e.bandColor||new h(16747520)},numBands:{value:e.numBands||8},rotationAngle:{value:e.rotationAngle||0},bandPositions:{value:e.bandPositions||new Array(20).fill(0)},bandWidths:{value:e.bandWidths||new Array(20).fill(.1)},animationSpeed:{value:e.animationSpeed||1},turbulence:{value:e.turbulence||.5},noiseScale:{value:e.noiseScale||3},lightDirection:{value:new T(1,1,1).normalize()},opacity:{value:e.opacity||.4}},transparent:!0,blending:Pe,side:Ee,depthWrite:!1})}createCloudGyrosLayerMaterial(e){const t=`
      varying vec3 vPosition;
      varying vec3 vNormal;
      varying vec2 vUv;
    ...
    `,o=new Array(10).fill(0);return e.stormCenters&&e.stormCenters.forEach((a,n)=>{n<5&&(o[n*2]=a.x,o[n*2+1]=a.y)}),new fe({vertexShader:t,fragmentShader:i,uniforms:{time:{value:0},stormColor:{value:e.stormColor||new h(9109504)},stormIntensity:{value:e.stormIntensity||.8},spiralSpeed:{value:e.spiralSpeed||2},animationSpeed:{value:e.animationSpeed||1},stormCenters:{value:o},numStorms:{value:e.stormCenters?Math.min(e.stormCenters.length,5):3},lightDirection:{value:new T(1,1,1).normalize()}},transparent:!0,blending:Pe,side:Ee,depthWrite:!1})}createMetallicSurfaceLayerMaterial(e){const t=`
      varying vec3 vPosition;
      varying vec3 vNormal;
      varying vec3 vWorldPosition;
      varying vec3 vWorldNormal;
...
`;class Tt{mesh;material;params;startTime;proceduralParams;constructor(e){const t=e.seed||Math.floor(Math.random()*1e6),i=new F(t);this.startTime=e.startTime||t%1e4/1e3,this.proceduralParams={size:i.uniform(ke.SIZE.min,ke.SIZE.max),rotationSpeed:i.uniform(ke.ROTATION_SPEED.min,ke.ROTATION_SPEED.max),opacity:i.uniform(ke.OPACITY.min,ke.OPACITY.max),timeSpeed:i.uniform(ke.TIME_SPEED.min,ke.TIME_SPEED.max)},this.params=e;const o=new h(e.planetColor),a=o.clone();a.multiplyScalar(1-e.hexagonData.color_darken_factor),this.material=new fe({uniforms:{time:{value:0},planetColor:{value:o},hexagonColor:{value:a},darkenFactor:{value:e.hexagonData.color_darken_factor},opacity:{value:this.proceduralParams.opacity},hexagonRadius:{value:this.proceduralParams.size},rotationSpeed:{value:this.proceduralParams.rotationSpeed},pole:{value:e.hexagonData.pole==="north"?1:-1},visibility:{value:1}},vertexShader:xo,fragmentShader:So,transparent:!0,depthWrite:!1,side:Ee,blending:e.hexagonData.nebula_blend?ze:Pe});const n=this.createCurvedHexagonGeometry(e.hexagonData.pole,e.hexagonData.radius);this.mesh=new be(n,this.material),this.mesh.scale.set(e.planetRadius,e.planetRadius,e.planetRadius),this.updateVisibility()}updateVisibility(){if(!this.params.hexagonData.enabled){this.material.uniforms.visibility.value=0;return}const t=(this.params.currentTime||0)%this.params.hexagonData.cycle_duration_years/this.params.hexagonData.cycle_duration_years,i=this.params.hexagonData.visible_duration_years/this.params.hexagonData.cycle_duration_years;if(t<i){const o=t/i;o<.1?this.material.uniforms.visibility.value=o/.1:o>.9?this.material.uniforms.visibility.value=(1-o)/.1:this.material.uniforms.visibility.value=1}else this.material.uniforms.visibility.value=0}update(e){const i=(this.startTime+Date.now()/1e3*this.proceduralParams.timeSpeed)%1e3;this.material.uniforms.time.value=i,this.updateVisibility()}addToScene(e){e.add(this.mesh)}removeFromScene(e){e.remove(this.mesh)}dispose(){this.material.dispose(),this.mesh.geometry.dispose()}createCurvedHexagonGeometry(e,t){const i=e==="north"?1:-1,o=64,a=1,n=new ti(a,a,o,o),c=n.attributes.position,d=new T;for(let l=0;l<c.count;l++){d.fromBufferAttribute(c,l);const s=d.x,u=d.y,f=Math.sqrt(s*s+u*u);if(f<=a/2){const y=f*Math.PI*.5,S=i*Math.cos(y)*1.02,_=Math.sin(y)*1.02;if(f>0){const v=s/f,x=u/f;d.x=v*_,d.y=S,d.z=x*_}else d.x=0,d.y=i*1.02,d.z=0}c.setXYZ(l,d.x,d.y,d.z)}return c.needsUpdate=!0,n.computeVertexNormals(),n}setEnabled(e){this.mesh.visible=e}}class qt{fragments;fragmentMeshes=[];params;planetRadius;constructor(e,t={}){this.planetRadius=e,this.params={fragmentCount:t.fragmentCount||20,color:t.color||new h(4473924),size:t.size||.05,distribution:t.distribution||"edge",animationSpeed:t.animationSpeed||1,rotationSpeed:t.rotationSpeed||.1,metalness:t.metalness||.9,roughness:t.roughness||.6},this.fragments=new Fe,this.generateFragments()}generateFragments(){const e=new Ke({color:this.params.color instanceof h?this.params.color:new h(this.params.color),metalness:this.params.metalness,roughness:this.params.roughness});for(let t=0;t<this.params.fragmentCount;t++){const i=this.generateFragmentGeometry(),o=new be(i,e);this.positionFragment(o,t),o.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);const a=this.params.size*(Math.random()*.5+.75);o.scale.set(a,a,a),o.userData={rotationAxis:new T(Math.random()-.5,Math.random()-.5,Math.random()-.5).normalize(),rotationSpeed:(Math.random()-.5)*this.params.rotationSpeed},this.fragmentMeshes.push(o),this.fragments.add(o)}}generateFragmentGeometry(){const e=Math.floor(Math.random()*4)+3,t=[],i=[],o=[];o.push(new T(0,0,0));for(let c=0;c<e;c++){const d=c/e*Math.PI*2,l=Math.random()*.5+.5,s=(Math.random()-.5)*.3;o.push(new T(Math.cos(d)*l,Math.sin(d)*l,s))}for(let c=1;c<=e;c++){const l=o[c].clone();l.z+=Math.random()*.4+.2,o.push(l)}for(const c of o)t.push(c.x,c.y,c.z);for(let c=1;c<e;c++)i.push(0,c,c+1);i.push(0,e,1);const a=o.length-e-1;for(let c=0;c<e-1;c++)i.push(a,a+c+2,a+c+1);i.push(a,a+1,a+e);for(let c=0;c<e;c++){const d=c+1,l=(c+1)%e+1,s=d+e,u=l+e;i.push(d,s,l),i.push(l,s,u)}const n=new Te;return n.setAttribute("position",new It(t,3)),n.setIndex(i),n.computeVertexNormals(),n}positionFragment(e,t){let i;switch(this.params.distribution){case"edge":i=this.generateEdgePosition(t);break;case"surface":i=this.generateSurfacePosition();break;case"random":default:i=this.generateRandomPosition();break}e.position.copy(i)}generateEdgePosition(e){const t=e/this.params.fragmentCount*Math.PI*2,i=this.planetRadius*(.95+Math.random()*.1),o=(Math.random()-.5)*this.planetRadius*.5;return new T(Math.cos(t)*i,o,Math.sin(t)*i)}generateSurfacePosition(){const e=Math.random()*Math.PI*2,t=Math.acos(Math.random()*2-1),i=this.planetRadius*(1+Math.random()*.05);return new T(i*Math.sin(t)*Math.cos(e),i*Math.sin(t)*Math.sin(e),i*Math.cos(t))}generateRandomPosition(){const e=this.planetRadius*(.8+Math.random()*.4),t=Math.random()*Math.PI*2,i=Math.random()*Math.PI*2;return new T(e*Math.sin(t)*Math.cos(i),e*Math.sin(t)*Math.sin(i),e*Math.cos(t))}addToScene(e,t){t&&this.fragments.position.copy(t),e.add(this.fragments)}update(e){this.fragmentMeshes.forEach((t,i)=>{const o=t.userData;t.rotateOnAxis(o.rotationAxis,o.rotationSpeed*e*this.params.animationSpeed);const a=Math.sin(Date.now()*.001+i)*.001;t.position.y+=a*e}),this.fragments.rotation.y+=e*.01*this.params.animationSpeed}updateParams(e){if(this.params={...this.params,...e},e.color){const t=e.color instanceof h?e.color:new h(e.color);this.fragmentMeshes.forEach(i=>{i.material instanceof Ke&&(i.material.color=t)})}(e.metalness!==void 0||e.roughness!==void 0)&&this.fragmentMeshes.forEach(t=>{t.material instanceof Ke&&(e.metalness!==void 0&&(t.material.metalness=e.metalness),e.roughness!==void 0&&(t.material.roughness=e.roughness))}),(e.size!==void 0||e.fragmentCount!==void 0)&&this.regenerateFragments()}regenerateFragments(){this.fragmentMeshes.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.fragments.clear(),this.fragmentMeshes=[],this.generateFragments()}getObject3D(){return this.fragments}getFragmentMeshes(){return[...this.fragmentMeshes]}dispose(){this.fragmentMeshes.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material instanceof Xe&&e.material.dispose()}),this.fragmentMeshes=[],this.fragments.clear()}}function St(r){const e=r.replace("#",""),t=parseInt(e.substr(0,2),16)/255,i=parseInt(e.substr(2,2),16)/255,o=parseInt(e.substr(4,2),16)/255;return new h(t,i,o)}function Mt(r){return r.length>=3?new h(r[0],r[1],r[2]):new h(.5,.5,.5)}function $e(r){if(r.ocean_color){if(typeof r.ocean_color=="string")return St(r.ocean_color);if(Array.isArray(r.ocean_color))return Mt(r.ocean_color)}if(r.planet_info?.base_color){if(typeof r.planet_info.base_color=="string")return St(r.planet_info.base_color);if(Array.isArray(r.planet_info.base_color))return Mt(r.planet_info.base_color)}if(r.base_color){if(typeof r.base_color=="string")return St(r.base_color);if(Array.isArray(r.base_color))return Mt(r.base_color)}const e=r.planet_info?.type||r.type||"Unknown";return bo(e)}function bo(r){const t={"Gas Giant":"#FFA500",Anomaly:"#FFFFFF",Rocky:"#808080",Icy:"#ADD8E6",Oceanic:"#0000FF",Desert:"#FFD700",Lava:"#FF0000",Arid:"#800000",Swamp:"#008000",Tundra:"#F0F8FF",Forest:"#006400",Savannah:"#F4A460",Cave:"#D1D1D1",Crystalline:"#00FFFF",Metallic:"#C0C0C0",Toxic:"#800080",Radioactive:"#00FF00",Magma:"#FF4500","Molten Core":"#FF8C00",Carbon:"#090909",Diamond:"#87CEFA","Super Earth":"#90EE90","Sub Earth":"#006400","Frozen Gas Giant":"#ADD8E6",Nebulous:"#FFC0CB",Aquifer:"#00FFFF",Exotic:"#FF00FF"}[r]||"#FFFFFF";return St(t)}class ht{material;params;oceanLayerMesh;static vertexShader=`
  ...
  `;constructor(e,t={}){this.params={radius:t.radius||e*.999,detail:t.detail||128,flowSpeed:t.flowSpeed||.5,waveAmplitude:t.waveAmplitude||.02,opacity:t.opacity||.75,colorDeep:t.colorDeep||new h(4147),colorShallow:t.colorShallow||new h(26333),...t};const i=new ft(this.params.radius,this.params.detail,this.params.detail);this.material=new fe({vertexShader:ut.vertexShader,fragmentShader:ut.fragmentShader,uniforms:{uTime:{value:0},uFlowSpeed:{value:this.params.flowSpeed},uWaveAmplitude:{value:this.params.waveAmplitude},uFresnelPower:{value:1.5},uOpacity:{value:this.params.opacity},uColorDeep:{value:this.params.colorDeep instanceof h?this.params.colorDeep:new h(this.params.colorDeep)},uColorShallow:{value:this.params.colorShallow instanceof h?this.params.colorShallow:new h(this.params.colorShallow)},uNoiseScale:{value:3},uSecondaryWaveScale:{value:6},uPrimaryFlowSpeed:{value:this.params.flowSpeed||.5},uSecondaryFlowSpeed:{value:(this.params.flowSpeed||.5)*1.6},uUvPatternSpeed1:{value:(this.params.flowSpeed||.5)*4},uUvPatternSpeed2:{value:(this.params.flowSpeed||.5)*3}},transparent:!0,depthWrite:!1,depthTest:!0,side:Ee,blending:Pe}),this.mesh=new be(i,this.material),this.mesh.renderOrder=-1,console.log("🌊 FluidLayersEffect created with params:",this.params)}addToScene(e,t){t&&this.mesh.position.copy(t),e.add(this.mesh),console.log("🌊 FluidLayers mesh added to scene at position:",this.mesh.position)}update(e,t){this.material.uniforms.uTime.value+=e,t!==void 0&&(this.mesh.rotation.y=t)}updateParams(e){if(this.params={...this.params,...e},e.flowSpeed!==void 0&&(this.material.uniforms.uFlowSpeed.value=e.flowSpeed,this.material.uniforms.uPrimaryFlowSpeed.value=e.flowSpeed,this.material.uniforms.uSecondaryFlowSpeed.value=e.flowSpeed*1.6,this.material.uniforms.uUvPatternSpeed1.value=e.flowSpeed*4,this.material.uniforms.uUvPatternSpeed2.value=e.flowSpeed*3),e.waveAmplitude!==void 0&&(this.material.uniforms.uWaveAmplitude.value=e.waveAmplitude),e.opacity!==void 0&&(this.material.uniforms.uOpacity.value=e.opacity),e.colorDeep){const t=e.colorDeep instanceof h?e.colorDeep:new h(e.colorDeep);this.material.uniforms.uColorDeep.value=t}if(e.colorShallow){const t=e.colorShallow instanceof h?e.colorShallow:new h(e.colorShallow);this.material.uniforms.uColorShallow.value=t}}getObject3D(){return this.mesh}dispose(){this.mesh.geometry&&this.mesh.geometry.dispose(),this.material&&this.material.dispose()}}function Xt(r,e){let t=.5,i=.025,o=.75;if(e.seeds){const n=e.seeds.shape_seed||e.seeds.planet_seed,d=(l=>{let s=l;return()=>(s=(s*1664525+1013904223)%4294967296,s/4294967296)})(n);t=.05+d()*.3,i=.02+d()*.02,o=.25+d()*.6}const a={radius:r*.999,detail:128,flowSpeed:t,waveAmplitude:i*.4,opacity:o,colorDeep:new h(4147),colorShallow:new h(26333)};return new ut(r,a)}const de={WAVE_HEIGHT:{min:.05,max:.12},WAVE_FREQUENCY:{min:2,max:5},WAVE_SPEED:{min:.2,max:.8},SPECULAR_INTENSITY:{min:2,max:6},TRANSPARENCY:{min:.2,max:.5},TIME_SPEED:{min:.1,max:1}};class di{layerMesh;material;params;layerSystem;startTime;constructor(e,t={}){this.layerSystem=e;const i=t.seed||Math.floor(Math.random()*1e6),o=new F(i);this.startTime=t.startTime||i%1e4/1e3;const a=t.waterColor instanceof h?t.waterColor:t.waterColor?new h(t.waterColor):new h(3050379),n=t.deepWaterColor instanceof h?t.deepWaterColor:t.deepWaterColor?new h(t.deepWaterColor):new h(13158),c=t.foamColor instanceof h?t.foamColor:t.foamColor?new h(t.foamColor):new h(16777215);this.params={waterColor:a,deepWaterColor:n,foamColor:c,waveHeight:t.waveHeight||o.uniform(de.WAVE_HEIGHT.min,de.WAVE_HEIGHT.max),waveFrequency:t.waveFrequency||o.uniform(de.WAVE_FREQUENCY.min,de.WAVE_FREQUENCY.max),waveSpeed:t.waveSpeed||o.uniform(de.WAVE_SPEED.min,de.WAVE_SPEED.max),secondaryWaveHeight:t.secondaryWaveHeight||o.uniform(de.WAVE_HEIGHT.min*.6,de.WAVE_HEIGHT.max*.6),secondaryWaveFrequency:t.secondaryWaveFrequency||o.uniform(de.WAVE_FREQUENCY.min*1.2,de.WAVE_FREQUENCY.max*1.2),secondaryWaveSpeed:t.secondaryWaveSpeed||o.uniform(de.WAVE_SPEED.min*1.1,de.WAVE_SPEED.max*1.1),distortionScale:t.distortionScale||3,distortionSpeed:t.distortionSpeed||.5,specularIntensity:t.specularIntensity||o.uniform(de.SPECULAR_INTENSITY.min,de.SPECULAR_INTENSITY.max),reflectivity:t.reflectivity||.3,transparency:t.transparency||o.uniform(de.TRANSPARENCY.min,de.TRANSPARENCY.max),roughness:t.roughness||.1,metalness:t.metalness||.2,normalScale:t.normalScale||.05,normalSpeed:t.normalSpeed||.5,seed:i,startTime:this.startTime,timeSpeed:t.timeSpeed||o.uniform(de.TIME_SPEED.min,de.TIME_SPEED.max)},this.material=this.layerSystem.createAquiferWaterLayerMaterial(this.params),this.layerMesh=this.layerSystem.addEffectLayer("aquiferWater",this.material,this.layerSystem.getNextScaleFactor(),this)}update(e){const i=(this.startTime+Date.now()/1e3*this.params.timeSpeed)%1e3;this.material.uniforms.time&&(this.material.uniforms.time.value=i)}dispose(){}}function Kt(r,e,t){const i=e.planet_info||{},o=i.base_color?typeof i.base_color=="string"?new h(i.base_color):new h().fromArray(i.base_color):new h(4886754),a={h:0,s:0,l:0};o.getHSL(a);const n=new h().setHSL(a.h,Math.min(1,a.s*1.2),Math.min(1,a.l*.8)),c=new h().setHSL(a.h,Math.min(1,a.s*1.3),Math.max(0,a.l*.4)),d=12345,l=new F(d+5e3),s={waterColor:n,deepWaterColor:c,foamColor:new h(.9,.95,1),specularIntensity:l.uniform(de.SPECULAR_INTENSITY.min,de.SPECULAR_INTENSITY.max),reflectivity:.3,transparency:l.uniform(de.TRANSPARENCY.min,de.TRANSPARENCY.max),roughness:.05,metalness:.1,normalScale:.02,normalSpeed:.6,seed:d};return new di(r,s)}const ne={CURRENT_INTENSITY:{min:.3,max:.8},CURRENT_SCALE:{min:1,max:3},CURRENT_SPEED:{min:.1,max:.4},OPACITY:{min:.15,max:.35},TIME_SPEED:{min:.05,max:.2}};class Eo{layerMesh;material;params;layerSystem;startTime;constructor(e,t={}){this.layerSystem=e;const i=t.seed||Math.floor(Math.random()*1e6),o=new F(i);this.startTime=t.startTime||i%1e4/1e3;const a=t.currentColor instanceof h?t.currentColor:t.currentColor?new h(t.currentColor):new h(4889486),n=t.deepCurrentColor instanceof h?t.deepCurrentColor:t.deepCurrentColor?new h(t.deepCurrentColor):new h(2973010);this.params={currentColor:a,deepCurrentColor:n,currentIntensity:t.currentIntensity||o.uniform(ne.CURRENT_INTENSITY.min,ne.CURRENT_INTENSITY.max),currentScale:t.currentScale||o.uniform(ne.CURRENT_SCALE.min,ne.CURRENT_SCALE.max),currentSpeed:t.currentSpeed||o.uniform(ne.CURRENT_SPEED.min,ne.CURRENT_SPEED.max),secondaryCurrentIntensity:t.secondaryCurrentIntensity||o.uniform(ne.CURRENT_INTENSITY.min*.6,ne.CURRENT_INTENSITY.max*.6),secondaryCurrentScale:t.secondaryCurrentScale||o.uniform(ne.CURRENT_SCALE.min*1.5,ne.CURRENT_SCALE.max*1.5),secondaryCurrentSpeed:t.secondaryCurrentSpeed||o.uniform(ne.CURRENT_SPEED.min*.7,ne.CURRENT_SPEED.max*.7),opacity:t.opacity||o.uniform(ne.OPACITY.min,ne.OPACITY.max),transparency:t.transparency||.8,seed:i,startTime:this.startTime,timeSpeed:t.timeSpeed||o.uniform(ne.TIME_SPEED.min,ne.TIME_SPEED.max)},this.material=this.layerSystem.createOceanCurrentsLayerMaterial(this.params),this.layerMesh=this.layerSystem.addEffectLayer("oceanCurrents",this.material,this.layerSystem.getNextScaleFactor(),this)}update(e){const i=(this.startTime+Date.now()/1e3*this.params.timeSpeed)%2e3;this.material.uniforms.time&&(this.material.uniforms.time.value=i)}dispose(){}}function wo(r,e,t){e.planet_info;const i=e.surface_elements||{},o=12345,a=new F(o+6e3);let n=new h(4889486),c=new h(2973010);i.ocean_currents&&i.ocean_currents.current_color&&(n=new h().fromArray(i.ocean_currents.current_color)),i.ocean_currents&&i.ocean_currents.deep_current_color&&(c=new h().fromArray(i.ocean_currents.deep_current_color));const d={currentColor:n,deepCurrentColor:c,currentIntensity:i.ocean_currents?.intensity||a.uniform(ne.CURRENT_INTENSITY.min,ne.CURRENT_INTENSITY.max),currentScale:i.ocean_currents?.scale||a.uniform(ne.CURRENT_SCALE.min,ne.CURRENT_SCALE.max),currentSpeed:i.ocean_currents?.speed||a.uniform(ne.CURRENT_SPEED.min,ne.CURRENT_SPEED.max),opacity:i.ocean_currents?.opacity||a.uniform(ne.OPACITY.min,ne.OPACITY.max),transparency:.8,seed:o};return new Eo(r,d)}class mi{sunLine=null;rotationLine=null;debugGroup;params;planetRadius;constructor(e,t={}){this.planetRadius=e,this.params={showSunLine:!0,showRotationLine:!0,showRotationInfo:!0,showTimeInfo:!0,planetRadius:e,...t},this.debugGroup=new Fe,this.createDebugElements()}createDebugElements(){this.params.showSunLine&&this.createSunLine(),this.params.showRotationLine&&this.createRotationLine()}createSunLine(){const e=this.calculateSunAngle(),t=this.planetRadius*3,i=e,o=t*Math.cos(i),a=t*Math.sin(i),n=a*.8,c=new Te,d=new Float32Array([0,0,0,o,n,a]);c.setAttribute("position",new ie(d,3));const l=new st({color:16776960,linewidth:5,transparent:!1});this.sunLine=new nt(c,l),this.debugGroup.add(this.sunLine);const s=e+Math.PI,u=t*.7,f=u*Math.cos(s),p=0,y=u*Math.sin(s),S=new ft(this.planetRadius*.15,16,16),_=new oi({color:16776960,transparent:!1,opacity:1}),v=new be(S,_);v.position.set(f,p,y),this.debugGroup.add(v),this.createTestSpheres()}createTestSpheres(){}createRotationLine(){const e=this.calculateCurrentRotation(),t=this.planetRadius*25,i=new Te,o=new Float32Array([-t*Math.cos(e),0,-t*Math.sin(e),t*Math.cos(e),0,t*Math.sin(e)]);i.setAttribute("position",new ie(o,3));const a=new st({color:9079434,linewidth:2,transparent:!1});this.rotationLine=new nt(i,a),this.debugGroup.add(this.rotationLine)}calculateSunAngle(){return this.params.sunAngle!==void 0?this.params.sunAngle:this.params.orbitalAngle||0}calculateCurrentRotation(){const e=this.params.currentTime||Date.now()/1e3,t=this.params.cosmicOriginTime||e-3600,i=this.params.rotationPeriod||86400,o=this.params.initialAngleRotation||0,a=e-t,n=2*Math.PI/i;return(o+a*n)%(2*Math.PI)}update(e,t){t&&(this.params={...this.params,...t}),this.sunLine&&this.params.showSunLine&&this.updateSunLine(),this.rotationLine&&this.params.showRotationLine&&this.updateRotationLine()}updateSunLine(){if(!this.sunLine)return;const t=this.calculateSunAngle(),i=this.planetRadius*20,o=this.sunLine.geometry,a=o.attributes.position.array;a[3]=i*Math.cos(t),a[4]=0,a[5]=i*Math.sin(t),o.attributes.position.needsUpdate=!0}updateRotationLine(){if(!this.rotationLine)return;const e=this.calculateCurrentRotation(),t=this.planetRadius*25,i=this.rotationLine.geometry,o=i.attributes.position.array;o[0]=-t*Math.cos(e),o[1]=0,o[2]=-t*Math.sin(e),o[3]=t*Math.cos(e),o[4]=0,o[5]=t*Math.sin(e),i.attributes.position.needsUpdate=!0}addToScene(e,t){t&&this.debugGroup.position.copy(t),e.add(this.debugGroup)}getDebugInfo(){const e=this.calculateCurrentRotation(),t=this.calculateSunAngle();return{"Current Time":new Date().toISOString(),"Planet Rotation":`${(e*180/Math.PI).toFixed(2)}°`,"Sun Angle":`${(t*180/Math.PI).toFixed(2)}°`,"Rotation Period":`${this.params.rotationPeriod}s`,"Cosmic Origin":new Date((this.params.cosmicOriginTime||0)*1e3).toISOString()}}toggleSunLine(e){this.sunLine&&(this.sunLine.visible=e)}toggleRotationLine(e){this.rotationLine&&(this.rotationLine.visible=e)}getObject3D(){return this.debugGroup}dispose(){this.debugGroup.clear(),this.sunLine&&(this.sunLine.geometry.dispose(),this.sunLine.material.dispose()),this.rotationLine&&(this.rotationLine.geometry.dispose(),this.rotationLine.material.dispose())}}function Co(r,e){const t={currentTime:Date.now()/1e3,cosmicOriginTime:r.debug?.cosmic_origin_time||r.timing?.cosmic_origin_time||r.cosmicOriginTime,rotationPeriod:r.planet_info?.rotation_period||r.rotation_period_seconds||86400,initialAngleRotation:r.debug?.initial_angle_rotation||r.timing?.initial_angle_rotation||r.initialAngleRotation||0,planetRadius:e,orbitalAngle:r.timing?.orbital_angle||0,sunAngle:r.sun_angle||r.lighting?.sun_angle,showSunLine:!0,showRotationLine:!0,showRotationInfo:!0,showTimeInfo:!0};return new mi(e,t)}const To=!1;class Ze{static instance;creators=new Map;effects=new Map;nextId=1;layerSystem;constructor(){this.registerDefaultEffects()}static getInstance(){return Ze.instance||(Ze.instance=new Ze),Ze.instance}registerDefaultEffects(){this.registerEffect("atmosphere_glow",{create:(e,t)=>new lt(t,e),fromPythonData:(e,t)=>Wt(t,e.atmosphere||{})}),this.registerEffect("atmosphere_clouds",{create:(e,t)=>new Qe(t,e),fromPythonData:(e,t)=>We(t,e.surface_elements||{})}),this.registerEffect("atmospheric_streaks",{create:(e,t)=>new ci(t,e),fromPythonData:(e,t)=>Zt(t,e.atmosphere||{})}),this.registerEffect("atmosphere",{create:(e,t)=>new rt(t,e),fromPythonData:(e,t)=>ao(t,e)}),this.registerEffect("ring_system",{create:(e,t)=>new si(t,e),fromPythonData:(e,t)=>oo(e.rings||{},t)}),this.registerEffect("fragmentation",{create:(e,t)=>new qt(t,e),fromPythonData:(e,t)=>new qt(t,{color:e.surface?.fragment_color||[.3,.3,.3],fragmentCount:e.surface?.fragment_count||20})}),this.registerEffect("land_masses",{create:(e,t)=>new Lt(t,e),fromPythonData:(e,t)=>xt(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("ocean_waves",{create:(e,t)=>new ht(e),fromPythonData:(e,t)=>_o(e)}),this.registerEffect("aquifer_water",{create:(e,t,i)=>new di(i,e),fromPythonData:(e,t,i)=>Kt(i,e)}),this.registerEffect("fluid_layers",{create:(e,t)=>new ut(t,e),fromPythonData:(e,t)=>Xt(t,e)}),this.registerEffect("lava_flows",{create:(e,t)=>(console.warn("Lava flows effect not implemented yet"),null)}),this.registerEffect("crystal_formations",{create:(e,t)=>(console.warn("Crystal formations effect not implemented yet"),null)}),this.registerEffect("star_field",{create:(e,t)=>new mt(t,e),fromPythonData:(e,t)=>yo(t,e.seeds?.planet_seed||e.planet_seed)}),this.registerEffect("tundra_snowflakes",{create:(e,t)=>new ni(t,e),fromPythonData:(e,t)=>Bt(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("anomaly_phase_matter",{create:(e,t)=>new ct(t,e),fromPythonData:(e,t)=>ro(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("pulsating_cube",{create:(e,t)=>new ri(t,e),fromPythonData:(e,t)=>{const i=$e(e);return lo(t,e.surface_elements||{},e.seeds?.planet_seed,i,e)}}),this.registerEffect("planet_rays",{create:(e,t)=>new li(t,e),fromPythonData:(e,t)=>co(t,e.surface_elements||{},e.seeds?.planet_seed)}),this.registerEffect("visual_debug_3d",{create:(e,t)=>new mi(t,e),fromPythonData:(e,t)=>Co(e,t)})}registerEffect(e,t){this.creators.set(e,t)}createEffect(e,t,i,o,a=0){const n=this.creators.get(e);if(!n)return console.warn(`Effect type '${e}' not registered`),null;try{const c=n.create(t,i,o);if(!c)return null;const d={id:`effect_${this.nextId++}`,type:e,effect:c,priority:a,enabled:!0};return this.effects.set(d.id,d),d}catch(c){return console.error(`Error creating effect '${e}':`,c),null}}createEffectFromPythonData(e,t,i,o,a=0){const n=this.creators.get(e);if(!n||!n.fromPythonData)return this.createEffect(e,t,i,o,a);try{const c=n.fromPythonData(t,i,o);if(!c)return null;const d={id:`effect_${this.nextId++}`,type:e,effect:c,priority:a,enabled:!0};return this.effects.set(d.id,d),d}catch(c){return console.error(`Error creating effect '${e}' from Python data:`,c),null}}createEffectsFromList(e,t,i){const o=[],a=e.sort((n,c)=>(n.priority||0)-(c.priority||0));for(const n of a){const c=this.createEffect(n.type,n.params,t,i,n.priority);c&&(c.enabled=n.enabled!==!1,o.push(c))}return o}createEffectsFromPythonPlanetData(e,t,i,o,a){const n=[];try{const c=$e(e);if(a?this.layerSystem=a:this.layerSystem=new dt(i,c),e.surface_elements){const s=e.surface_elements;if(s.effects_3d&&Array.isArray(s.effects_3d))for(const u of s.effects_3d){if(u.type==="atmospheric_streaks"){const p=Zt(t,u.params,e.seeds?.shape_seed+3e3),y={id:`effect_${this.nextId++}`,type:"atmospheric_streaks",effect:p,priority:u.priority||0,enabled:!0,name:"Atmospheric Streaks"};this.effects.set(y.id,y),n.push(y),p.addToScene(o,i.position);continue}const f=this.createEffect(u.type,u.params,t,i,u.priority||0);f?(f.name=u.type.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase()),n.push(f),f.effect.apply&&f.effect.apply(i),f.effect.addToScene&&f.effect.addToScene(o,i.position)):console.error("❌ FALLO AL CREAR EFECTO:",u.type)}switch(console.log(`🔍 Planet surface type: "${s.type}"`),console.log(`🔍 Planet info type: "${e.planet_info?.type}"`),s.type.toLowerCase()){case"gas_giant":if(this.layerSystem){const g=Ht(this.layerSystem,{...s,base_color:c,turbulence:e.turbulence||s.turbulence},e.seeds?.shape_seed||e.seeds?.planet_seed||e.seeds?.planet_seed),b=$t(this.layerSystem,{...s,base_color:c,storm_intensity:e.storm_intensity||s.storm_intensity},(e.seeds?.shape_seed||e.seeds?.planet_seed)+1e3),P={id:`effect_${this.nextId++}`,type:"cloud_bands_layer",effect:g,priority:0,enabled:!0};this.effects.set(P.id,P),n.push(P);const I={id:`effect_${this.nextId++}`,type:"cloud_gyros_layer",effect:b,priority:1,enabled:!0};if(this.effects.set(I.id,I),n.push(I),s.polar_hexagon&&s.polar_hexagon.enabled){const M=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,L=new Tt({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:M}),j={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:L,priority:10,enabled:!0};this.effects.set(j.id,j),n.push(j),o&&L.addToScene(o)}}else console.error("❌ PlanetLayerSystem not initialized!");break;case"frozen_gas_giant":if(this.layerSystem){const g=Ht(this.layerSystem,{...s,base_color:c,turbulence:e.turbulence||s.turbulence,icy_tint:!0},e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"cloud_bands_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.polar_hexagon&&s.polar_hexagon.enabled){const P=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,I=new Tt({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:P}),M={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:I,priority:10,enabled:!0};this.effects.set(M.id,M),n.push(M),o&&I.addToScene(o)}}break;case"aquifer":console.log("🌊 Processing Aquifer planet with surface data:",s),console.log("🌊 Surface.clouds:",s.clouds);const u=Kt(this.layerSystem,e);if(u){const g={id:`effect_${this.nextId++}`,type:"aquifer_water",effect:u,priority:2,enabled:!0,name:"Aquifer Water Surface"};this.effects.set(g.id,g),n.push(g),console.log("🌊 AquiferWater effect added for aquifer planet")}const f=wo(this.layerSystem,e);if(f){const g={id:`effect_${this.nextId++}`,type:"ocean_currents",effect:f,priority:1,enabled:!0,name:"Ocean Currents"};this.effects.set(g.id,g),n.push(g),console.log("🌊 Ocean Currents effect added for aquifer planet")}if(s.clouds&&s.clouds.length>0){const g=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("☁️ Atmospheric Clouds added to Aquifer planet")}if(s.land_masses&&s.land_masses.length>0){const g=xt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+7e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:3,enabled:!0,name:"Emergent Land Masses"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}if(s.atmosphere_clouds&&s.atmosphere_clouds.length>0){const g=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+8e3);if(g){const b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:4,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}break;case"nebulous":if(this.layerSystem){const g=$t(this.layerSystem,{...s,base_color:c,storm_intensity:s.nebula_density||.6,color_variance:s.color_variance||.2},(e.seeds?.shape_seed||e.seeds?.planet_seed)+2e3),b={id:`effect_${this.nextId++}`,type:"cloud_gyros_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.polar_hexagon&&s.polar_hexagon.enabled){const P=e.timing?.elapsed_time?e.timing.elapsed_time/31557600:0,I=new Tt({planetColor:c,hexagonData:s.polar_hexagon,planetRadius:t,currentTime:P}),M={id:`effect_${this.nextId++}`,type:"polar_hexagon",effect:I,priority:10,enabled:!0};this.effects.set(M.id,M),n.push(M),o&&I.addToScene(o)}}break;case"metallic":case"metallic_3d":if(this.layerSystem){const g=vo(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"metallic_surface_layer",effect:g,priority:0,enabled:!0};this.effects.set(b.id,b),n.push(b)}break;case"rocky":if(this.layerSystem){const g=uo(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"rocky_terrain_layer",effect:g,priority:0,enabled:!0};if(this.effects.set(b.id,b),n.push(b),s.clouds&&s.clouds.length>0){const P=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),I={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:P,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(I.id,I),n.push(I),P.addToScene(o,i.position)}}break;case"icy":if(this.layerSystem){const g=po(this.layerSystem,e,e.seeds?.shape_seed||e.seeds?.planet_seed),b={id:`effect_${this.nextId++}`,type:"icy_terrain_layer",effect:g,priority:0,enabled:!0};this.effects.set(b.id,b),n.push(b);const P=so(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+8e3);if(P){const M={id:`effect_${this.nextId++}`,type:"transparent_land_masses",effect:P,priority:1,enabled:!0,name:"Ice Formations"};this.effects.set(M.id,M),n.push(M),P.addToScene(o,i.position),console.log("🧊 Ice Formations (transparent LandMasses) added to Icy planet")}else console.warn("❄️ Failed to create transparent LandMasses for Icy planet");if(s.clouds&&s.clouds.length>0){const M=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),L={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:M,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(L.id,L),n.push(L),M.addToScene(o,i.position),console.log("☁️ Atmospheric Clouds added to Icy planet")}const I=Gt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+9e3);if(I){const M={id:`effect_${this.nextId++}`,type:"icy_features",effect:I,priority:2,enabled:!0,name:"Ice Crystals & Features"};this.effects.set(M.id,M),n.push(M),I.addToScene(o,i.position),console.log("❄️ Icy Features (crystals, cracks, ice caps) added to Icy planet")}}break;case"oceanic":const p=Xt(t,e);if(p){const g={id:`effect_${this.nextId++}`,type:"fluid_layers",effect:p,priority:3,enabled:!0,name:"Fluid Ocean Layers"};this.effects.set(g.id,g),n.push(g),p.addToScene(o,i.position),console.log("🌊 FluidLayers effect added for oceanic planet")}if(s.green_patches&&s.green_patches.length>0){const g=xt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+6e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:5,enabled:!0,name:"Land Masses (Islands)"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}}if(s.clouds&&s.clouds.length>0){const g=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position)}break;case"tundra":if(s.green_patches&&s.green_patches.length>0){const g=xt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+6e3);if(g){const b={id:`effect_${this.nextId++}`,type:"land_masses",effect:g,priority:5,enabled:!0,name:"Tundra Terrain"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("🏔️ Tundra terrain (LandMasses) added")}}const y=Gt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+9e3);if(y){const g={id:`effect_${this.nextId++}`,type:"icy_features",effect:y,priority:6,enabled:!0,name:"Snow Patches & Ice"};this.effects.set(g.id,g),n.push(g),y.addToScene(o,i.position),console.log("❄️ Sparse ice features added to Tundra planet")}if(s.clouds&&s.clouds.length>0){const g=We(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+4e3),b={id:`effect_${this.nextId++}`,type:"atmosphere_clouds",effect:g,priority:15,enabled:!0,name:"Atmospheric Clouds"};this.effects.set(b.id,b),n.push(b),g.addToScene(o,i.position),console.log("☁️ Atmospheric clouds added to Tundra planet")}const S=Bt(t,s,(e.seeds?.shape_seed||e.seeds?.planet_seed)+15e3);if(S){const g={id:`effect_${this.nextId++}`,type:"tundra_snowflakes",effect:S,priority:20,enabled:!0,name:"Snowflakes"};this.effects.set(g.id,g),n.push(g),S.addToScene(o,i.position),console.log("❄️ Tundra snowflakes added to Tundra planet")}break;case"anomaly":console.log("🌌 DETECTED ANOMALY PLANET - Creating effects"),console.log("🌌 Planet data:",{surfaceType:s.type,planetType:e.planet_info?.type}),console.log("🎭 SHOWCASE MODE: Activating ALL anomaly effects for evaluation");const v=["anomaly_phase_matter","pulsating_cube","planet_rays"],x=e.seeds?.planet_seed||Math.floor(Math.random()*1e6),A=v.length;for(let g=0;g<A;g++){const b=v[g],P=x+g*1e4,I=this.createEffectFromPythonData(b,{...e,seeds:{...e.seeds,planet_seed:P}},t,i,10+g);I&&(I.name=b.replace(/_/g," ").replace(/\b\w/g,M=>M.toUpperCase()),n.push(I),I.effect.addToScene&&I.effect.addToScene(o,i.position),console.log(`🎭 Added anomaly effect: ${I.name}`))}if(e.atmosphere&&e.atmosphere.type!=="None"){const g=this.createEffectFromPythonData("atmosphere",e.atmosphere,t,i,5);g&&(n.push(g),g.effect.addToScene(o,i.position),console.log("🌫️ Anomalous atmosphere added"))}break;default:if(e.planet_info?.type?.toLowerCase()==="anomaly"){console.log("🌌 DETECTED ANOMALY PLANET via planet_info.type - Creating effects"),console.log("🎭 SHOWCASE MODE (alt detection): Activating ALL anomaly effects for evaluation");const b=["anomaly_phase_matter","pulsating_cube","planet_rays"],P=e.seeds?.planet_seed||Math.floor(Math.random()*1e6),I=b.length;for(let M=0;M<I;M++){const L=b[M],j=P+M*1e4,w=this.createEffectFromPythonData(L,{...e,seeds:{...e.seeds,planet_seed:j}},t,i,10+M);w&&(w.name=L.replace(/_/g," ").replace(/\b\w/g,V=>V.toUpperCase()),n.push(w),w.effect.addToScene&&w.effect.addToScene(o,i.position),console.log(`🎭 Added anomaly effect: ${w.name}`))}if(e.atmosphere&&e.atmosphere.type!=="None"){const M=this.createEffectFromPythonData("atmosphere",e.atmosphere,t,i,5);M&&(n.push(M),M.effect.addToScene(o,i.position),console.log("🌫️ Anomalous atmosphere added"))}}else if(i.material instanceof Ke){const g=$e(e);i.material.color.copy(g)}break}}else if(i.material instanceof Ke){const s=$e(e);i.material.color.copy(s)}const d=e.planet_info?.type?.toLowerCase()||e.surface_elements?.type?.toLowerCase(),l=d==="anomaly"||e.surface_elements?.type==="anomaly";if(e.atmosphere&&!l){if(e.atmosphere.streaks||["Gas Giant","Frozen Gas Giant"].includes(e.planet_info?.type)){const s=Wt(t,e.atmosphere||{},e.seeds?.shape_seed+2e3);if(s){const u={id:`effect_${this.nextId++}`,type:"atmosphere_glow",effect:s,priority:20,enabled:!0};this.effects.set(u.id,u),n.push(u),s.addToScene(o,i.position)}}if(e.atmosphere.type&&e.atmosphere.type!=="None"){const s={...e.atmosphere};d==="oceanic"&&(s.opacity=Math.min(s.opacity||.3,.15),s.width=Math.min(s.width||15,8));const u=this.createEffectFromPythonData("atmosphere",s,t,i,5);u&&(n.push(u),u.effect.addToScene(o,i.position))}}if(e.rings&&e.rings.has_rings||["Gas Giant","Frozen Gas Giant","Super Earth"].includes(e.planet_info?.type)){const s=this.createEffectFromPythonData("ring_system",e,t,i,1);s?(n.push(s),s.effect.addToScene(o,i.position)):console.warn("⚠️ Failed to create ring effect")}if(e.surface_elements?.has_fragmentation_zones){const s=this.createEffectFromPythonData("fragmentation",e,t,i,5);s&&(n.push(s),s.effect.addToScene(o,i.position))}this.layerSystem&&this.layerSystem.addToScene(o);try{const s=this.createEffectFromPythonData("star_field",e,t,i,-100);s&&s.effect&&(s.effect.addToScene(o,i.position),n.push(s),console.log("⭐ StarField added automatically using planet seed:",e.seeds?.planet_seed))}catch(s){console.warn("Could not create StarField:",s)}return n.forEach((s,u)=>{}),n.length===0&&console.warn("⚠️ NO EFFECTS WERE CREATED! Check the data structure and conditions."),n}catch(c){throw console.error("Error in EffectRegistry.createEffectsFromPythonPlanetData:",c),c}}getEffect(e){return this.effects.get(e)||null}getEffectsByType(e){return Array.from(this.effects.values()).filter(t=>t.type===e)}getAllEffects(){return Array.from(this.effects.values())}toggleEffect(e,t){const i=this.effects.get(e);if(i){i.enabled=t!==void 0?t:!i.enabled;const o=i.effect;if(o&&o.getObject3D){const a=o.getObject3D();a&&(a.visible=i.enabled,console.log(`🎮 Toggle effect ${i.type}: visible = ${i.enabled}`))}if(this.layerSystem){const a=this.layerSystem.getLayerMeshes(),c={cloud_bands_layer:"cloudBands",cloud_gyros_layer:"cloudGyros",metallic_surface_layer:"metallicSurface",rocky_terrain_layer:"rockyTerrain",icy_terrain_layer:"icyTerrain",aquifer_water:"aquiferWater",ocean_currents:"oceanCurrents"}[i.type];c&&a[c]&&(a[c].visible=i.enabled)}}else console.warn(`⚠️ Effect not found: ${e}`)}updateAllEffects(e,t){this.layerSystem&&this.layerSystem.update(e,t);for(const i of this.effects.values())if(i.enabled&&i.effect.update)try{i.effect.update(e,t)}catch(o){console.error(`Error updating effect ${i.type}:`,o)}}updateLightForAllEffects(e){console.log("🔆 updateLightForAllEffects called with light position:",e.position),this.layerSystem&&this.layerSystem.updateFromThreeLight(e),console.log("🔆 Checking",this.effects.size,"effects for light updates");for(const t of this.effects.values())if(console.log(`🔆 Effect ${t.type}, enabled: ${t.enabled}, hasUpdateFromThreeLight: ${!!t.effect.updateFromThreeLight}`),t.enabled&&t.effect.updateFromThreeLight)try{console.log(`🔆 Updating light for effect: ${t.type}`),t.effect.updateFromThreeLight(e)}catch(i){console.error(`Error updating light for effect ${t.type}:`,i)}}removeEffect(e){const t=this.effects.get(e);t&&(t.effect.dispose&&t.effect.dispose(),this.effects.delete(e))}clearAllEffects(){this.layerSystem&&(this.layerSystem.dispose(),this.layerSystem=void 0);for(const e of this.effects.values())e.effect.dispose&&e.effect.dispose();this.effects.clear(),this.nextId=1}getStats(){const e=Array.from(this.effects.values());return{registeredTypes:this.creators.size,activeEffects:e.length,enabledEffects:e.filter(t=>t.enabled).length}}getAvailableEffectTypes(){return Array.from(this.creators.keys())}}const Oe=Ze.getInstance(),Be={atmosphere:{type:"Thin",width:12,opacity:.2,density:1},cloud_bands:{numBands:8,animationSpeed:1,turbulence:.5},cloud_gyros:{stormIntensity:.8,spiralSpeed:2,animationSpeed:1},atmosphere_glow:{particleCount:500,speed:.4,size:1,opacity:1}};function Mo(r){const e=[];switch(r.toLowerCase()){case"metallic":e.push({type:"atmosphere",params:{...Be.atmosphere,color:[.6,.1,.9,.2]},priority:10},{type:"atmospheric_streaks",params:{color:[.95,.95,1],particleCount:100},priority:20});break;case"gas giant":e.push({type:"cloud_bands",params:Be.cloud_bands,priority:0},{type:"cloud_gyros",params:Be.cloud_gyros,priority:1},{type:"atmosphere",params:{...Be.atmosphere,color:[1,.6,.2,.2]},priority:10},{type:"atmosphere_glow",params:Be.atmosphere_glow,priority:20});break;case"icy":e.push({type:"atmosphere",params:{...Be.atmosphere,color:[.5,.8,1,.15]},priority:10});break;default:e.push({type:"atmosphere",params:{color:[.5,.5,.8,.15]},priority:10});break}return e}const Re={log:(r,e)=>{},warn:(r,e)=>{console.warn(`[Effects] ${r}`,e||"")},error:(r,e)=>{console.error(`[Effects] ${r}`,e||"")},debug:(r,e)=>{}};new Date().toISOString();const Po=({planetData:r,showInConsole:e=!0,showInPage:t=!1})=>{const[i,o]=N.useState([]),[a,n]=N.useState({});N.useEffect(()=>{if(!r)return;const l=c(r);n(l),o(d(r)),typeof window<"u"&&(window.__DEBUG_PLANET_DATA=r,window.__DEBUG_PLANET_ANALYSIS=l)},[r,e]);function c(l){const s={hasValidStructure:!1,missingFields:[],dataIntegrity:"unknown",renderingIssues:[],colorConsistency:"unknown"};if(l.planet_info&&l.surface_elements?s.hasValidStructure=!0:(l.planet_info||s.missingFields.push("planet_info"),l.surface_elements||s.missingFields.push("surface_elements")),l.surface_elements?.type==="oceanic"&&(s.oceanicData={hasAbstractLands:!!l.surface_elements.abstract_lands?.length,numGreenPatches:l.surface_elements.green_patches?.length||0,numClouds:l.surface_elements.clouds?.length||0,hasDepths:l.surface_elements.depths?.enabled||!1,baseColorIsBlue:l.planet_info?.base_color==="#0000FF",greenPatchColor:l.surface_elements.green_patches?.[0]?.color,issues:[]},s.oceanicData.numGreenPatches>15&&s.oceanicData.issues.push("Muchos parches verdes pueden ocultar el océano azul"),s.oceanicData.baseColorIsBlue||s.oceanicData.issues.push(`Color base no es azul puro: ${l.planet_info?.base_color}`),s.renderingIssues=s.oceanicData.issues),l.planet_info?.base_color&&l.planet_info?.type){const f={Oceanic:"#0000FF",Rocky:"#808080",Icy:"#ADD8E6",Desert:"#FFD700",Lava:"#FF0000"}[l.planet_info.type];f&&l.planet_info.base_color!==f?s.colorConsistency=`Inconsistente: esperado ${f}, recibido ${l.planet_info.base_color}`:s.colorConsistency="Correcto"}return s}function d(l){const s=[];if(!l.surface_elements?.type)return["No surface type defined"];const u=l.surface_elements.type.toLowerCase();switch(u){case"oceanic":s.push("OceanWavesEffect (PROBLEMA: ignora green_patches de Python)");break;case"rocky":s.push("RockyTerrainEffect");break;case"icy":s.push("IcyTerrainEffect");break;case"gas giant":s.push("GasGiantBandsEffect");break;default:s.push(`Generic effect for type: ${u}`)}return l.atmosphere?.density>0&&s.push("AtmosphericEffect"),l.rings&&s.push("RingSystemEffect"),s}return t?m.jsxs("div",{style:{position:"fixed",top:10,right:10,background:"rgba(0, 0, 0, 0.9)",color:"#00ff00",padding:"10px",borderRadius:"5px",fontFamily:"monospace",fontSize:"12px",maxWidth:"400px",maxHeight:"600px",overflow:"auto",zIndex:1e4,border:"1px solid #00ff00"},children:[m.jsxs("h3",{style:{margin:"0 0 10px 0",color:"#00ff00"},children:["🔍 Planet Debug: ",r.planet_info?.name]}),m.jsxs("div",{style:{marginBottom:"10px"},children:[m.jsx("strong",{children:"Type:"})," ",r.planet_info?.type,m.jsx("br",{}),m.jsx("strong",{children:"Base Color:"})," ",r.planet_info?.base_color,m.jsx("br",{}),m.jsx("strong",{children:"Radius:"})," ",r.planet_info?.radius]}),r.surface_elements?.type==="oceanic"&&m.jsxs("div",{style:{marginBottom:"10px",borderTop:"1px solid #00ff00",paddingTop:"10px"},children:[m.jsx("strong",{children:"🌊 Oceanic Data:"}),m.jsx("br",{}),m.jsxs("span",{style:{color:a.oceanicData?.baseColorIsBlue?"#00ff00":"#ff0000"},children:["Base Color: ",a.oceanicData?.baseColorIsBlue?"✓ Blue":"✗ Not Blue"]}),m.jsx("br",{}),"Green Patches: ",a.oceanicData?.numGreenPatches,m.jsx("br",{}),"Clouds: ",a.oceanicData?.numClouds,m.jsx("br",{}),"Has Depths: ",a.oceanicData?.hasDepths?"Yes":"No",m.jsx("br",{}),a.oceanicData?.issues?.length>0&&m.jsxs("div",{style:{color:"#ffaa00",marginTop:"5px"},children:["⚠️ Issues:",m.jsx("br",{}),a.oceanicData.issues.map((l,s)=>m.jsxs("div",{children:["- ",l]},s))]})]}),m.jsxs("div",{style:{borderTop:"1px solid #00ff00",paddingTop:"10px"},children:[m.jsx("strong",{children:"🎨 Effects Applied:"}),m.jsx("br",{}),i.map((l,s)=>m.jsxs("div",{style:{color:l.includes("PROBLEMA")?"#ff0000":"#00ff00"},children:["- ",l]},s))]}),m.jsx("button",{style:{marginTop:"10px",background:"#00ff00",color:"#000",border:"none",padding:"5px 10px",cursor:"pointer",borderRadius:"3px"},children:"Log to Console"})]}):null};function Io(r){N.useEffect(()=>{if(r&&r.surface_elements?.type==="oceanic"){r.surface_elements.green_patches?.length>0;const e=r.planet_info?.base_color;e!=="#0000FF"&&console.warn("⚠️ Planeta oceánico sin color azul base!",e)}},[r])}const bt=2.5,Qt=()=>{const r=45*Math.PI/180;return bt/(Math.tan(r/2)*.5)},No=({planetName:r,containerClassName:e="",width:t=800,height:i=600,autoRotate:o=!0,enableControls:a=!0,showDebugInfo:n=!1,planetData:c,cosmicOriginTime:d,initialAngleRotation:l,onDataLoaded:s,onEffectsCreated:u,onError:f})=>{const p=N.useRef(null),y=N.useRef(null),S=N.useRef(null),_=N.useRef(null),v=N.useRef(null),x=N.useRef(null),A=N.useRef(new Di),g=N.useRef(null),b=N.useRef(0),P=N.useRef(null),[I,M]=N.useState(!0),[L,j]=N.useState(null),[w,V]=N.useState(null),[Y,G]=N.useState([]),[te,Z]=N.useState({activeEffects:0,enabledEffects:0,frameRate:0,renderTime:0}),K=N.useRef([]),D=N.useRef(0),k=N.useRef(null),z=N.useRef(null),q=Math.floor(Date.now()/1e3),[oe,ge]=N.useState(0),ae=d||w?.timing?.cosmic_origin_time||Date.now()/1e3-3600,ve=q-ae+oe;b.current=ve;const xe=N.useCallback(()=>{if(!p.current||!S.current||!_.current)return;const E=p.current,R=E.clientWidth||400,C=E.clientHeight||400;S.current.setSize(R,C),_.current.aspect=R/C,_.current.updateProjectionMatrix()},[]),we=async E=>{if(!(!v.current||!y.current||!z.current)){Re.log("Applying modular effects from API data",{planet:E.planet_info.name,type:E.planet_info.type});try{Ae();const R=$e(E);z.current.updateBaseColor(R);const C=Oe.createEffectsFromPythonPlanetData(E,bt,v.current,y.current,z.current);console.log(`Planet: ${E.planet_info?.name}, Effects:`,C.map(O=>O.type)),G(C),K.current=C,u&&u(C),Re.log(`Successfully applied ${C.length} modular effects`),it()}catch(R){Re.error("Error applying modular effects",R),Ge()}}},Se=N.useCallback(()=>{if(!p.current)return!1;try{for(;p.current.firstChild;)p.current.removeChild(p.current.firstChild);y.current=null,_.current=null,S.current=null,v.current=null,ce.current=null;const E=p.current,R=E.clientWidth||t||400,C=E.clientHeight||i||400,O=new Li;O.background=new h(1297),y.current=O;const se=new Oi(45,R/C,.1,1e4),X=Qt();se.position.set(0,0,X),se.lookAt(0,0,0),_.current=se;const W=new zi({antialias:!0,alpha:!0,powerPreference:"high-performance"});return W.setSize(R,C),W.setPixelRatio(Math.min(window.devicePixelRatio,2)),W.shadowMap.enabled=!0,W.shadowMap.type=Fi,W.toneMapping=ji,W.toneMappingExposure=1.2,W.outputColorSpace=ki,p.current.appendChild(W.domElement),S.current=W,et(O,null),tt(O),a&&pt(se,W.domElement),!0}catch(E){return console.error("Error initializing Three.js:",E),!1}},[w,c,d]),Ie=E=>{if(!E)return 0;const R=E.sun_angle||E.lighting?.sun_angle;if(R!==void 0)return R;const C=E.timing?.current_orbital_angle||E.timing?.orbital_angle;return C??0},he=N.useRef(null),De=N.useRef(null),Ne=N.useRef(null),ce=N.useRef(null),Le=E=>{E.castShadow=!0,E.shadow.mapSize.width=2048,E.shadow.mapSize.height=2048,E.shadow.camera.near=.5,E.shadow.camera.far=50,E.shadow.camera.left=-10,E.shadow.camera.right=10,E.shadow.camera.top=10,E.shadow.camera.bottom=-10},Ue=E=>{if(!he.current||!y.current)return;const R=Ie(E),C=10,O=R+Math.PI,se=Math.sin(R)*5,X=C*Math.cos(O),W=se,Ye=C*Math.sin(O);he.current.position.set(X,W,Ye),he.current.target.position.set(0,0,0),y.current.children.includes(he.current.target)||y.current.add(he.current.target),De.current&&De.current.position.set(-X*.5,0,-Ye*.5),z.current&&he.current&&z.current.updateFromThreeLight(he.current),he.current&&Oe.updateLightForAllEffects(he.current)},et=(E,R)=>{{const C=new kt(16777215,2);C.position.set(-10,5,10),C.target.position.set(0,0,0),C.castShadow=!0,Le(C),E.add(C),E.add(C.target),he.current=C;const O=new kt(16777215,.05);O.position.set(8,-3,-5),E.add(O),De.current=O;const se=new Ui(2236996,.1);E.add(se),setTimeout(()=>{z.current&&C&&z.current.updateFromThreeLight(C),C&&Oe.updateLightForAllEffects(C)},50);return}},tt=E=>{const R=new ft(bt,128,64),C=new oi({color:8421504}),O=new be(R,C);O.castShadow=!0,O.receiveShadow=!0,O.position.set(0,0,0),E.add(O),v.current=O;const se=new h(8421504);z.current=new dt(O,se),z.current.addToScene(E)},pt=(E,R)=>{const C=new Gi(E,R);C.enableDamping=!0,C.dampingFactor=.05;const O=Qt();C.minDistance=O*.5,C.maxDistance=O*2,C.autoRotate=o,C.autoRotateSpeed=.5,C.enablePan=!0,C.enableZoom=!0,C.target.set(0,0,0),x.current=C},Ve=N.useCallback(async()=>{if(!window.isLoadingPlanetData){window.isLoadingPlanetData=!0;try{M(!0),j(null),Re.log("Loading planet data from API",{planetName:r});const R=await fetch("/api/planet/rendering-data");if(!R.ok)throw new Error(`HTTP error! status: ${R.status}`);const C=await R.json();if(!C.success)throw new Error(C.error||"Failed to fetch planet data");const O=C.planet_data,se=C.timing,X=C.rendering_data,W={planet_info:X?.planet_info||{name:O.name,type:O.planet_type,base_color:"#808080",radius:O.diameter/15e3,orbital_radius:O.orbital_radius},surface_elements:X?.surface_elements,atmosphere:X?.atmosphere,rings:X?.rings,effects_3d:X?.effects_3d,shader_uniforms:X?.shader_uniforms,universal_actions:X?.universal_actions,timing:{cosmic_origin_time:se.cosmic_origin_time,current_time_seconds:se.current_time_seconds,elapsed_time:se.elapsed_time,initial_orbital_angle:O.initial_orbital_angle,current_orbital_angle:O.current_orbital_angle,max_orbital_radius:se.max_orbital_radius,system_max_orbital_radius:O.system_max_orbital_radius},original_planet_data:O,seeds:X?.seeds};return V(W),P.current=W,Re.log("API data loaded successfully",{planet:W.planet_info.name,type:W.planet_info.type,hasEffects:!!W.surface_elements,fullRenderingData:X}),s&&s(W),W}catch(E){const R=E instanceof Error?E.message:"Unknown error";return j(R),f&&f(R),null}finally{M(!1),window.isLoadingPlanetData=!1}}},[r,s,f]);N.useCallback(async()=>{if(!window.isLoadingPlanetData){window.isLoadingPlanetData=!0;try{M(!0),j(null),Re.log("Loading planet data from API",{planetName:r});const R=await fetch("/api/planet/rendering-data");if(!R.ok)throw new Error(`HTTP error! status: ${R.status}`);const C=await R.json();if(!C.success)throw new Error(C.error||"Failed to fetch planet data");const O=C.planet_data,se=C.timing,X=C.rendering_data,W={planet_info:X?.planet_info||{name:O.name,type:O.planet_type,base_color:"#808080",radius:O.diameter/15e3,orbital_radius:O.orbital_radius},surface_elements:X?.surface_elements,atmosphere:X?.atmosphere,rings:X?.rings,effects_3d:X?.effects_3d,shader_uniforms:X?.shader_uniforms,universal_actions:X?.universal_actions,timing:{cosmic_origin_time:se.cosmic_origin_time,current_time_seconds:se.current_time_seconds,elapsed_time:se.elapsed_time,initial_orbital_angle:O.initial_orbital_angle,current_orbital_angle:O.current_orbital_angle,max_orbital_radius:se.max_orbital_radius,system_max_orbital_radius:O.system_max_orbital_radius},original_planet_data:O,seeds:X?.seeds};V(W),P.current=W,Re.log("API data loaded successfully",{planet:W.planet_info.name,type:W.planet_info.type,hasEffects:!!W.surface_elements,fullRenderingData:X}),Ue(W),ce.current&&y.current&&(y.current.remove(ce.current),ce.current.geometry.dispose(),ce.current.material.dispose(),ce.current=null),await we(W),s&&s(W)}catch(E){const R=E instanceof Error?E.message:"Unknown error";j(R),f&&f(R),Ge()}finally{M(!1),window.isLoadingPlanetData=!1}}},[r,c,d,l]);const je=N.useCallback(()=>{if(!w||!v.current)return;const E=c?.orbital_period_seconds||365.25*24*3600,R=2*Math.PI/E,C=w.timing?.initial_orbital_angle||0,O=Date.now()/1e3,se=0,X=d||w.timing?.cosmic_origin_time||Date.now()/1e3-3600,W=O-X+se,Ye=(C+W*R)%(2*Math.PI),wt=w.timing?.max_orbital_radius||100,vt=20+w.planet_info?.orbital_radius/wt*80,hi=vt,ui=vt*Math.cos(Ye),fi=hi*Math.sin(Ye);v.current.position.x=ui,v.current.position.z=fi,v.current.position.y=0},[w,c,d]),Et=N.useCallback(async E=>{const R=E||w;if(R&&y.current)try{Ue(R),ce.current&&y.current&&(y.current.remove(ce.current),ce.current.geometry.dispose(),ce.current.material.dispose(),ce.current=null),await we(R)}catch(C){Re.error("Error in applyProceduralShadersFromAPI:",C),Ge()}},[w]),Ge=()=>{if(!(!y.current||!v.current)){Re.warn("Applying fallback effects for planet type:",c?.planet_type);try{Ae(),v.current.material instanceof Ke&&v.current.material.color.setHex(6710886);try{const E=Mo("generic"),R=Oe.createEffectsFromList(E,bt,v.current);R.forEach(C=>{C.effect.addToScene&&y.current&&v.current&&C.effect.addToScene(y.current,v.current.position)}),K.current=R,G(R)}catch(E){console.warn("Could not create fallback effects, using basic material only:",E)}it()}catch(E){Re.error("Error applying fallback effects",E)}}},Ae=()=>{Oe.clearAllEffects(),K.current.forEach(E=>{try{E.effect.dispose&&E.effect.dispose()}catch{}}),K.current=[],G([])},gt=N.useCallback(()=>{g.current=requestAnimationFrame(gt);const E=performance.now(),R=A.current.getDelta();x.current&&x.current.update();try{Oe.updateAllEffects(R,v.current?.rotation.y)}catch{}if(v.current&&P.current){P.current.planet_info?.name;const C=P.current.original_planet_data,O=C?.orbital_period_seconds||365.25*24*3600,se=P.current.timing?.initial_orbital_angle||0;d||P.current.timing?.cosmic_origin_time||Date.now()/1e3-3600;const X=C?.axial_tilt||0,W=2*Math.PI/O;(se+b.current*W)%(2*Math.PI);const Ye=P.current.timing?.max_orbital_radius||P.current.timing?.system_max_orbital_radius,wt=C?.orbital_radius;if(!Ye||!wt)return;C?.eccentricity_factor,v.current.position.set(0,0,0);const zt=C?.rotation_period_seconds||86400,vt=2*Math.PI/zt;v.current.rotation.y=b.current*vt%(2*Math.PI),v.current.rotation.z=X*(Math.PI/180)}if(K.current.forEach(C=>{C.effect.updateUniforms&&C.effect.updateUniforms(R)}),S.current&&y.current&&_.current){const C=performance.now();S.current.render(y.current,_.current);const O=performance.now()-C;if(E-D.current>5e3){const se=1e3/(E-D.current);it(),Z(X=>({...X,frameRate:Math.round(se),renderTime:Math.round(O*100)/100})),D.current=E}}},[]),it=N.useCallback(()=>{const E=Oe.getStats();Z(R=>({...R,activeEffects:E.activeEffects,enabledEffects:E.enabledEffects}))},[]);return N.useEffect(()=>{let E=!0;return window.tonnirLoggedInPlanet=!1,window.orbitChecked=!1,window.debugOrbitRadius=null,window.debugSystemMaxRadius=null,window.planetNameLogged=!1,window.timingDataLogged=!1,window.isLoadingPlanetData=!1,window.orbitalAngleSourceLogged=!1,window.orbitalAngleDebugged=!1,window.positionDebugged=!1,window.animationLoopDebugged=!1,(async()=>{try{if(!E)return;const C=await Ve();if(!E)return;if(!Se()){E&&j("Failed to initialize 3D renderer");return}if(!E||(gt(),p.current&&"ResizeObserver"in window&&(k.current=new ResizeObserver(xe),k.current.observe(p.current)),window.addEventListener("resize",xe),!E))return;C?await Et(C):Ge()}catch(C){E&&j(C instanceof Error?C.message:"Unknown initialization error")}})(),()=>{if(E=!1,P.current=null,g.current&&cancelAnimationFrame(g.current),k.current&&k.current.disconnect(),window.removeEventListener("resize",xe),Ae(),z.current&&(z.current.dispose(),z.current=null),x.current&&x.current.dispose(),Ne.current&&y.current&&(y.current.remove(Ne.current),Ne.current.geometry.dispose(),Ne.current.material.dispose(),Ne.current=null),ce.current&&y.current&&(y.current.remove(ce.current),ce.current.geometry.dispose(),ce.current.material.dispose(),ce.current=null),S.current&&p.current)try{p.current.contains(S.current.domElement)&&p.current.removeChild(S.current.domElement),S.current.dispose()}catch{}}},[]),N.useEffect(()=>{const E=setInterval(()=>{const R=Oe.getStats();Z(C=>({...C,activeEffects:R.activeEffects,enabledEffects:R.enabledEffects}))},1e4);return()=>clearInterval(E)},[]),N.useEffect(()=>{w&&y.current&&v.current&&je()},[w,je]),Io(w),m.jsxs("div",{className:`relative ${e}`,children:[n&&w&&m.jsx(Po,{planetData:w,showInPage:!0,showInConsole:!0}),m.jsx("div",{ref:p,className:"w-full h-full",style:{minHeight:"300px",aspectRatio:"1"}}),I&&m.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black bg-opacity-50",children:m.jsxs("div",{className:"text-white text-center",children:[m.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-white mx-auto mb-2"}),m.jsx("div",{children:"Loading planet..."})]})}),L&&m.jsxs("div",{className:"absolute top-0 left-0 right-0 p-2 bg-red-500 text-white text-sm",children:[m.jsx("strong",{children:"Error:"})," ",L]}),w&&!I&&m.jsxs("div",{className:"absolute bottom-0 left-0 p-4 text-white bg-black bg-opacity-50 max-w-xs",children:[m.jsx("h3",{className:"text-lg font-bold",children:w.planet_info.name}),m.jsx("p",{className:"text-sm opacity-80",children:w.planet_info.type}),m.jsxs("p",{className:"text-xs mt-1 opacity-60",children:[Y.length," effects active"]}),w.surface_elements?.description&&m.jsx("p",{className:"text-xs mt-2 opacity-60",children:w.surface_elements.description.appearance})]}),n&&m.jsxs("div",{className:"absolute top-0 right-0 p-4 text-white bg-black bg-opacity-70 text-xs font-mono",children:[m.jsx("h4",{className:"font-bold mb-2",children:"Debug Info"}),m.jsxs("div",{children:["Frame Rate: ",te.frameRate," FPS"]}),m.jsxs("div",{children:["Render Time: ",te.renderTime,"ms"]}),m.jsxs("div",{children:["Active Effects: ",te.activeEffects]}),m.jsxs("div",{children:["Enabled Effects: ",te.enabledEffects]}),m.jsxs("div",{className:"mt-2",children:[m.jsx("div",{className:"font-semibold",children:"Effects:"}),Y.map(E=>m.jsxs("div",{className:"ml-2",children:[E.type," (",E.enabled?"ON":"OFF",")"]},E.id))]})]})]})};class Ao extends Jt.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return console.error("🚨 ErrorBoundary caught error:",e),console.error("🚨 Error stack:",e.stack),{hasError:!0,error:e.message}}componentDidCatch(e,t){console.error("🚨 componentDidCatch:",e,t)}render(){return this.state.hasError?m.jsx("div",{className:"flex items-center justify-center w-full h-full bg-gray-900/50 rounded",children:m.jsxs("div",{className:"text-center p-4",children:[m.jsx("div",{className:"text-red-400 text-sm mb-2",children:"3D Renderer Error"}),m.jsx("div",{className:"text-xs text-gray-400",children:this.state.error})]})}):this.props.children}}const Ro=r=>m.jsx(Ao,{children:m.jsx(No,{...r})}),Do=({planetUrl:r,imageUrl:e,planet:t,cosmicOriginTime:i,initialAngleRotation:o,onEffectsCreated:a,effects:n,onToggleEffect:c})=>{const d=N.useRef(null),l=N.useRef(null),[s,u]=N.useState("Aligning Stargate..."),[f,p]=N.useState(!1),[y,S]=N.useState(!1),[_,v]=N.useState(!1),[x,A]=N.useState(!0),[g,b]=N.useState(!0),[P,I]=N.useState(null),[M,L]=N.useState(null);N.useEffect(()=>{n&&c&&n.forEach(w=>{Oe.toggleEffect(w.id,w.enabled)})},[n]),N.useEffect(()=>{const w=document.createElement("style");return w.textContent=`
    ...
    `,document.head.appendChild(w),()=>{document.head.removeChild(w)}},[]),N.useEffect(()=>{const w=d.current;if(!w)return;const V=w.getContext("2d");if(!V)return;let Y=[];const G=800;let te,Z;const K=800;let D,k=.5;function z(){const ae=w?.parentElement;if(!ae||!w)return;const ve=ae.clientWidth,xe=ae.clientHeight;w.width=Math.min(ve,K),w.height=Math.min(xe,K),te=w.width/2,Z=w.height/2}function q(){z(),Y=[];for(let ae=0;ae<G;ae++)Y.push({x:Math.random()*(w?.width||800),y:Math.random()*(w?.height||800),z:Math.random()*(w?.width||800),o:Math.random()});oe()}function oe(){!w||!V||(V.clearRect(0,0,w.width,w.height),Y.forEach(ae=>{ae.z-=k,ae.z<=0&&(ae.z=w.width,ae.x=Math.random()*w.width,ae.y=Math.random()*w.height,ae.o=Math.random());const ve=w.width/ae.z,xe=(ae.x-te)*ve+te,we=(ae.y-Z)*ve+Z,Se=2*ve;V.beginPath(),V.fillStyle=`rgba(255, 255, 255, ${ae.o})`,V.arc(xe,we,Se,0,2*Math.PI),V.fill()}),k<60&&(k+=1),D=requestAnimationFrame(oe))}q();const ge=()=>z();return window.addEventListener("resize",ge),()=>{window.removeEventListener("resize",ge),D&&cancelAnimationFrame(D)}},[]),N.useEffect(()=>{if(e&&!x){const w=new Image;w.onload=()=>{l.current&&(l.current.src=e,S(!0),v(!0))},w.onerror=()=>{console.error("Failed to load planet image:",e),setTimeout(()=>{S(!0),v(!0)},1500)},w.src=e}else(x||!e)&&setTimeout(()=>{S(!0),v(!0)},1500)},[e,x]),N.useEffect(()=>{if(sessionStorage.getItem("stargateAnimationShown")){u("Stargate system aligned");return}sessionStorage.setItem("stargateAnimationShown","true"),p(!0);const V=(K,D)=>Array.from({length:D},()=>K[Math.floor(Math.random()*K.length)]).join(""),Y=[{chars:"01",duration:40,iterations:20},{chars:"0123456789",duration:25,iterations:30},{chars:"0123456789ABCDEF",duration:20,iterations:40},{chars:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()-_=+[]{}|;:\\'\",.<>?/`~",duration:10,iterations:100}];let G=0,te=0;const Z=()=>{if(G>=Y.length){const D="Stargate system aligned";let k=0;u("");const z=()=>{k<D.length?(u(D.substring(0,k+1)),k++,setTimeout(z,30)):p(!1)};z();return}const K=Y[G];u(V(K.chars,32)),te++,te>=K.iterations&&(G++,te=0),setTimeout(Z,K.duration)};Z()},[]);const j=()=>{A(!x),x||(S(!0),v(!0))};return m.jsxs("div",{className:"h-full flex flex-col",children:[m.jsxs("div",{className:"flex items-center justify-between mb-3",children:[m.jsx("h3",{className:"text-lg sm:text-xl font-bold text-white",children:"Planet Visualization"}),g&&m.jsx("div",{className:"flex items-center gap-2",children:m.jsx("button",{onClick:j,className:`px-3 py-1 text-xs font-medium rounded-full transition-all duration-300 ${x?"bg-blue-500 text-white shadow-lg shadow-blue-500/25":"bg-gray-600 text-gray-200 hover:bg-gray-500"}`,children:x?"2D View":"3D View"})})]}),m.jsxs("div",{className:"relative w-full max-w-80 sm:max-w-96 aspect-square mx-auto bg-black/50 flex justify-center items-center rounded-xl overflow-hidden border-2 border-blue-400/30 mb-4",children:[m.jsx("canvas",{ref:d,className:`absolute inset-0 w-full h-full object-cover transition-opacity duration-[2500ms] ${_?"opacity-0":"opacity-100"}`,style:{filter:_?"blur(50px)":"none"}}),x&&y&&t&&m.jsx("div",{className:`absolute inset-0 w-full h-full transition-all duration-500 ${y?"opacity-100 blur-0":"opacity-0 blur-[25px]"}`,children:m.jsx(Ro,{planetName:t.name,containerClassName:"w-full h-full",autoRotate:!1,enableControls:!0,showDebugInfo:!1,onEffectsCreated:a,planetData:{name:t.name,diameter:t.diameter,density:t.density,gravity:t.gravity,mass:t.mass,orbital_radius:t.orbital_radius,orbital_period_seconds:t.orbital_period_seconds,rotation_period_seconds:t.rotation_period_seconds,surface_temperature:t.surface_temperature,axial_tilt:t.axial_tilt,planet_type:t.planet_type,atmosphere:t.atmosphere,elements:t.elements,initial_orbital_angle:t.initial_orbital_angle||0},cosmicOriginTime:i,initialAngleRotation:o,onDataLoaded:w=>{I(w)},onError:w=>{L(w),console.error("❌ Planet rendering error:",w)}})}),!x&&m.jsx("div",{className:`absolute inset-0 w-full h-full transition-all duration-500 ${y?"opacity-100 blur-0":"opacity-0 blur-[25px]"}`,children:y&&e?m.jsx("div",{className:"w-full h-full flex items-center justify-center",children:m.jsx(xi,{zoomMargin:20,classDialog:"backdrop-blur-3xl",children:m.jsx("img",{ref:l,className:"max-w-full max-h-full object-contain rounded-xl shadow-2xl shadow-blue-500/20",src:e,alt:"Planet visualization",style:{width:"100%",height:"100%",objectFit:"contain",backgroundColor:"transparent"}})})}):m.jsx("img",{ref:l,className:"w-full h-full object-cover",src:"/static/images/placeholder-min.jpg",alt:"Planet visualization"})}),g&&m.jsx("div",{className:"absolute top-2 right-2 bg-black/70 text-white px-2 py-1 rounded text-xs",children:x?"🌍 3D":"🖼️ 2D"})]}),m.jsxs("div",{className:"text-center mt-auto",children:[m.jsxs("a",{href:r,className:`inline-block px-4 py-2 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-gray-200 font-medium text-sm rounded-lg border border-slate-600 hover:border-slate-500 shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden group ${f?"animate-pulse":""}`,style:{boxShadow:"0 2px 8px rgba(0, 0, 0, 0.3)"},children:[m.jsxs("span",{className:"relative z-10 font-mono flex items-center gap-2",children:[m.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 20 20",children:m.jsx("path",{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zM8.736 6.979C9.208 6.193 9.696 6 10 6s.792.193 1.264.979a1 1 0 001.715-1.029C12.279 4.784 11.232 4 10 4s-2.279.784-2.979 1.95a1 1 0 001.715 1.029zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM10 14c-.304 0-.792-.193-1.264-.979a1 1 0 00-1.715 1.029C7.721 15.216 8.768 16 10 16s2.279-.784 2.979-1.95a1 1 0 00-1.715-1.029C10.792 13.807 10.304 14 10 14z",clipRule:"evenodd"})}),s]}),m.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-slate-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"})]}),m.jsxs("div",{className:"mt-2 text-xs text-gray-500 text-center",children:["Gateway to the stars",x&&P&&m.jsxs("div",{className:"ml-2 text-blue-400 mt-1",children:["• ",P.planet_info?.type," Planet",P.atmosphere&&m.jsx("span",{className:"text-purple-400",children:" • Atmosphere"}),P.rings?.has_rings&&m.jsx("span",{className:"text-yellow-400",children:" • Rings"})]}),x&&M&&m.jsx("div",{className:"ml-2 text-red-400 mt-1",children:"• Rendering Error"})]})]})]})},Lo=({currentPlanet:r,system:e,galaxy:t,systemPlanets:i})=>{const[o,a]=N.useState(null),[n,c]=N.useState(null),[d,l]=N.useState(!1),[s,u]=N.useState(!1),[f,p]=N.useState(!0);N.useEffect(()=>{if(i&&i.length>0){const _=i.findIndex(v=>v.name.toLowerCase()===r.toLowerCase());_!==-1?(_>0?(a(i[_-1].name.toLowerCase()),l(!0)):e.index>0?(a("__prev_system__"),l(!0)):l(!1),_<i.length-1?(c(i[_+1].name.toLowerCase()),u(!0)):(c("__next_system__"),u(!0))):(l(!1),u(!1))}else l(!1),u(!1);p(!1)},[r,e.index,i]);const y=async()=>{const _=t.coordinates.join(",");if(o==="__prev_system__")try{const v=await fetch(`/system/${e.index-1}`,{headers:{Accept:"application/json"}});if(v.ok){const x=await v.json();if(x.system&&x.system.planets&&x.system.planets.length>0){const g=x.system.planets[x.system.planets.length-1].name.toLowerCase();at(_,e.index-1,g,x.system.planets),Pt(_,e.index-1),window.location.href=`/planet/${g}`;return}}window.location.href=`/system/${e.index-1}`}catch{window.location.href=`/system/${e.index-1}`}else o&&(at(_,e.index,o,i),window.location.href=`/planet/${o}`)},S=async()=>{const _=t.coordinates.join(",");if(n==="__next_system__")try{const v=await fetch(`/system/${e.index+1}`,{headers:{Accept:"application/json"}});if(v.ok){const x=await v.json();if(x.system&&x.system.planets&&x.system.planets.length>0){const g=x.system.planets[0].name.toLowerCase();at(_,e.index+1,g,x.system.planets),Pt(_,e.index+1),window.location.href=`/planet/${g}`;return}}window.location.href=`/system/${e.index+1}`}catch{window.location.href=`/system/${e.index+1}`}else n&&(at(_,e.index,n,i),window.location.href=`/planet/${n}`)};return f?null:m.jsxs("div",{className:"flex items-center justify-between mb-4",children:[m.jsx("button",{onClick:y,disabled:!d,className:`flex items-center justify-center px-3 py-1.5 rounded-lg transition-all duration-200 ${d?"bg-white/10 hover:bg-white/20 border border-white/20 text-white hover:text-blue-300":"bg-white/5 border border-white/10 text-gray-600 cursor-not-allowed"}`,children:m.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:m.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),m.jsx("button",{onClick:S,disabled:!s,className:`flex items-center justify-center px-3 py-1.5 rounded-lg transition-all duration-200 ${s?"bg-white/10 hover:bg-white/20 border border-white/20 text-white hover:text-blue-300":"bg-white/5 border border-white/10 text-gray-600 cursor-not-allowed"}`,children:m.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:m.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]})},Oo=({planet:r,system:e,galaxy:t,planet_url:i,version:o,image_url:a,cosmic_origin_time:n,initial_angle_rotation:c})=>{const[d]=N.useState(t.coordinates.join(",")),[l,s]=N.useState([]),u=_=>{s(_)},f=(_,v)=>{s(x=>x.map(A=>A.id===_?{...A,enabled:v}:A))};N.useEffect(()=>{document.body.setAttribute("data-coordinates",d),document.body.setAttribute("data-system-index",e.index.toString()),document.body.setAttribute("data-planet-name",r.name.toLowerCase()),at(d,e.index,r.name,e.planets||[]),Pt(d,e.index)},[d,e.index,r.name]);const p=_=>_.replace(/_/g," "),y=_=>_.replace(/_/g," "),S=_=>_.replace(/_/g," ");return m.jsxs("div",{className:"w-full h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-auto",children:[m.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`}}),m.jsxs("div",{className:"relative z-10",children:[m.jsx(vi,{}),m.jsxs("div",{className:"w-full px-2 sm:px-4 lg:px-6 py-4 sm:py-8",children:[m.jsxs("div",{className:"text-center mb-8",children:[m.jsx("div",{className:"flex items-center justify-center gap-4 mb-4",children:m.jsxs("h1",{className:"text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent",children:["Planet '",p(r.name),"'"]})}),m.jsxs("p",{className:"text-lg sm:text-xl text-gray-300",children:["in System '",y(e.name),"' - Galaxy '",S(t.name),"'"]}),m.jsxs("p",{className:"text-sm sm:text-base text-gray-400",children:["Coordinates ",t.coordinates.join(", ")]})]}),m.jsx(Lo,{currentPlanet:r.name,system:e,galaxy:t,systemPlanets:e.planets||[]}),m.jsx("div",{className:"bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 mb-8 shadow-2xl p-4 sm:p-6",children:m.jsxs("div",{className:"flex flex-col lg:grid lg:grid-cols-[400px_1fr] gap-6 lg:gap-8 relative",children:[m.jsx("div",{className:"order-1 lg:order-1",children:m.jsx(Do,{planetUrl:i,imageUrl:a,planet:r,cosmicOriginTime:n,initialAngleRotation:c,onEffectsCreated:u,effects:l,onToggleEffect:f})}),m.jsx("div",{className:"hidden lg:block absolute left-[416px] top-0 bottom-0 w-1 rounded-full bg-white/10 -translate-x-1.5"}),m.jsx("div",{className:"order-2 lg:order-2",children:m.jsx(Yi,{planet:r,system:e,galaxy:t,cosmicOriginTime:n,initialAngleRotation:c,effects:l,onToggleEffect:f})})]})}),m.jsx("div",{className:"bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 mb-8 shadow-2xl p-4 sm:p-6 text-center",children:m.jsx("button",{onClick:()=>window.location.href=`/system/${e.index}`,className:"w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-gray-600 via-gray-700 to-gray-600 hover:from-gray-700 hover:via-gray-800 hover:to-gray-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg backdrop-blur-sm",children:m.jsxs("span",{className:"text-base sm:text-lg",children:["← Back to System '",y(e.name),"'"]})})})]}),m.jsx(pi,{version:o})]}),m.jsx(Si,{currentLocation:{type:"planet",name:r.name,coordinates:t.coordinates.join(","),systemIndex:e.index,planetName:r.name}})]})};document.addEventListener("DOMContentLoaded",async()=>{try{const r=document.getElementById("planet-data"),e=document.getElementById("system-data"),t=document.getElementById("galaxy-data"),i=document.getElementById("meta-data");if(!r||!e||!t||!i){console.error("Missing required data elements");return}const o=JSON.parse(r.textContent||"{}"),a=JSON.parse(e.textContent||"{}"),n=JSON.parse(t.textContent||"{}"),c=JSON.parse(i.textContent||"{}"),d={planet:o,system:a,galaxy:n,planet_url:c.planet_url,version:c.version,image_url:c.image_url,cosmic_origin_time:c.cosmic_origin_time,initial_angle_rotation:c.initial_angle_rotation},l=document.getElementById("atlas-react-root");l&&gi.createRoot(l).render(Jt.createElement(Oo,d))}catch(r){console.error("Error initializing Planet React app:",r)}});
