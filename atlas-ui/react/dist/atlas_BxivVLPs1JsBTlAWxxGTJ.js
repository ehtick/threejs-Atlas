import{S as d}from"./atlas_BMpNx4AK3tYXnXF6p046V.js";import{D as y,a as N,g as P}from"./atlas_T7JJ8afK2bnKNLBS_Xpir.js";import{V as S,C as m,i as R,co as M,av as l,au as L,bE as B}from"./atlas_CP-qo6TeGb-XhtmtHX5P6.js";const i={STAR_COUNT:{min:4500,max:7500},MIN_BRIGHTNESS:{min:.6,max:.8},MAX_BRIGHTNESS:{min:.9,max:1},MIN_SIZE:{min:8,max:9.6},MAX_SIZE:{min:20,max:32},DISTANCE:{min:2e3,max:3600},TWINKLE_SPEED:{min:1,max:2},PARALLAX_STRENGTH:{min:1,max:3},VARIABLE_CHANCE:{min:.002,max:.005},ORBITAL_PARALLAX_STRENGTH:{min:.15,max:.35}};class c{starSystem;material;geometry;params;starCount;cameraPosition=new S;lastCameraPosition=new S;startTime;static vertexShader=`
