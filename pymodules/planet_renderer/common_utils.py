...
Common utilities and helper functions for planet rendering.
"""
...
class CommonUtils:
    """Common utility functions for planet rendering"""
    
    @staticmethod
    def generate_abstract_land_data(planet_radius: int, seed: int, planet_name: str,
    ...
    def normalize_coordinates(x: float, y: float, center_x: float, center_y: float, planet_radius: int) -> List[float]:
        """Convert Pillow coordinates to normalized 3D coordinates (-1 to 1)"""
